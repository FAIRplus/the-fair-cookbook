...
CO (URL_TO_INSERT_RECORD https://fairsharing.org/FAIRsharing.wgfrmg)  (URL_TO_INSERT_RECORD https://fairsharing.org/FAIRsharing.thskvr) MMENT: the concepts in this recipe did not map (URL_TO_INSERT_RECORD https://fairsharing.org/FAIRsharing.53edcc)  to any terms from the EDAM (URL_TO_INSERT_RECORD https://fairsharing.org/FAIRsharing.a6r7zs)  ontology (URL_TO_INSERT_TERM https://fairsharing.org/search?recordType=terminology_artefact) . 

---

## Table of Data Standards

CO (URL_TO_INSERT_RECORD https://fairsharing.org/FAIRsharing.wgfrmg)  (URL_TO_INSERT_RECORD https://fairsharing.org/FAIRsharing.thskvr) MMENT: the concepts in this recipe did not map (URL_TO_INSERT_RECORD https://fairsharing.org/FAIRsharing.53edcc)  to any terms from the FAIR (URL_TO_INSERT_RECORD https://fairsharing.org/FAIRsharing.WWI10U) sharing (URL_TO_INSERT_RECORD https://fairsharing.org/FAIRsharing.2abjs5)  (URL_TO_INSERT_RECORD https://fairsharing.org/FAIRsharing.2abjs5) .org database (URL_TO_INSERT_TERM https://fairsharing.org/search?fairsharingRegistry=Database) .-->
