(fcb-approach-cdis (URL_TO_INSERT_RECORD-NAME_4 https://fairsharing.org/3525) c)=
...
This recipe provides a general guide for mapping a clinical trial dataset to [CDISC Study Data Tabulated Model](https://doi.org/10.25504/FAIRsharing.s51qk5) (CDISC (URL_TO_INSERT_RECORD-NAME_6 https://fairsharing.org/3525) -SDTM (URL_TO_INSERT_RECORD-ABBREV_5 https://fairsharing.org/FAIRsharing.s51qk5) ) using practical examples from two Innovative Medicine Initiative projects, APPROACH and ABIRISK.

The recipe will cover the following elements:

> * Provide a general overview of the challenges of mapping a non-conforming data dictionary to CDISC (URL_TO_INSERT_RECORD-NAME_7 https://fairsharing.org/3525)  STDM standard and CDISC (URL_TO_INSERT_RECORD-NAME_8 https://fairsharing.org/3525)  Vocabulary.
>
> * Illustrate the mapping process using the above projects.
>
> * Describe the Extract-Transform-Load (ETL) processes necessary to convert the data to CDISC (URL_TO_INSERT_RECORD-NAME_10 https://fairsharing.org/3525) -SDTM (URL_TO_INSERT_RECORD-ABBREV_9 https://fairsharing.org/FAIRsharing.s51qk5)  based on the mapped data dictionary.
