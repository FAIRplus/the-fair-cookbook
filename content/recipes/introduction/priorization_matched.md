...
* We begin by pointing out the reasons why one should to make their dataset FAIR(URL_TO_INSERT_RECORD https://www.go-fair.org/fair-principles/). 
...
Additional reasons for the need of FAIR(URL_TO_INSERT_RECORD https://www.go-fair.org/fair-principles/)ification encompass ethical reasons for doing so. These are more fully described 
in a dedicated recipe called [Values of FAIR(URL_TO_INSERT_RECORD https://www.go-fair.org/fair-principles/)](https://fairplus.github.io/the-fair-cookbook/content/recipes/introduction/FAIRplus-values.html).
...
With the help of the above-mentioned list, the PSP(URL_TO_INSERT_RECORD http://www.phosphosite.org)(URL_TO_INSERT_RECORD http://bioportal.bioontology.org/ontologies/SP) team can formulate a filtering or prioritization schema.
...
This list is not extensive and the PSP(URL_TO_INSERT_RECORD http://www.phosphosite.org)(URL_TO_INSERT_RECORD http://bioportal.bioontology.org/ontologies/SP) team can modify the criteria based on their needs.
...
In case of the absence of a DMP(URL_TO_INSERT_RECORD http://www.informatics.jax.org/vocab/mp_ontology), the FAIR(URL_TO_INSERT_RECORD https://www.go-fair.org/fair-principles/) experts lack the ability to find the best FAIR(URL_TO_INSERT_RECORD https://www.go-fair.org/fair-principles/)ification process for the given 
...
to ensure both data availability and accessibility before the FAIR(URL_TO_INSERT_RECORD https://www.go-fair.org/fair-principles/)ification process. 
...
The best practice in such situations is to have at least one member from the consortium in the **FAIR(URL_TO_INSERT_RECORD https://www.go-fair.org/fair-principles/) experts team**,
the team involved in the FAIR(URL_TO_INSERT_RECORD https://www.go-fair.org/fair-principles/)ification process. This enables easing the FAIR(URL_TO_INSERT_RECORD https://www.go-fair.org/fair-principles/)ification process in 2 ways: 
...
This is mainly of interest to data handle(URL_TO_INSERT_RECORD http://handle.net)rs within the FAIR(URL_TO_INSERT_RECORD https://www.go-fair.org/fair-principles/) expert team who can with few lines of programmatic code access the data.
...
- The first is the **time management**. Since the FAIR(URL_TO_INSERT_RECORD https://www.go-fair.org/fair-principles/)ification process can depend on a number of factors,
...
Such roadblocks should be identified and rectified if possible prior to starting a FAIR(URL_TO_INSERT_RECORD https://www.go-fair.org/fair-principles/)ification process. 

 
Each of these criteria have an independent stance and when creating a score(URL_TO_INSERT_RECORD http://purl.uniprot.org/core/)(URL_TO_INSERT_RECORD https://core.ac.uk)board, a personalized priority between 
these factors need to be made. For example, if people have data champions within their FAIR(URL_TO_INSERT_RECORD https://www.go-fair.org/fair-principles/)ification team, they would 
...
The cost factors refer to the set of indicators or aspects that influence the costs associated with the FAIR(URL_TO_INSERT_RECORD https://www.go-fair.org/fair-principles/)ification
process, while the value factors can be defined as the value proposition for performing the FAIR(URL_TO_INSERT_RECORD https://www.go-fair.org/fair-principles/)ification. 
...
<img src="/images/score(URL_TO_INSERT_RECORD http://purl.uniprot.org/core/)(URL_TO_INSERT_RECORD https://core.ac.uk)_card_ref.png" style="border:1px solid black"/>
</div> -->
...
---
width: 550px
name: Score(URL_TO_INSERT_RECORD http://purl.uniprot.org/core/)(URL_TO_INSERT_RECORD https://core.ac.uk) card template
alt: Score(URL_TO_INSERT_RECORD http://purl.uniprot.org/core/)(URL_TO_INSERT_RECORD https://core.ac.uk) card template
---
Score(URL_TO_INSERT_RECORD http://purl.uniprot.org/core/)(URL_TO_INSERT_RECORD https://core.ac.uk) card template.
```
````
...
* [The Value of FAIR(URL_TO_INSERT_RECORD https://www.go-fair.org/fair-principles/)](fcb-intro-fair-values)
* [Data Management Plan](https://rdmkit.elixir-europe.org(URL_TO_INSERT_RECORD https://elixir-europe.org/)/data_management_plan.html)
