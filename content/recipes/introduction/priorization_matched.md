...
> stages required for FAIRification. Finally, we also highlight the reasons for making the data FAIR (URL_TO_INSERT_RECORD-ABBREV_2316 https://fairsharing.org/FAIRsharing.WWI10U) .


## Introduction
With the increased awareness of the FAIR (URL_TO_INSERT_RECORD-ABBREV_2318 https://fairsharing.org/FAIRsharing.WWI10U)  principles (URL_TO_INSERT_RECORD-NAME_2317 https://fairsharing.org/FAIRsharing.WWI10U) , the drive to implement them can be felt in projects and programs. 
...
* We begin by pointing out the reasons why one should to make their dataset FAIR (URL_TO_INSERT_RECORD-ABBREV_2319 https://fairsharing.org/FAIRsharing.WWI10U) . 
...
Before understanding why and how to *prioritize* projects for the FAIR (URL_TO_INSERT_RECORD-ABBREV_2320 https://fairsharing.org/FAIRsharing.WWI10U)  pipeline, it is essential to understand 
*the need* for FAIRification of data {footcite}`d3_report`. The list below identifies key reasons why one should make data FAIR (URL_TO_INSERT_RECORD-ABBREV_2321 https://fairsharing.org/FAIRsharing.WWI10U) : 
...
* Encourages community collaboration:
  ...
  communities would now have a structured data format to map (URL_TO_INSERT_RECORD-NAME_2322 https://fairsharing.org/FAIRsharing.53edcc)  their data for integration.
...
To answer whether a project requires FAIRification or not, it is essential to first gather all relevant information 
...
would take care of the prioritization process, the **Project Selection and Prioritization (PSP (URL_TO_INSERT_RECORD-ABBREV_2323 https://fairsharing.org/FAIRsharing.x8xt3k) )** team. 
...
The information that PSP (URL_TO_INSERT_RECORD-ABBREV_2324 https://fairsharing.org/FAIRsharing.x8xt3k)  team users can collect about the projects covered:
<ol>
	<li>Name</li>
...
With the help of the above-mentioned list, the PSP (URL_TO_INSERT_RECORD-ABBREV_2325 https://fairsharing.org/FAIRsharing.x8xt3k)  team can formulate a filtering or prioritization schema.
The next sections discuss different methods for achieving this. 


## Project prioritization

Once the basic information is collected, the PSP (URL_TO_INSERT_RECORD-ABBREV_2326 https://fairsharing.org/FAIRsharing.x8xt3k)  team can now describe projects through a [scoreboard](https://zenodo.org/record/5778431#.YbikDxNKhH1). 
...
This list is not extensive and the PSP (URL_TO_INSERT_RECORD-ABBREV_2327 https://fairsharing.org/FAIRsharing.x8xt3k)  team can modify the criteria based on their needs.

### 1. Prioritization based on focus

When dealing with large number of projects, the PSP (URL_TO_INSERT_RECORD-ABBREV_2328 https://fairsharing.org/FAIRsharing.x8xt3k)  team can get an overview of the research area or focus area of the given project.
...
An *in-house* prioritization scheme can be established by FAIR (URL_TO_INSERT_RECORD-ABBREV_2329 https://fairsharing.org/FAIRsharing.WWI10U)  experts for selection of relevant projects for the FAIRification process.
...
choose ontologies etc. that ensures creation of FAIR (URL_TO_INSERT_RECORD-ABBREV_2330 https://fairsharing.org/FAIRsharing.WWI10U)  data by design.
...
Hence, the best time of engaging a project into the FAIR (URL_TO_INSERT_RECORD-ABBREV_2331 https://fairsharing.org/FAIRsharing.WWI10U)  pipeline would be dependent on the retrospective and 
...
This established document gives the data owners and FAIR (URL_TO_INSERT_RECORD-ABBREV_2332 https://fairsharing.org/FAIRsharing.WWI10U)  experts an overview of the resource under study. 
On the basis of this DMP document, a FAIRification process can be determined and established. 
In case of the absence of a DMP, the FAIR (URL_TO_INSERT_RECORD-ABBREV_2333 https://fairsharing.org/FAIRsharing.WWI10U)  experts lack the ability to find the best FAIRification process for the given 
...
The best practice in such situations is to have at least one member from the consortium in the **FAIR (URL_TO_INSERT_RECORD-ABBREV_2334 https://fairsharing.org/FAIRsharing.WWI10U)  experts team**,
...
This is mainly of interest to data handlers within the FAIR (URL_TO_INSERT_RECORD-ABBREV_2335 https://fairsharing.org/FAIRsharing.WWI10U)  expert team who can with few lines of programmatic code access the data.
...
**In summary, projects that FAIR (URL_TO_INSERT_RECORD-ABBREV_2336 https://fairsharing.org/FAIRsharing.WWI10U)  experts can get access to data should be at a higher priority than those that have
...
dealing with such processes or data already exists within the FAIR (URL_TO_INSERT_RECORD-ABBREV_2337 https://fairsharing.org/FAIRsharing.WWI10U)  expert team.
...
FAIR (URL_TO_INSERT_RECORD-ABBREV_2338 https://fairsharing.org/FAIRsharing.WWI10U)  process or data comparatively easy.
...
*INSDC SRA (URL_TO_INSERT_RECORD-ABBREV_2340 https://fairsharing.org/FAIRsharing.g7t2hv) * format or imaging data in *DICOM (URL_TO_INSERT_RECORD-ABBREV_2339 https://fairsharing.org/FAIRsharing.b7z8by) * format. 
...
by the PSP (URL_TO_INSERT_RECORD-ABBREV_2341 https://fairsharing.org/FAIRsharing.x8xt3k)  team and handed over to the people responsible for the FAIRification process.
