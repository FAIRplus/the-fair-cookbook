...
```{figure_fairplus} prioritization-mermaid.png
name: fcb-prioritization-figure1
subtitle: Prioritization overview.
```
...
```{figure_fairplus} score_card_ref.png
name: fcb-prioritization-figure2
subtitle: Score card template.
```
