...
> This recipe aims to provide example clinical datasets to allow users to get fam(URL_TO_INSERT_RECORD https://www.cog-genomics.org/plink2/formats#fam)iliar with the process of handling clinical datasets
...
- fam(URL_TO_INSERT_RECORD https://www.cog-genomics.org/plink2/formats#fam)iliarize with clinical data types, such as Electronic Health Records(EHR).
- fam(URL_TO_INSERT_RECORD https://www.cog-genomics.org/plink2/formats#fam)iliarize with the procedures to gain access to sensitive data.
...
https://github.com(URL_TO_INSERT_RECORD https://github.com/)/OHDSI/CommonDataModel/tree/v5.2.2
````
...
### What to read next?
* How to request data access and deal with data access committees? < TO(URL_TO_INSERT_RECORD http://browser.planteome.org/amigo/term/TO:0000387#display-lineage-tab)DO add a link to corresponding document >
* How to do NER on EHR with NLP?< TO(URL_TO_INSERT_RECORD http://browser.planteome.org/amigo/term/TO:0000387#display-lineage-tab)DO add a link to corresponding document >
