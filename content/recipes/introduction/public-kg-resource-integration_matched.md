...
Additionally, the availability of such information in specialized graph representations was also included as a selection criteria. Therefore, services providing SPARQL (URL_TO_INSERT_RECORD-ABBREV_2343 https://fairsharing.org/FAIRsharing.87ccfd)  endpoint and Graph API for dataset access were considered and the following sections providing specific information and references for each of the resources and datasets are considered


## A catalog of SPARQL Endpoints for Life Sciences: Yummydata

Yummydata is a catalog of SPARQL (URL_TO_INSERT_RECORD-ABBREV_2344 https://fairsharing.org/FAIRsharing.87ccfd)  endpoints of interest to the biomedical community, maintained by the Database Center for Life Sciences in Kashiwa, Japan {footcite}`pmid29688370`. 

Database URL (URL_TO_INSERT_RECORD-ABBREV_2345 https://fairsharing.org/FAIRsharing.9d38e2) : http://yummydata.org/
...
The "health status" is reported as a "Umaka Score" which consolidates endpoint status according to six dimensions (URL_TO_INSERT_RECORD-NAME_2346 https://fairsharing.org/FAIRsharing.9af33c) :
...
central resource based on public domain data to enable target identification and prioritisation, based on functional genomics data and GWAS (URL_TO_INSERT_RECORD-ABBREV_2347 https://fairsharing.org/FAIRsharing.ubYn8D)  data {footcite}`10.1093/nar/gkaa1027`. 
...
* a ftp download. https://platform.opentargets.org (URL_TO_INSERT_RECORD-HOMEPAGE_2348 https://fairsharing.org/FAIRsharing.3f9n4y) /downloads/data
...
GitHub (URL_TO_INSERT_RECORD-NAME_2349 https://fairsharing.org/FAIRsharing.c55d5e)  Repository: https://github.com (URL_TO_INSERT_RECORD-HOMEPAGE_2350 https://fairsharing.org/FAIRsharing.c55d5e) /opentargets
...
* EFO (URL_TO_INSERT_RECORD-ABBREV_2352 https://fairsharing.org/FAIRsharing.1gr4tz) : Experimental Factor Ontology (URL_TO_INSERT_RECORD-NAME_2351 https://fairsharing.org/FAIRsharing.1gr4tz)  and associated open target slim EFO (URL_TO_INSERT_RECORD-ABBREV_2353 https://fairsharing.org/FAIRsharing.1gr4tz) -OTAR
* MONDO (URL_TO_INSERT_RECORD-ABBREV_2354 https://fairsharing.org/FAIRsharing.b2979t) : Diseases
* HPO: clinical signs, symptoms and phenotypes 
* ECO (URL_TO_INSERT_RECORD-ABBREV_2355 https://fairsharing.org/FAIRsharing.wvpgwn) : evidence code ontology to annotate confidence and reliability of findings
...
Pharos comes on the back of initiative such as Illuminating the Druggable Genome (IDG) program (https://commonfund.nih.gov/idg/index) and Target Central Resource Database (URL_TO_INSERT_RECORD-NAME_2356 https://fairsharing.org/FAIRsharing.1gn47b)  (TCRD (URL_TO_INSERT_RECORD-ABBREV_2357 https://fairsharing.org/FAIRsharing.1gn47b) ).
...
The DTO (URL_TO_INSERT_RECORD-ABBREV_2358 https://fairsharing.org/FAIRsharing.tke3y2)  reuses terms from well established resources such as:
* DO: Disease Ontology (URL_TO_INSERT_RECORD-NAME_2359 https://fairsharing.org/FAIRsharing.8b6wfq) 
* GO (URL_TO_INSERT_RECORD-ABBREV_2361 https://fairsharing.org/FAIRsharing.6xq0ee) : Gene Ontology (URL_TO_INSERT_RECORD-NAME_2360 https://fairsharing.org/FAIRsharing.6xq0ee) 
* BAO (URL_TO_INSERT_RECORD-ABBREV_2363 https://fairsharing.org/FAIRsharing.mye76w) : BioAssay Ontology (URL_TO_INSERT_RECORD-NAME_2362 https://fairsharing.org/FAIRsharing.mye76w) 
* GPCRO: GPCR Ontology
...
+ **JSON (URL_TO_INSERT_RECORD-ABBREV_2364 https://fairsharing.org/FAIRsharing.5bbab9) ** — see [`hetnet/json`](https://github.com/hetio/hetionet/tree/master/hetnet/json)
...
+ **TSV (URL_TO_INSERT_RECORD-ABBREV_2365 https://fairsharing.org/FAIRsharing.a978c9) ** — see [`hetnet/tsv`](https://github.com/hetio/hetionet/tree/master/hetnet/tsv)
+ **matrix** — see [`hetnet/matrix`](https://github.com/hetio/hetionet/tree/master/hetnet/matrix)

GitHb Repository: https://github.com (URL_TO_INSERT_RECORD-HOMEPAGE_2366 https://fairsharing.org/FAIRsharing.c55d5e) /hetio/hetionet
...
* DO: disease ontology (URL_TO_INSERT_RECORD-NAME_2367 https://fairsharing.org/FAIRsharing.8b6wfq)  slim, with 137 terms considered.
* MESH (URL_TO_INSERT_RECORD-ABBREV_2368 https://fairsharing.org/FAIRsharing.qnkw45) : for signs and symptoms, with 438 terms considered
* SIDER (URL_TO_INSERT_RECORD-ABBREV_2369 https://fairsharing.org/FAIRsharing.zzaykv) : for side effects
* GO (URL_TO_INSERT_RECORD-ABBREV_2370 https://fairsharing.org/FAIRsharing.6xq0ee) : Biological processes, cellular components, and molecular functions.
* UBERON (URL_TO_INSERT_RECORD-ABBREV_2371 https://fairsharing.org/FAIRsharing.4c0b6b) : for anatomical terms.

Mappings provide connection to chemical information via the use of InChI (URL_TO_INSERT_RECORD-ABBREV_2372 https://fairsharing.org/FAIRsharing.ddk9t9)  keys to unambiguously specific chemical structures. 
...
DRKG includes information from six existing databases including DrugBank (URL_TO_INSERT_RECORD-NAME_2373 https://fairsharing.org/FAIRsharing.353yat) , Hetionet, GNBR, String (URL_TO_INSERT_RECORD-NAME_2375 https://fairsharing.org/FAIRsharing.9b7wvk) , IntAct (URL_TO_INSERT_RECORD-ABBREV_2374 https://fairsharing.org/FAIRsharing.d05nwx)  and DGIdb, and data collected from recent publications particularly related to Covid-19. 

It includes 97,238 entities belonging to 13 entity-types; and 5,874,261 triples belonging to 107 edge-types.

GitHb Repository: https://github.com (URL_TO_INSERT_RECORD-HOMEPAGE_2376 https://fairsharing.org/FAIRsharing.c55d5e) /gnn4dr/DRKG/
...
Knowledge Graph training notebook: https://github.com (URL_TO_INSERT_RECORD-HOMEPAGE_2377 https://fairsharing.org/FAIRsharing.c55d5e) /gnn4dr/DRKG/blob/master/drug_repurpose/COVID-19_drug_repurposing_via_genes.ipynb

### 5. OpenBiolink

OpenBioLink is an open benchmark dataset that serve as training or evaluation datasets for link prediction models {footcite}`rpath_paper_ddomingo`, {footcite}`drug2ways_ddomingo`. It is an ensembl (URL_TO_INSERT_RECORD-NAME_2380 https://fairsharing.org/FAIRsharing.fx0mw7)  of large independent resource connecting drugs to disease via proteins. These resources include STRING (URL_TO_INSERT_RECORD-NAME_2384 https://fairsharing.org/FAIRsharing.9b7wvk) , GO (URL_TO_INSERT_RECORD-ABBREV_2378 https://fairsharing.org/FAIRsharing.6xq0ee) , DisGeNet (URL_TO_INSERT_RECORD-NAME_2385 https://fairsharing.org/FAIRsharing.fssydn) , HPO, STITCH (URL_TO_INSERT_RECORD-ABBREV_2379 https://fairsharing.org/FAIRsharing.zhwa8x) , CTD (URL_TO_INSERT_RECORD-ABBREV_2381 https://fairsharing.org/FAIRsharing.h3tjtr) , HPO, DrugCentral (URL_TO_INSERT_RECORD-NAME_2383 https://fairsharing.org/FAIRsharing.3me82d) , and SIDER (URL_TO_INSERT_RECORD-ABBREV_2382 https://fairsharing.org/FAIRsharing.zzaykv) . 
...
* DO: Disease Ontology (URL_TO_INSERT_RECORD-NAME_2386 https://fairsharing.org/FAIRsharing.8b6wfq) 
* BTO (URL_TO_INSERT_RECORD-ABBREV_2387 https://fairsharing.org/FAIRsharing.1414v8) : Brenda Tissue Ontology for anatomical entities and tissues (URL_TO_INSERT_RECORD-NAME_2388 https://fairsharing.org/FAIRsharing.yXPvpU) .
* EFO (URL_TO_INSERT_RECORD-ABBREV_2390 https://fairsharing.org/FAIRsharing.1gr4tz) : Experimental Factor Ontology (URL_TO_INSERT_RECORD-NAME_2389 https://fairsharing.org/FAIRsharing.1gr4tz) 
* HPO: Human Phenotype Ontology (URL_TO_INSERT_RECORD-NAME_2391 https://fairsharing.org/FAIRsharing.kbtt7f)  
* GO (URL_TO_INSERT_RECORD-ABBREV_2393 https://fairsharing.org/FAIRsharing.6xq0ee) : Gene Ontology (URL_TO_INSERT_RECORD-NAME_2392 https://fairsharing.org/FAIRsharing.6xq0ee) 
* SNOMED-CT: which defines clinical terms and their associative relationships.

The code for CKG is available from GitHub (URL_TO_INSERT_RECORD-NAME_2394 https://fairsharing.org/FAIRsharing.c55d5e)  at: https://github.com (URL_TO_INSERT_RECORD-HOMEPAGE_2395 https://fairsharing.org/FAIRsharing.c55d5e) /MannLabs/CKG under a MIT License.

CKG can be loaded and queried via a Neo4j graph database, a data dump of which is available from: https://data.mendeley.com (URL_TO_INSERT_RECORD-HOMEPAGE_2396 https://fairsharing.org/FAIRsharing.3epmpp) /datasets/mrcf7f4tc2/1.
...
To build it, AstraZeneca developers created dedicated information extraction pipeline for mining unstructured text such as full text publications using Natural Language Processing (NLP) techniques, as well as information obtained from specialized databases such as ChEMBL (URL_TO_INSERT_RECORD-NAME_2398 https://fairsharing.org/FAIRsharing.m3jtpg)  or Ensembl (URL_TO_INSERT_RECORD-NAME_2397 https://fairsharing.org/FAIRsharing.fx0mw7)  for chemical and gene products respectively, but also other datasets such as Hetionet and Open Target.
...
* UBERON (URL_TO_INSERT_RECORD-ABBREV_2399 https://fairsharing.org/FAIRsharing.4c0b6b) : for anatomical terms
* GO (URL_TO_INSERT_RECORD-ABBREV_2401 https://fairsharing.org/FAIRsharing.6xq0ee) :  Gene Ontology (URL_TO_INSERT_RECORD-NAME_2400 https://fairsharing.org/FAIRsharing.6xq0ee)  for Biological processes, cellular components, and molecular functions.


BIKG can be accessed via a GraphQL API and the underlying data can be exported in 2 different graph formats, RDF (URL_TO_INSERT_RECORD-ABBREV_2402 https://fairsharing.org/FAIRsharing.p77ph9)  or Neo4j/CS (URL_TO_INSERT_RECORD-ABBREV_2403 https://fairsharing.org/FAIRsharing.1943d4) V for linked data graph or property graph representations respectively.
...
GitHub (URL_TO_INSERT_RECORD-NAME_2404 https://fairsharing.org/FAIRsharing.c55d5e)  Repository: https://github.com (URL_TO_INSERT_RECORD-HOMEPAGE_2405 https://fairsharing.org/FAIRsharing.c55d5e) /pykeen/pykeen
...
Link Prediction example notebook: https://github.com (URL_TO_INSERT_RECORD-HOMEPAGE_2406 https://fairsharing.org/FAIRsharing.c55d5e) /tomasonjo/blogs/blob/master/pykeen/Hetionet%20-%20RotatE.ipynb
