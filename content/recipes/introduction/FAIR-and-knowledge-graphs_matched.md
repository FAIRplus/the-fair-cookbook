...
1. the relation between FAIR (URL_TO_INSERT_RECORD-ABBREV_2156 https://fairsharing.org/FAIRsharing.WWI10U)  and KGs.
...
5. the impact of graph-based representations on what it means to deliver FAIR (URL_TO_INSERT_RECORD-ABBREV_2157 https://fairsharing.org/FAIRsharing.WWI10U)  data and services.
...
FAIR (URL_TO_INSERT_RECORD-ABBREV_2158 https://fairsharing.org/FAIRsharing.WWI10U)  is chiefly about three things: metadata, metadata and metadata. 
...
the FAIR (URL_TO_INSERT_RECORD-ABBREV_2160 https://fairsharing.org/FAIRsharing.WWI10U)  principles (URL_TO_INSERT_RECORD-NAME_2159 https://fairsharing.org/FAIRsharing.WWI10U) . 
Thus, providing metadata about a dataset in the form of Linked Data Graph is a significant path towards making data FAIR (URL_TO_INSERT_RECORD-ABBREV_2161 https://fairsharing.org/FAIRsharing.WWI10U) .
...
> But `FAIR (URL_TO_INSERT_RECORD-ABBREV_2162 https://fairsharing.org/FAIRsharing.WWI10U)  data` and `knowledge graphs` are not equivalent. Not all FAIR (URL_TO_INSERT_RECORD-ABBREV_2163 https://fairsharing.org/FAIRsharing.WWI10U)  data is a knowledge graph and not all knowledge graphs are FAIR (URL_TO_INSERT_RECORD-ABBREV_2164 https://fairsharing.org/FAIRsharing.WWI10U) .
...
standing for "Resource Description Framework (URL_TO_INSERT_RECORD-NAME_2166 https://fairsharing.org/FAIRsharing.p77ph9) ", one of the World Wide Web Consortium (W3C) standards supporting the vision of a **Semantic Web** as 
...
````markdown
"@wdt": "https://www.wikidata.org (URL_TO_INSERT_RECORD-HOMEPAGE_2167 https://fairsharing.org/FAIRsharing.6s749p) /wiki/"
...
The `RDF (URL_TO_INSERT_RECORD-ABBREV_2168 https://fairsharing.org/FAIRsharing.p77ph9)  syntax` allows the expression of `RDF (URL_TO_INSERT_RECORD-ABBREV_2169 https://fairsharing.org/FAIRsharing.p77ph9)  statements`, which can be built and grouped in an `RDF (URL_TO_INSERT_RECORD-ABBREV_2170 https://fairsharing.org/FAIRsharing.p77ph9)  graph`.
...
RDF (URL_TO_INSERT_RECORD-ABBREV_2171 https://fairsharing.org/FAIRsharing.p77ph9)  graph objects can be persisted in specialized databases, `RDF (URL_TO_INSERT_RECORD-ABBREV_2172 https://fairsharing.org/FAIRsharing.p77ph9)  graph databases` also known as `RDF (URL_TO_INSERT_RECORD-ABBREV_2173 https://fairsharing.org/FAIRsharing.p77ph9)  triple stores`. 
...
To validate and control the quality of the fast emerging RDF (URL_TO_INSERT_RECORD-ABBREV_2174 https://fairsharing.org/FAIRsharing.p77ph9)  triples.
The W3C has produced a specification detailing a constraint language which allows data managers to control the so-called
`shape` of the RDF (URL_TO_INSERT_RECORD-ABBREV_2176 https://fairsharing.org/FAIRsharing.p77ph9)  graph coming in. The W3C SHACL (URL_TO_INSERT_RECORD-ABBREV_2175 https://fairsharing.org/FAIRsharing.f1449d)  SHApe Constraint Language, known as [SHACL](https://www.w3.org/TR/shacl/) (pronounced `shackle`),
allow to express a set of conditions to validate RDF (URL_TO_INSERT_RECORD-ABBREV_2178 https://fairsharing.org/FAIRsharing.p77ph9)  graphs/RD (URL_TO_INSERT_RECORD-ABBREV_2179 https://fairsharing.org/FAIRsharing.p77ph9) F statements. SHACL (URL_TO_INSERT_RECORD-ABBREV_2177 https://fairsharing.org/FAIRsharing.f1449d)  expressions are RDF (URL_TO_INSERT_RECORD-ABBREV_2180 https://fairsharing.org/FAIRsharing.p77ph9)  statements 
and the constraint profiles can be stored in an RDF (URL_TO_INSERT_RECORD-ABBREV_2181 https://fairsharing.org/FAIRsharing.p77ph9)  triple store. 
SHACL (URL_TO_INSERT_RECORD-ABBREV_2182 https://fairsharing.org/FAIRsharing.f1449d)  specifications are implemented in the [TopQuadrant TopBraid Composer tool](https://www.topquadrant.com/products/topbraid-composer/).
...
RDF (URL_TO_INSERT_RECORD-ABBREV_2183 https://fairsharing.org/FAIRsharing.p77ph9)  graphs stored in RDF (URL_TO_INSERT_RECORD-ABBREV_2184 https://fairsharing.org/FAIRsharing.p77ph9)  triple stores can be queried using a dedicated query language defined by a W3C specification known as 
[SPARQL 1.1](https://www.w3.org/TR/sparql11-query/).
SPARQL (URL_TO_INSERT_RECORD-ABBREV_2185 https://fairsharing.org/FAIRsharing.87ccfd)  stands for `SPARQL (URL_TO_INSERT_RECORD-ABBREV_2186 https://fairsharing.org/FAIRsharing.87ccfd)  Query Language`, (pronounced `sparkle`) {footcite}`sparql`. 
The results of a SPARQL (URL_TO_INSERT_RECORD-ABBREV_2189 https://fairsharing.org/FAIRsharing.87ccfd)  query are a `result set` or `RDF (URL_TO_INSERT_RECORD-ABBREV_2187 https://fairsharing.org/FAIRsharing.p77ph9)  graph` and is therefore **a collection of RDF (URL_TO_INSERT_RECORD-ABBREV_2188 https://fairsharing.org/FAIRsharing.p77ph9)  triples**.

An impressive feature of the SPARQL (URL_TO_INSERT_RECORD-ABBREV_2190 https://fairsharing.org/FAIRsharing.87ccfd)  query language is its ability to perform `mashups` by performing federated queries
over a number of 'SERVICES', i.e. RDF (URL_TO_INSERT_RECORD-ABBREV_2191 https://fairsharing.org/FAIRsharing.p77ph9)  triple store endpoints and return an RDF (URL_TO_INSERT_RECORD-ABBREV_2192 https://fairsharing.org/FAIRsharing.p77ph9)  graph which contains triples assembled
...
Wikidata (URL_TO_INSERT_RECORD-NAME_2193 https://fairsharing.org/FAIRsharing.6s749p)  provides a list of SPARQL (URL_TO_INSERT_RECORD-ABBREV_2194 https://fairsharing.org/FAIRsharing.87ccfd)  query examples,
...
Like `RDF (URL_TO_INSERT_RECORD-ABBREV_2195 https://fairsharing.org/FAIRsharing.p77ph9)  graphs`, `property graphs(PG)` are also used to build `knowledge graphs`.
However, unlike `RDF (URL_TO_INSERT_RECORD-ABBREV_2196 https://fairsharing.org/FAIRsharing.p77ph9)  graphs`, `property graphs` allows the vertices (aka the `edge`) to carry *annotations*,
...
`Property graphs` have inherent interesting properties which set them aside from `RDF (URL_TO_INSERT_RECORD-ABBREV_2197 https://fairsharing.org/FAIRsharing.p77ph9)  graphs`.
...
Reactome (URL_TO_INSERT_RECORD-NAME_2198 https://fairsharing.org/FAIRsharing.tf6kj8)  {footcite}`pmid29377902` and KnetMiners {footcite}`pmid30085931`.

* The [Reactome database](https://reactome.org/) builds on Neo4j to allow navigation of reactions and pathways.

A complete tutorial to query Reactome (URL_TO_INSERT_RECORD-NAME_2199 https://fairsharing.org/FAIRsharing.tf6kj8)  using the `Cypher language` to interrogate the underlying Neo4j store is
...
* The [PDBe-KB](PD (URL_TO_INSERT_RECORD-ABBREV_2200 https://fairsharing.org/FAIRsharing.26ek1v) Be-KG https://www.ebi.ac.uk/pdbe (URL_TO_INSERT_RECORD-HOMEPAGE_2201 https://fairsharing.org/FAIRsharing.26ek1v) /pdbe-kb/graph-download) is another relevant resources in the fields of
bioinformatics which is available as a Neo4j graph database. PDBe (URL_TO_INSERT_RECORD-ABBREV_2202 https://fairsharing.org/FAIRsharing.26ek1v) -KB (URL_TO_INSERT_RECORD-ABBREV_2204 https://fairsharing.org/FAIRsharing.sFzdV7)  is a community-driven resource managed by the PDBe (URL_TO_INSERT_RECORD-ABBREV_2203 https://fairsharing.org/FAIRsharing.26ek1v) 
team, collating functional annotations and predictions for structure data in the PDB (URL_TO_INSERT_RECORD-ABBREV_2205 https://fairsharing.org/FAIRsharing.9y4cqw)  archive, the content of which is distributed
under CC-BY-4 license. PDFe-KB can be downloaded [here](PD (URL_TO_INSERT_RECORD-ABBREV_2206 https://fairsharing.org/FAIRsharing.26ek1v) Be-KG https://www.ebi.ac.uk/pdbe (URL_TO_INSERT_RECORD-HOMEPAGE_2207 https://fairsharing.org/FAIRsharing.26ek1v) /pdbe-kb/graph-download).
...
Neo4J open-sourced the Cypher query language and made it available via GitHub (URL_TO_INSERT_RECORD-NAME_2208 https://fairsharing.org/FAIRsharing.c55d5e)  as part of the [open-cypher](https://github.com/opencypher) project
...
1. RDF (URL_TO_INSERT_RECORD-ABBREV_2209 https://fairsharing.org/FAIRsharing.p77ph9)  graphs technology is backed by a large number of W3C standards for the **semantic web**.
    >- W3C RDF (URL_TO_INSERT_RECORD-ABBREV_2210 https://fairsharing.org/FAIRsharing.p77ph9) 
    >- WC3 RDFS (URL_TO_INSERT_RECORD-ABBREV_2211 https://fairsharing.org/FAIRsharing.v9n3gk) 
    >- W3C OWL (URL_TO_INSERT_RECORD-ABBREV_2212 https://fairsharing.org/FAIRsharing.atygwy) 
    >- W3C SHACL (URL_TO_INSERT_RECORD-ABBREV_2213 https://fairsharing.org/FAIRsharing.f1449d) 
    >- W3C SPARQL (URL_TO_INSERT_RECORD-ABBREV_2214 https://fairsharing.org/FAIRsharing.87ccfd)  1.1

2. Content Validation
    >- RDF (URL_TO_INSERT_RECORD-ABBREV_2215 https://fairsharing.org/FAIRsharing.p77ph9)  graphs content can be validated (i.e. checked) with 2 equally functional `constraint` languages,
    SHEX and SHACL (URL_TO_INSERT_RECORD-ABBREV_2216 https://fairsharing.org/FAIRsharing.f1449d) . 
    Using these languages, the "shape" of the RDF (URL_TO_INSERT_RECORD-ABBREV_2217 https://fairsharing.org/FAIRsharing.p77ph9)  graph can be controlled.
...
Besides this point, two additional features can give RDF (URL_TO_INSERT_RECORD-ABBREV_2218 https://fairsharing.org/FAIRsharing.p77ph9)  graphs the edge (no pun intended!) over labeled property graphs
(even if it also depends on the use cases and ultimate goal):

3. IRI support and Linked data
    >- the RDF (URL_TO_INSERT_RECORD-ABBREV_2219 https://fairsharing.org/FAIRsharing.p77ph9)  specification by construction allows the use of IRI to uniquely identify nodes
    and have globally unique resolvable identifiers for resources.

4. Native semantics and the possibility of inference
    >- Backed by RDFS (URL_TO_INSERT_RECORD-ABBREV_2221 https://fairsharing.org/FAIRsharing.v9n3gk)  and OWL (URL_TO_INSERT_RECORD-ABBREV_2222 https://fairsharing.org/FAIRsharing.atygwy)  semantics, RDF (URL_TO_INSERT_RECORD-ABBREV_2220 https://fairsharing.org/FAIRsharing.p77ph9)  graphs are built on a technology stack developed to deliver the
...
of between RDF (URL_TO_INSERT_RECORD-ABBREV_2223 https://fairsharing.org/FAIRsharing.p77ph9)  triple stores and Property graph in the context of Glycan substructure and their assessment can serve as
...
metadata, data about the data  in a FAIR (URL_TO_INSERT_RECORD-ABBREV_2224 https://fairsharing.org/FAIRsharing.WWI10U)  way.
...
> Ontologies also rely on RDF (URL_TO_INSERT_RECORD-ABBREV_2225 https://fairsharing.org/FAIRsharing.p77ph9)  language for their representation but their purpose is different.
> 
...
> One needs to add a layer of semantics to `type` each of the element of an RDF (URL_TO_INSERT_RECORD-ABBREV_2226 https://fairsharing.org/FAIRsharing.p77ph9)  statement.
> 
>```bash
>@prefix go: <go:>
>@prefix uniprot: <uniprot:>
>@prefix chebi: <chebi:>
> P53 gene transcript a RDF (URL_TO_INSERT_RECORD-ABBREV_2227 https://fairsharing.org/FAIRsharing.p77ph9) :type go:Transcript;
> DNA a RDF (URL_TO_INSERT_RECORD-ABBREV_2228 https://fairsharing.org/FAIRsharing.p77ph9) :type chebi:molecularEntity
> binds_to
>```
>
