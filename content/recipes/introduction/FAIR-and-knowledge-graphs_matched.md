...
1. the relation between FAIR (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.WWI10U)  and KGs.
...
5. the impact of graph-based representations on what it means to deliver FAIR (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.WWI10U)  data and services.
...
FAIR (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.WWI10U)  is chiefly about three things: metadata, metadata and metadata. 
...
the FAIR (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.WWI10U)  principles (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.WWI10U) . 
Thus, providing metadata about a dataset in the form of Linked Data Graph is a significant path towards making data FAIR (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.WWI10U) .
...
> But `FAIR (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.WWI10U)  data` and `knowledge graphs` are not equivalent. Not all FAIR (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.WWI10U)  data is a knowledge graph and not all knowledge graphs are FAIR (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.WWI10U) .
...
standing for "Resource Description Framework (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.p77ph9) ", one of the World Wide Web Consortium (W3C) standard (URL_TO_INSERT_TERM https://fairsharing.org/search?fairsharingRegistry=Standard) s supporting the vision of a **Semantic Web** as 
...
````markdown
"@wdt": "https://www.wikidata.org (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.6s749p) /wiki/"
[wdt:Q283350](https://www.wikidata.org (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.6s749p) /wiki/Q283350) [wdt:Property:P129](https://www.wikidata.org (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.6s749p) /wiki/Property:P129) 
[wdt:Q7430](https://www.wikidata.org (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.6s749p) /wiki/Q7430)
````
``````

The `RDF (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.p77ph9)  syntax` allows the expression of `RDF (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.p77ph9)  statements`, which can be built and grouped (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.31385c)  in an `RDF (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.p77ph9)  graph`.
...
RDF (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.p77ph9)  graph objects can be persisted in specialized database (URL_TO_INSERT_TERM https://fairsharing.org/search?fairsharingRegistry=Database) s, `RDF (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.p77ph9)  graph database (URL_TO_INSERT_TERM https://fairsharing.org/search?fairsharingRegistry=Database) s` also known as `RDF (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.p77ph9)  triple stores`. 
Some of the most performant and successful solutions are:
- [Allegrograph](https://allegrograph.com/products/allegrograph/)
- [Blazegraph](https://github.com (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.c55d5e) /blazegraph)
...
To validate and control the quality of the fast emerging RDF (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.p77ph9)  triples.
The W3C has produced a specification detailing a constraint language which allows data managers to control the so-called
`shape` of the RDF (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.p77ph9)  graph coming in. The W3C SHAC (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.md3e78) L (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.j9y503)  (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.f1449d)  SHApe Constraint Language, known as [SHACL](https://www.w3.org/TR/shacl (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.f1449d) /) (pronounced `shackle`),
allow to express a set of conditions to validate RDF (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.p77ph9)  graphs/RDF (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.p77ph9)  statements. SHAC (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.md3e78) L (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.j9y503)  (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.f1449d)  expressions are RDF (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.p77ph9)  statements 
and the constraint profiles can be stored in an RDF (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.p77ph9)  triple store. 
SHAC (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.md3e78) L (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.j9y503)  (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.f1449d)  specifications are implemented in the [TopQuadrant TopBraid Composer tool](https://www.topquadrant.com/products/topbraid-composer/).
...
RDF (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.p77ph9)  graphs stored in RDF (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.p77ph9)  triple stores can be queried using a dedicated query language defined by a W3C specification known as 
[SP (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.s63y3p) ARQL (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.87ccfd)  1.1](https://www.w3.org/TR/sparql11-query/).
SP (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.s63y3p) ARQL (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.87ccfd)  stands for `SP (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.s63y3p) ARQL (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.87ccfd)  Query Language`, (pronounced `sparkle`) {footcite}`sparql`. 
The results of a SP (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.s63y3p) ARQL (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.87ccfd)  query are a `result set` or `RDF (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.p77ph9)  graph` and is therefore **a collection (URL_TO_INSERT_TERM https://fairsharing.org/search?recordType=collection)  of RDF (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.p77ph9)  triples**.

An impressive feature of the SP (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.s63y3p) ARQL (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.87ccfd)  query language is its ability to perform `mashups` by performing federated queries
over a number of 'SERVICES', i.e. RDF (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.p77ph9)  triple store endpoints and return an RDF (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.p77ph9)  graph which contains triples assembled
...
---
width: 1000px
name: wikidata (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.6s749p)  sparql
alt: wikidata (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.6s749p)  sparql
---
A SP (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.s63y3p) ARQL (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.87ccfd)  query over Wikidata (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.6s749p)  (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.6s749p)  RDF (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.p77ph9)  endpoint
```
````
...
---
width: 1000px
name: wikidata (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.6s749p)  sparql endpoint
alt: wikidata (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.6s749p)  sparql endpoint
---
A SP (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.s63y3p) ARQL (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.87ccfd)  query over Wikidata (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.6s749p)  (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.6s749p)  RDF (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.p77ph9)  endpoint: Cell lines with names that could also be URL (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.9d38e2) s (Internet of Cell Lines)
```
````

Wikidata (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.6s749p)  (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.6s749p)  provides a list of SP (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.s63y3p) ARQL (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.87ccfd)  query examples,
see [here](https://www.wikidata.org (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.6s749p) /wiki/Wikidata:SPARQL_query_service/queries/examples#Cell_lines_with_names_that_could_also_be_URLs_\(Internet_of_Cell_Lines\)).


### 2. Property graphs
    
Like `RDF (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.p77ph9)  graphs`, `property graphs(PG)` are also used to build `knowledge graphs`.
However, unlike `RDF (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.p77ph9)  graphs`, `property graphs` allows the vertices (aka the `edge`) to carry *annotations*,
...
`Property graphs` have inherent interesting (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.q7bkqr)  properties which set them aside from `RDF (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.p77ph9)  graphs`.
...
underlying data structure.  As a framework, Tinkerpop is developed (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.31385c)  as an abstract layer, meant to ensure vendor 
neutrality, allowing developers to decide about arch (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.52b22c) itecture choices and tests while coding against a standard (URL_TO_INSERT_TERM https://fairsharing.org/search?fairsharingRegistry=Standard) ized
interface.
...
Backing the approach, the team developed (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.31385c)  a dedicated query language for `Labeled property graphs`. 
...
ensembl (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.fx0mw7) e of molecular pathways, that is to say graphs of interactions and reactions.
An illustration of that natural fit is the uptake of the Neo4j technology by a project (URL_TO_INSERT_TERM https://fairsharing.org/search?recordType=project)  such as ` Disease Map (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.53edcc) s`, 
Reactome (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.tf6kj8)  {footcite}`pmid29377902` and KnetMiner (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.826b4a)  (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.826b4a) s {footcite}`pmid30085931`.

* The [Reactome (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.tf6kj8)  database](https://reactome.org (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.tf6kj8) /) builds on Neo4j to allow navigation of reactions and pathways.

A complete tutorial to query Reactome (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.tf6kj8)  using the `Cypher language` to interrogate the underlying Neo4j store is
available [here](https://reactome.org (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.tf6kj8) /dev/graph-database/extract-participating-molecules).
...
---
width: 600px
name: reactome (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.tf6kj8)  cypher query
alt: reactome (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.tf6kj8)  cypher query
---
CYPHER query example on Reactome (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.tf6kj8) : Comparison with SQL. From Fabregat et al,2018. 10.1371/journal (URL_TO_INSERT_TERM https://fairsharing.org/search?recordType=journal) .pcbi.1005968
```
````

* The [PDB (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.9y4cqw) e (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.26ek1v) -KB (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.sFzdV7) ](PDB (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.9y4cqw) e (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.26ek1v) -KG https://www.ebi.ac.uk/pdbe (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.26ek1v) /pdbe-kb/graph-download) is another relevant resources in the fields of
bioinformat (URL_TO_INSERT_TERM https://fairsharing.org/search?recordType=model_and_format) ics which is available as a Neo4j graph database (URL_TO_INSERT_TERM https://fairsharing.org/search?fairsharingRegistry=Database) . PDB (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.9y4cqw) e (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.26ek1v) -KB (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.sFzdV7)  is a community-driven resource managed by the PDB (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.9y4cqw) e (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.26ek1v) 
team, collating functional annotations and predictions for structure data in the PDB (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.9y4cqw)  arch (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.52b22c) ive, the content of which is distributed
under CC-BY-4 license. PDFe-KB can be downloaded [here](PDB (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.9y4cqw) e (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.26ek1v) -KG https://www.ebi.ac.uk/pdbe (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.26ek1v) /pdbe-kb/graph-download).
...
Neo4J open-sourced the Cypher query language and made it available via GitHub (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.c55d5e)  (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.c55d5e)  as part of the [open-cypher](https://github.com (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.c55d5e) /opencypher) project (URL_TO_INSERT_TERM https://fairsharing.org/search?recordType=project) 
...
1. RDF (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.p77ph9)  graphs technology is backed by a large number of W3C standard (URL_TO_INSERT_TERM https://fairsharing.org/search?fairsharingRegistry=Standard) s for the **semantic web**.
    >- W3C RDF (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.p77ph9) 
    >- WC3 RDF (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.p77ph9) S (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.v9n3gk) 
    >- W3C OWL (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.atygwy) 
    >- W3C SHAC (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.md3e78) L (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.j9y503)  (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.f1449d) 
    >- W3C SP (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.s63y3p) ARQL (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.87ccfd)  1.1

2. Content Validation
    >- RDF (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.p77ph9)  graphs content can be validated (i.e. checked) with 2 equally functional `constraint` languages,
    SHEX and SHAC (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.md3e78) L (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.j9y503)  (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.f1449d) . 
    Using these languages, the "shape" of the RDF (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.p77ph9)  graph can be controlled.
...
Besides this point, two additional features can give RDF (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.p77ph9)  graphs the edge (no pun intended!) over labeled property graphs
(even if it also depends on the use cases and ultimate goal):

3. IRI support and Linked data
    >- the RDF (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.p77ph9)  specification by construction allows the use of IRI to uniquely identify nodes
...
4. Native semantics and the possibility of inference
    >- Backed by RDF (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.p77ph9) S (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.v9n3gk)  and OWL (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.atygwy)  semantics, RDF (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.p77ph9)  graphs are built on a technology stack developed (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.31385c)  to deliver the
...
of between RDF (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.p77ph9)  triple stores and Property graph in the context of Glycan substructure and their assessment can serve as
...
metadata, data about the data  in a FAIR (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.WWI10U)  way.
...
> One step is known as 'Name Entity Recognition' (NER), which as the name says aims to cast string (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.9b7wvk) s into specific bins such 'noun', 'verb', 'qualifier', etc.
> Another step, following the NER step would be the anchoring of these entities to a semantic framework and this step is known as 'semantic mark-up' or sometimes 'map (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.53edcc) ping to ontologies (URL_TO_INSERT_TERM https://fairsharing.org/search?recordType=terminology_artefact) '.
>
...
> knowledge graphs. Ontologies (URL_TO_INSERT_TERM https://fairsharing.org/search?recordType=terminology_artefact)  are **formal resources developed (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.31385c)  by experts in a domain**.
> Ontologies (URL_TO_INSERT_TERM https://fairsharing.org/search?recordType=terminology_artefact)  also rely on RDF (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.p77ph9)  language for their representation but their purpose is different.
> 
...
> 
> The representation is neat and tidy but one can not help noticing that all the string (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.9b7wvk) s are stored as free text.
> A problem arises when trying to accumulate knowledge from different sources.
> One needs to add a layer of semantics to `type` each of the element of an RDF (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.p77ph9)  statement.
> 
>```bash
>@prefix go: <go:>
>@prefix uniprot: <uniprot:>
>@prefix chebi: <chebi:>
> P53 gene transcript a RDF (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.p77ph9) :type go:Transcript;
> DNA a RDF (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.p77ph9) :type chebi:molecularEntity
> binds_to
>```
>
...
[6]. https://www.ncbi.nlm.nih.gov/pmc (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.wpt5mp) /articles/PMC7327409/ (Constructing knowledge graphs and their biomedical applications)

[7]. https://douroucouli.wordpress.com/2019/03/14/biological-knowledge-graph-modeling-design-patterns/

[8]. wikidata (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.6s749p) 

[9]. monarch (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.52b22c)  knowledge graph

[10]. NCAT (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.3a96ae) S biomedical data translator
