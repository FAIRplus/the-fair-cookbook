...
1. the relation between FAIR(URL_TO_INSERT_RECORD https://www.go-fair.org/fair-principles/) and KGs.
...
5. the impact of graph-based representations on what it means to deliver FAIR(URL_TO_INSERT_RECORD https://www.go-fair.org/fair-principles/) data and services.
...
FAIR(URL_TO_INSERT_RECORD https://www.go-fair.org/fair-principles/) is chiefly about three things: metadata, metadata and metadata. 
...
````markdown
"@wdt": "https://www.wikidata.org(URL_TO_INSERT_RECORD http://wikidata.org/)/wiki/"
[wdt:Q283350](https://www.wikidata.org(URL_TO_INSERT_RECORD http://wikidata.org/)/wiki/Q283350) [wdt:Property:P129](https://www.wikidata.org(URL_TO_INSERT_RECORD http://wikidata.org/)/wiki/Property:P129) 
[wdt:Q7430](https://www.wikidata.org(URL_TO_INSERT_RECORD http://wikidata.org/)/wiki/Q7430)
````
``````

The `RDF(URL_TO_INSERT_RECORD http://www.w3.org/TR/2014/REC-rdf11-concepts-20140225/) syntax` allows the expression of `RDF(URL_TO_INSERT_RECORD http://www.w3.org/TR/2014/REC-rdf11-concepts-20140225/) statements`, which can be built and grouped(URL_TO_INSERT_RECORD https://www.cog-genomics.org/plink2/formats#ped) in an `RDF(URL_TO_INSERT_RECORD http://www.w3.org/TR/2014/REC-rdf11-concepts-20140225/) graph`.
...
To validate and control the quality of the fast emerging RDF(URL_TO_INSERT_RECORD http://www.w3.org/TR/2014/REC-rdf11-concepts-20140225/) triples.
The W3C has produced a specification detailing a constraint language which allows data managers to control the so-called
`shape` of the RDF(URL_TO_INSERT_RECORD http://www.w3.org/TR/2014/REC-rdf11-concepts-20140225/) graph coming in. The W3C SHAC(URL_TO_INSERT_RECORD https://ac.tdwg.org/introduction/)L(URL_TO_INSERT_RECORD https://www.w3.org/TR/shacl/)(URL_TO_INSERT_RECORD https://github.com/obophenotype/cell-ontology) SHApe Constraint Language, known as [SHACL](https://www.w3.org/TR/shacl(URL_TO_INSERT_RECORD https://www.w3.org/TR/shacl/)/) (pronounced `shackle`),
allow to express a set of conditions to validate RDF(URL_TO_INSERT_RECORD http://www.w3.org/TR/2014/REC-rdf11-concepts-20140225/) graphs/RDF(URL_TO_INSERT_RECORD http://www.w3.org/TR/2014/REC-rdf11-concepts-20140225/) statements. SHAC(URL_TO_INSERT_RECORD https://ac.tdwg.org/introduction/)L(URL_TO_INSERT_RECORD https://www.w3.org/TR/shacl/)(URL_TO_INSERT_RECORD https://github.com/obophenotype/cell-ontology) expressions are RDF(URL_TO_INSERT_RECORD http://www.w3.org/TR/2014/REC-rdf11-concepts-20140225/) statements 
and the constraint profiles can be stored in an RDF(URL_TO_INSERT_RECORD http://www.w3.org/TR/2014/REC-rdf11-concepts-20140225/) triple store. 
SHAC(URL_TO_INSERT_RECORD https://ac.tdwg.org/introduction/)L(URL_TO_INSERT_RECORD https://www.w3.org/TR/shacl/)(URL_TO_INSERT_RECORD https://github.com/obophenotype/cell-ontology) specifications are implemented in the [TopQuadrant TopBraid Composer tool](https://www.topquadrant.com/products/topbraid-composer/).
...
---
width: 1000px
name: wikidata(URL_TO_INSERT_RECORD http://wikidata.org/) sparql
alt: wikidata(URL_TO_INSERT_RECORD http://wikidata.org/) sparql
---
A SP(URL_TO_INSERT_RECORD http://bioportal.bioontology.org/ontologies/SP)ARQL(URL_TO_INSERT_RECORD http://www.w3.org/TR/sparql11-overview/) query over Wikidata(URL_TO_INSERT_RECORD http://wikidata.org/)(URL_TO_INSERT_RECORD http://wikidata.org/) RDF(URL_TO_INSERT_RECORD http://www.w3.org/TR/2014/REC-rdf11-concepts-20140225/) endpoint
```
````
...
---
width: 1000px
name: wikidata(URL_TO_INSERT_RECORD http://wikidata.org/) sparql endpoint
alt: wikidata(URL_TO_INSERT_RECORD http://wikidata.org/) sparql endpoint
---
A SP(URL_TO_INSERT_RECORD http://bioportal.bioontology.org/ontologies/SP)ARQL(URL_TO_INSERT_RECORD http://www.w3.org/TR/sparql11-overview/) query over Wikidata(URL_TO_INSERT_RECORD http://wikidata.org/)(URL_TO_INSERT_RECORD http://wikidata.org/) RDF(URL_TO_INSERT_RECORD http://www.w3.org/TR/2014/REC-rdf11-concepts-20140225/) endpoint: Cell lines with names that could also be URL(URL_TO_INSERT_RECORD https://tools.ietf.org/html/rfc1630)s (Internet of Cell Lines)
```
````

Wikidata(URL_TO_INSERT_RECORD http://wikidata.org/)(URL_TO_INSERT_RECORD http://wikidata.org/) provides a list of SP(URL_TO_INSERT_RECORD http://bioportal.bioontology.org/ontologies/SP)ARQL(URL_TO_INSERT_RECORD http://www.w3.org/TR/sparql11-overview/) query examples,
see [here](https://www.wikidata.org(URL_TO_INSERT_RECORD http://wikidata.org/)/wiki/Wikidata:SPARQL_query_service/queries/examples#Cell_lines_with_names_that_could_also_be_URLs_\(Internet_of_Cell_Lines\)).


### 2. Property graphs
    
Like `RDF(URL_TO_INSERT_RECORD http://www.w3.org/TR/2014/REC-rdf11-concepts-20140225/) graphs`, `property graphs(PG)` are also used to build `knowledge graphs`.
However, unlike `RDF(URL_TO_INSERT_RECORD http://www.w3.org/TR/2014/REC-rdf11-concepts-20140225/) graphs`, `property graphs` allows the vertices (aka the `edge`) to carry *annotations*,
...
A complete tutorial to query Reactome(URL_TO_INSERT_RECORD https://reactome.org) using the `Cypher language` to interrogate the underlying Neo4j store is
available [here](https://reactome.org(URL_TO_INSERT_RECORD https://reactome.org)/dev/graph-database/extract-participating-molecules).
...
1. RDF(URL_TO_INSERT_RECORD http://www.w3.org/TR/2014/REC-rdf11-concepts-20140225/) graphs technology is backed by a large number of W3C standard (URL_TO_INSERT_TERM https://fairsharing.org/search?fairsharingRegistry=Standard)s for the **semantic web**.
    ...
    >- W3C SHAC(URL_TO_INSERT_RECORD https://ac.tdwg.org/introduction/)L(URL_TO_INSERT_RECORD https://www.w3.org/TR/shacl/)(URL_TO_INSERT_RECORD https://github.com/obophenotype/cell-ontology)
    >- W3C SP(URL_TO_INSERT_RECORD http://bioportal.bioontology.org/ontologies/SP)ARQL(URL_TO_INSERT_RECORD http://www.w3.org/TR/sparql11-overview/) 1.1

2. Content Validation
    >- RDF(URL_TO_INSERT_RECORD http://www.w3.org/TR/2014/REC-rdf11-concepts-20140225/) graphs content can be validated (i.e. checked) with 2 equally functional `constraint` languages,
...
metadata, data about the data  in a FAIR(URL_TO_INSERT_RECORD https://www.go-fair.org/fair-principles/) way.
...
> One needs to add a layer of semantics to `type` each of the element of an RDF(URL_TO_INSERT_RECORD http://www.w3.org/TR/2014/REC-rdf11-concepts-20140225/) statement.
> 
>```bash
>@prefix go: <go:>
>@prefix uniprot: <uniprot:>
>@prefix chebi: <chebi:>
> P53 gene transcript a RDF(URL_TO_INSERT_RECORD http://www.w3.org/TR/2014/REC-rdf11-concepts-20140225/):type go:Transcript;
> DNA a RDF(URL_TO_INSERT_RECORD http://www.w3.org/TR/2014/REC-rdf11-concepts-20140225/):type chebi:molecularEntity
> binds_to
>```
>
...
[6]. https://www.ncbi.nlm.nih.gov/pmc(URL_TO_INSERT_RECORD http://www.ncbi.nlm.nih.gov/pmc/)/articles/PMC7327409/ (Constructing knowledge graphs and their biomedical applications)

[7]. https://douroucouli.wordpress.com/2019/03/14/biological-knowledge-graph-modeling-design-patterns/

[8]. wikidata(URL_TO_INSERT_RECORD http://wikidata.org/)

[9]. monarch(URL_TO_INSERT_RECORD https://arch.library.northwestern.edu/) knowledge graph

[10]. NCAT(URL_TO_INSERT_RECORD http://cat.aii.caas.cn/)S biomedical data translator
