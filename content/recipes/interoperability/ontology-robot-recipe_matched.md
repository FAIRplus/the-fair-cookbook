...
> The main purpose of this recipe is building an application ontology (URL_TO_INSERT_TERM https://fairsharing.org/search?recordType=terminology_artefact)  from source ontologies (URL_TO_INSERT_TERM https://fairsharing.org/search?recordType=terminology_artefact)  using `RO (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.9w8ea0)  (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.504c6c)  (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.cp0ybc) BO (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.847069)  (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.cbz72b) T` {footcite}`pmid31357927` via a sustainable dynamic pipeline to allow seamless integration of source ontology (URL_TO_INSERT_TERM https://fairsharing.org/search?recordType=terminology_artefact)  updates {footcite}`Arp2015`. 

An application ontology (URL_TO_INSERT_TERM https://fairsharing.org/search?recordType=terminology_artefact)  is a semantic artefact which is developed (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.31385c)  to answer the needs of a specific application or focus. 
...
| :------------- | :------------- | :------------- |
| [Ontology (URL_TO_INSERT_TERM https://fairsharing.org/search?recordType=terminology_artefact)  and terminology](http://edamontology.org (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.a6r7zs) /topic_0089)  | [tsv,OWL (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.atygwy) ]|OWL (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.atygwy) |
...
| :------------- | :------------- | :------------- |
| [OWL](https://fairsharing.org (URL_TO_INSERT_RECORD http://127.0.0.1:8080/3518)  (URL_TO_INSERT_RECORD http://127.0.0.1:8080/3536)  (URL_TO_INSERT_RECORD http://127.0.0.1:8080/3538) /FAIRsharing.atygwy)  |   |   |
| [OBO](https://fairsharing.org (URL_TO_INSERT_RECORD http://127.0.0.1:8080/3518)  (URL_TO_INSERT_RECORD http://127.0.0.1:8080/3536)  (URL_TO_INSERT_RECORD http://127.0.0.1:8080/3538) /FAIRsharing.aa0eat)  |   |    |
...
| :------------- | :------------- | :------------ |
| RO (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.9w8ea0)  (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.504c6c)  (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.cp0ybc) BO (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.847069)  (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.cbz72b) T | [http://robot.obolibrary.org/](http://robot.obolibrary.org/) | ontology (URL_TO_INSERT_TERM https://fairsharing.org/search?recordType=terminology_artefact)  management cli |
| Ontology (URL_TO_INSERT_TERM https://fairsharing.org/search?recordType=terminology_artefact)  development kit | [https://github.com (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.c55d5e) /INCATools/ontology-development-kit](https://github.com (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.c55d5e) /INCATools/ontology-development-kit) (comes with RO (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.9w8ea0)  (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.504c6c)  (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.cp0ybc) BO (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.847069)  (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.cbz72b) T included)| ontology (URL_TO_INSERT_TERM https://fairsharing.org/search?recordType=terminology_artefact)  management environment |
...
| SP (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.s63y3p) ARQL (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.87ccfd)  | [https://www.w3.org/TR/sparql11-query/](https://www.w3.org/TR/sparql11-query/) | ontology (URL_TO_INSERT_TERM https://fairsharing.org/search?recordType=terminology_artefact)  query language |
...
<!-- [here](https://github.com (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.c55d5e) /FAIRplus/the-fair-cookbook/blob/ontology_robot_recipe/docs/content/recipes/ontology-robot/competency_questions.md).  -->
...
|                                                       | ➕ Identify all data generated from tissues (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.yXPvpU)  taken from patients suffering from a specific disease.                                     |
|                                                       | ➕ Identify all data generated from a specific tissues (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.yXPvpU)  obtained from mouse model (URL_TO_INSERT_TERM https://fairsharing.org/search?recordType=model_and_format) s that are related to a specific disease.              |
...
|                                                       | ➕ What is the expression of PP (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.tghhc4) ARg / growths factors in lung tissue from IPF patients?                                                 |
|                                                       | ➕ What is the expression of PP (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.tghhc4) ARg / growths factors in primary cells obtained from lung tissue from healthy subjects?                 |
|                                                       | ➕ What is the expression of PP (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.tghhc4) ARg / growths factors in all available tissues (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.yXPvpU)  obtained from healthy subjects?                          |
...
|                                                       | ➕ What is the expression of PP (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.tghhc4) ARg in lung tissue upon treatment with a specific compound in patients suffering from a specific disease |
...
| GSE116987March (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.52b22c) er2019 | EX101_1   | HSC CCl4-treated w0 |        |               | Hepatic Stellate Cell |          | NA                            |        | Mus musculus |
...
To build an `application ontology (URL_TO_INSERT_TERM https://fairsharing.org/search?recordType=terminology_artefact) ` that supports communication between different data resources, it is recommended to reuse existing (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.q7bkqr)  terms from existing (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.q7bkqr)  reference ontologies (URL_TO_INSERT_TERM https://fairsharing.org/search?recordType=terminology_artefact)  instead of creating new terms.
...
When selecting reference ontologies (URL_TO_INSERT_TERM https://fairsharing.org/search?recordType=terminology_artefact)  as source ontologies (URL_TO_INSERT_TERM https://fairsharing.org/search?recordType=terminology_artefact) , the reusability and sustainability of the source ontology (URL_TO_INSERT_TERM https://fairsharing.org/search?recordType=terminology_artefact)  need to be considered. Many ontologies (URL_TO_INSERT_TERM https://fairsharing.org/search?recordType=terminology_artefact)  in [the OBO (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.847069)  (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.cbz72b)  foundry (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.847069) ](http://www.obofoundry.org (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.847069) /) use the [CC-BY](https://creativecommons.org/licenses/by/2.0/) licence, allowing sharing and adaptation. Such ontologies (URL_TO_INSERT_TERM https://fairsharing.org/search?recordType=terminology_artefact)  can be directly used as source ontology (URL_TO_INSERT_TERM https://fairsharing.org/search?recordType=terminology_artefact) . Reference ontologies (URL_TO_INSERT_TERM https://fairsharing.org/search?recordType=terminology_artefact)  with similar umbrella structures can be conveniently combined in the application ontology (URL_TO_INSERT_TERM https://fairsharing.org/search?recordType=terminology_artefact) . The format (URL_TO_INSERT_TERM https://fairsharing.org/search?recordType=model_and_format)  and maintenance of the reference ontology (URL_TO_INSERT_TERM https://fairsharing.org/search?recordType=terminology_artefact)  shall also be considered.

Specific use cases and requirements from the target dataset also affect the choice of source ontologies (URL_TO_INSERT_TERM https://fairsharing.org/search?recordType=terminology_artefact) . For use cases focusing on extracting data from heterogeneous datasets with complicated data types and data relationships, reference ontologies (URL_TO_INSERT_TERM https://fairsharing.org/search?recordType=terminology_artefact)  with rich term relationships are preferred. The interpretation of each term also depends on the context and requirements of the target dataset. For example, _"hypertension"_ can be either interpreted as a _phenotype_ and map (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.53edcc) ped (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.31385c)  to phenotype ontologies (URL_TO_INSERT_TERM https://fairsharing.org/search?recordType=terminology_artefact) , or a _disease_ map (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.53edcc) ped (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.31385c)  to disease ontologies (URL_TO_INSERT_TERM https://fairsharing.org/search?recordType=terminology_artefact) .


The example dataset includes metadata related to disease, species, cell lines, tissues (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.yXPvpU)  and biological sex. _Table 2_ lists some reference ontologies (URL_TO_INSERT_TERM https://fairsharing.org/search?recordType=terminology_artefact)  available in corresponding domains. In this recipe, we selected _MO (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.qs4x5m) NDO (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.b2979t) _ for disease domain, _UBERO (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.nwgynk)  (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.9w8ea0)  (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.504c6c)  (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.cp0ybc) N (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.4c0b6b) _ for anatomy, _NCBItaxon_ for species taxonomy and _PATO (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.ayjdsm)  (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.w69t6r)  (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.ezwdhz) _ for biological sex. 


|Domain|Reference Ontologies (URL_TO_INSERT_TERM https://fairsharing.org/search?recordType=terminology_artefact) |
|----|----|
|Disease| [Mondo Disease Ontology (URL_TO_INSERT_TERM https://fairsharing.org/search?recordType=terminology_artefact)  (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.8b6wfq) , MONDO](http://www.obofoundry.org (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.847069) /ontology/mondo.html)<br> [Disease Ontology (URL_TO_INSERT_TERM https://fairsharing.org/search?recordType=terminology_artefact)  (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.8b6wfq) , DOID](https://disease-ontology.org/)<br> |
|Species|[NCBI organismal classification, NCBItaxon](http://www.obofoundry.org (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.847069) /ontology/ncbitaxon.html)|
|Cell line|[Cell Ontology (URL_TO_INSERT_TERM https://fairsharing.org/search?recordType=terminology_artefact)  (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.j9y503) , CL](http://www.obofoundry.org (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.847069) /ontology/cl.html)<br> [Cell Line Ontology (URL_TO_INSERT_TERM https://fairsharing.org/search?recordType=terminology_artefact)  (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.4dvtcz) , CL (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.j9y503) O (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.4dvtcz) ](http://www.obofoundry.org (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.847069) /ontology/clo.html)|
|Tissue|[NCI Thesaurus (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.4cvwxa)  (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.aqnss4)  OBO (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.847069)  (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.cbz72b)  Edition, NCIT](http://www.obofoundry.org (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.847069) /ontology/ncit.html)<br> [Ontology (URL_TO_INSERT_TERM https://fairsharing.org/search?recordType=terminology_artefact)  for MIRNA Target, OMIT](http://www.obofoundry.org (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.847069) /ontology/omit.html)<br> [Uberon multi-species anatomy ontology (URL_TO_INSERT_TERM https://fairsharing.org/search?recordType=terminology_artefact) , UBERO (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.nwgynk)  (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.9w8ea0)  (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.504c6c)  (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.cp0ybc) N (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.4c0b6b) ](http://www.obofoundry.org (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.847069) /ontology/uberon.html)|
|Biological Sex|[Phenotype And Trait Ontology (URL_TO_INSERT_TERM https://fairsharing.org/search?recordType=terminology_artefact) , PATO (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.ayjdsm)  (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.w69t6r)  (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.ezwdhz) ](http://www.obofoundry.org (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.847069) /ontology/pato.html)|
...
The following sample script uses the NCBO (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.cbz72b)  (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.y2dt83)  Annotator web service to get a list of seed terms - i.e., the URI (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.d261e1) s of ontology (URL_TO_INSERT_TERM https://fairsharing.org/search?recordType=terminology_artefact)  classes -.
```python
#Python3
...
Instead of manually maintaining a list of seed terms to generate a module, a term list can be generated on the fly using a `SP (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.s63y3p) ARQL (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.87ccfd)  query`. Here, we generate a subset of `UBERO (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.nwgynk)  (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.9w8ea0)  (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.504c6c)  (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.cp0ybc) N (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.4c0b6b) ` terms which have a cross-reference to either `FMA (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.x56jsy)  (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.pdwqcr)  (for human anatomy)` or `MA (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.pdwqcr)  (for mouse anatomy)` terms, since our example datasets includes human, mouse and rat data.
...
Module extractions from ontologies (URL_TO_INSERT_TERM https://fairsharing.org/search?recordType=terminology_artefact)  can be run manually and in an ad hoc fashion. We would however recommend collecting all steps together into a script or `Makefile` to avoid missing steps. `RO (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.9w8ea0)  (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.504c6c)  (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.cp0ybc) BO (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.847069)  (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.cbz72b) T` steps can in theory be chained together into single large commands. Practical experience however teaches that this can have unexpected consequences as well as making debugging difficult in the event of an issue. It is therefore advisable to split extractions and merges out into individual steps with intermediate artefacts which can be deleted at the end of the process chain.

#### Step 3.1 Get source ontology files

We recommend starting each (re)build of the application ontology (URL_TO_INSERT_TERM https://fairsharing.org/search?recordType=terminology_artefact)  with the latest versions of the source ontologies (URL_TO_INSERT_TERM https://fairsharing.org/search?recordType=terminology_artefact)  unless there is a good reason not to update to the latest version. Ideally, this should be done automatically, for example through a shell script that CURL (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.9d38e2) s all ontologies (URL_TO_INSERT_TERM https://fairsharing.org/search?recordType=terminology_artefact)  from their source URI (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.d261e1) s, e.g.
...
`RO (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.9w8ea0)  (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.504c6c)  (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.cp0ybc) BO (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.847069)  (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.cbz72b) T` supports two types of ontology (URL_TO_INSERT_TERM https://fairsharing.org/search?recordType=terminology_artefact)  module extraction, `Syntactic Locality Module Extractor` (SLME) and `Minimum Informat (URL_TO_INSERT_TERM https://fairsharing.org/search?recordType=model_and_format) ion to Reference an External Ontology (URL_TO_INSERT_TERM https://fairsharing.org/search?recordType=terminology_artefact)  Term` (MIREO (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.w7a76x)  (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.d1zzym) T). `SLME` extractions can be further subdivided into TO (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.w69t6r) P (URL_TO_INSERT_RECORD http://127.0.0.1:8080/707)  (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.yvmb9y)  (top module), `BO (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.cbz72b) T` (bottom module) and `STAR` (fixpoint-nested module). For full details of what these different options entail, see http://robot.obolibrary.org/extract.html. We recommend the use of BO (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.cbz72b) T for comprehensive modules that preserve the links between ontology (URL_TO_INSERT_TERM https://fairsharing.org/search?recordType=terminology_artefact)  classes and the use of `MIREO (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.w7a76x)  (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.d1zzym) T` if relationships apart from parent-child ones are less important. 


#### Step 3.3 Extract modules using seed terms

Using `robot` tool provided by the `OBO (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.847069)  (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.cbz72b)  foundry (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.847069) `, the creation of a module can be done with one command:
...
* *method*: `RO (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.9w8ea0)  (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.504c6c)  (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.cp0ybc) BO (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.847069)  (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.cbz72b) T` uses 4 different algorithms to generate a module.  `TO (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.w69t6r) P (URL_TO_INSERT_RECORD http://127.0.0.1:8080/707)  (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.yvmb9y) `, `BO (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.cbz72b) T`, `STAR` (all from the SLME method), and `MIREO (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.w7a76x)  (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.d1zzym) T`. The first two will create a module  below or above the seed classes (the classes of interest in the target ontology (URL_TO_INSERT_TERM https://fairsharing.org/search?recordType=terminology_artefact) ) respectively. The `STAR` method creates a module by pulling all the properties and axioms of the seed classes but nothing else. `MIREO (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.w7a76x)  (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.d1zzym) T` uses a different methods and offers some more options, in particular when it comes to how many levels up or down (parent and children) are needed.     
...
* *intermediates*: specific to the `MIREO (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.w7a76x)  (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.d1zzym) T` method, it allows to let the algorithm know how much or how little to extract. It has 3 levels (`all`,`minimal`, `none`).
...
* *sources*: optional, a pointer to a file map (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.53edcc) ping .
* *annotate-with-source*: a boolean value true/false. Default is `false`.


The above query, saved under `select_anatomy_subset.sparql` can be used to generate a dynamic seed list, then do a `BO (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.cbz72b) T` extraction: 
...
`RO (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.9w8ea0)  (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.504c6c)  (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.cp0ybc) BO (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.847069)  (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.cbz72b) T` provides a template-driven ontology (URL_TO_INSERT_TERM https://fairsharing.org/search?recordType=terminology_artefact)  term generation system. A `RO (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.9w8ea0)  (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.504c6c)  (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.cp0ybc) BO (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.847069)  (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.cbz72b) T template` is a `tab-separated values (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.a978c9) ` (TSV (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.a978c9) ) or `comma-separated values (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.1943d4) ` (CSV (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.1943d4) ) file that depicts a set of patterns to build ontology (URL_TO_INSERT_TERM https://fairsharing.org/search?recordType=terminology_artefact)  entities - i.e., classes, properties, and individuals -. These templates can be used for modular ontology (URL_TO_INSERT_TERM https://fairsharing.org/search?recordType=terminology_artefact)  development.
After the _Domain Expert_ and the _Use Case/Scenario Owner_ specify the main entity of the use case and its relationships with remaining ontology (URL_TO_INSERT_TERM https://fairsharing.org/search?recordType=terminology_artefact)  entities, the _Ontology (URL_TO_INSERT_TERM https://fairsharing.org/search?recordType=terminology_artefact)  Developer_ generates the `RO (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.9w8ea0)  (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.504c6c)  (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.cp0ybc) BO (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.847069)  (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.cbz72b) T` templates depicting the set of patterns aimed to build the _umbrella_ ontology (URL_TO_INSERT_TERM https://fairsharing.org/search?recordType=terminology_artefact) .

A `RO (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.9w8ea0)  (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.504c6c)  (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.cp0ybc) BO (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.847069)  (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.cbz72b) T` command using a template to build an ontology (URL_TO_INSERT_TERM https://fairsharing.org/search?recordType=terminology_artefact)  is shown below:
...
| -------- | -------- | -------- | -------- |-------- | -------- | -------- |
| ID     | LABEL (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.dp0jvd)      | TYPE (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.b403jy)      | EC % | CHARAC (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.md3e78) TERIS (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.efb730) TIC | DOMA (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.pdwqcr)  (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.g3j5qj) IN | RANGE |
|ex:cl_2 | Class_2 | class |-|-|-|-|
|ex:cl_3 | Class_3 | class |ex:cl_2|-|-|-|
|ex:op_1	|Prop_1| object property|-|Class_2|Class_3| |
|ex:dp_1	|Prop_2| data property|-|functional|Class_2|xsd:string (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.9b7wvk) |
...
The `merge` RO (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.9w8ea0)  (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.504c6c)  (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.cp0ybc) BO (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.847069)  (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.cbz72b) T command allows combining two or more separate input ontology (URL_TO_INSERT_TERM https://fairsharing.org/search?recordType=terminology_artefact)  modules into a single ontology (URL_TO_INSERT_TERM https://fairsharing.org/search?recordType=terminology_artefact) . Following, the `RO (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.9w8ea0)  (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.504c6c)  (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.cp0ybc) BO (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.847069)  (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.cbz72b) T` command merging the umbrella ontology (URL_TO_INSERT_TERM https://fairsharing.org/search?recordType=terminology_artefact)  and the modules is shown:
...
The ontology (URL_TO_INSERT_TERM https://fairsharing.org/search?recordType=terminology_artefact)  materialization uses `OWL (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.atygwy)  reasoners`. `RO (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.9w8ea0)  (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.504c6c)  (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.cp0ybc) BO (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.847069)  (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.cbz72b) T` provides [several ontology (URL_TO_INSERT_TERM https://fairsharing.org/search?recordType=terminology_artefact)  reasoners](http://robot.obolibrary.org/reason). 

It is also possible to identify issues in the ontology (URL_TO_INSERT_TERM https://fairsharing.org/search?recordType=terminology_artefact)  with some `quality control SP (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.s63y3p) ARQL (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.87ccfd)  queries`. 
...
The final step of the ontology (URL_TO_INSERT_TERM https://fairsharing.org/search?recordType=terminology_artefact)  construction is to assess coverage of the ontology (URL_TO_INSERT_TERM https://fairsharing.org/search?recordType=terminology_artefact)  scope by verifying if it is able to answer the competency questions predefined. The competency questions can be implemented as a set of `SP (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.s63y3p) ARQL (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.87ccfd)  queries` and run against the developed (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.31385c)  ontology (URL_TO_INSERT_TERM https://fairsharing.org/search?recordType=terminology_artefact)  to check if the answers/results are aligned with the scope of the ontology (URL_TO_INSERT_TERM https://fairsharing.org/search?recordType=terminology_artefact) . The `use case owner` and `ontology (URL_TO_INSERT_TERM https://fairsharing.org/search?recordType=terminology_artefact)  developer` can also collaborate on the assessment of the competency questions answers/results. 

`RO (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.9w8ea0)  (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.504c6c)  (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.cp0ybc) BO (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.847069)  (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.cbz72b) T` provides the `query` command to perform `SP (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.s63y3p) ARQL (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.87ccfd)  queries`  against an ontology (URL_TO_INSERT_TERM https://fairsharing.org/search?recordType=terminology_artefact)  to verify and validate the ontology (URL_TO_INSERT_TERM https://fairsharing.org/search?recordType=terminology_artefact) .

The query command runs SP (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.s63y3p) ARQL (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.87ccfd)  `ASK`, `SELECT`, and `CO (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.wgfrmg)  (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.thskvr) NS (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.rfec93) TR (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.18je7e) UCT` queries by using the `--query` option with two arguments: `a query file` and `an output file`. Instead of specifying one or more pairs (query file, output file), it is also possible to specify a single `--output-dir` and use the `--queries` option to provide one or more queries of any type. Each output file will be written to the output directory with the same base name as the query file that produced it. A pattern example of this command is shown as follows.
...
It is therefore also critical to understand the benefits of contributing to existing (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.q7bkqr)  open efforts.    

### What to read next?

* OBO (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.847069)  (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.cbz72b)  Foundry (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.847069)  Semantic Engineering training and the [Robot tutorial](https://oboacademy.github.io/obook/tutorial/robot-tutorial-1/) 
* {ref}`fcb-interop-metadataprofile`  <!-- How to establish a minimal metadata profile? --> <!-- TO (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.w69t6r) DO add a link to corresponding document -->
* {ref}`fcb-interop-ontorequest` <!-- How to submit/request terms to an ontology (URL_TO_INSERT_TERM https://fairsharing.org/search?recordType=terminology_artefact)  ?--> <!-- TO (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.w69t6r) DO add a link to corresponding document -->
...
<!-- ```{bibliography} ../../../_bibliography/bibliography-identifier (URL_TO_INSERT_TERM https://fairsharing.org/search?recordType=identifier_schema) -map (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.53edcc) ping.bib
...
- [IPython Notebook (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.cbz72b)  for the MSIO (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.dpkb5f)  Build Process](ontology (URL_TO_INSERT_TERM https://fairsharing.org/search?recordType=terminology_artefact) -robot-recipe/MSIO (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.dpkb5f) -robot-build-process.ipynb)
````
