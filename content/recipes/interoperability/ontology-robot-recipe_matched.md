...
> The main purpose of this recipe is building an application ontology (URL_TO_INSERT_TERM https://fairsharing.org/search?recordType=terminology_artefact)  from source ontologies (URL_TO_INSERT_TERM https://fairsharing.org/search?recordType=terminology_artefact)  using `RO(URL_TO_INSERT_RECORD https://github.com/oborel/obo-relations/)(URL_TO_INSERT_RECORD https://github.com/albytrav/RadiomicsOntologyIBSI)(URL_TO_INSERT_RECORD https://w3id.org/ro/)BO(URL_TO_INSERT_RECORD http://www.obofoundry.org/)(URL_TO_INSERT_RECORD http://bioportal.bioontology.org/ontologies/3059)T` {footcite}`pmid31357927` via a sustainable dynamic pipeline to allow seamless integration of source ontology (URL_TO_INSERT_TERM https://fairsharing.org/search?recordType=terminology_artefact)  updates {footcite}`Arp2015`. 

An application ontology (URL_TO_INSERT_TERM https://fairsharing.org/search?recordType=terminology_artefact)  is a semantic artefact which is developed(URL_TO_INSERT_RECORD https://www.cog-genomics.org/plink2/formats#ped) to answer the needs of a specific application or focus. 
...
| :------------- | :------------- | :------------- |
| [Ontology (URL_TO_INSERT_TERM https://fairsharing.org/search?recordType=terminology_artefact)  and terminology](http://edamontology.org(URL_TO_INSERT_RECORD http://edamontology.org)/topic_0089)  | [tsv,OWL(URL_TO_INSERT_RECORD http://www.w3.org/TR/owl-overview/)]|OWL(URL_TO_INSERT_RECORD http://www.w3.org/TR/owl-overview/)|
...
| :------------- | :------------- | :------------- |
| [OWL](https://fairsharing.org(URL_TO_INSERT_RECORD https://fairsharing.org/)(URL_TO_INSERT_RECORD https://fairsharing.org)(URL_TO_INSERT_RECORD https://fairsharing.org/)/FAIRsharing.atygwy)  |   |   |
| [OBO](https://fairsharing.org(URL_TO_INSERT_RECORD https://fairsharing.org/)(URL_TO_INSERT_RECORD https://fairsharing.org)(URL_TO_INSERT_RECORD https://fairsharing.org/)/FAIRsharing.aa0eat)  |   |    |
...
| :------------- | :------------- | :------------ |
| RO(URL_TO_INSERT_RECORD https://github.com/oborel/obo-relations/)(URL_TO_INSERT_RECORD https://github.com/albytrav/RadiomicsOntologyIBSI)(URL_TO_INSERT_RECORD https://w3id.org/ro/)BO(URL_TO_INSERT_RECORD http://www.obofoundry.org/)(URL_TO_INSERT_RECORD http://bioportal.bioontology.org/ontologies/3059)T | [http://robot.obolibrary.org/](http://robot.obolibrary.org/) | ontology (URL_TO_INSERT_TERM https://fairsharing.org/search?recordType=terminology_artefact)  management cli |
| Ontology (URL_TO_INSERT_TERM https://fairsharing.org/search?recordType=terminology_artefact)  development kit | [https://github.com(URL_TO_INSERT_RECORD https://github.com/)/INCATools/ontology-development-kit](https://github.com(URL_TO_INSERT_RECORD https://github.com/)/INCATools/ontology-development-kit) (comes with RO(URL_TO_INSERT_RECORD https://github.com/oborel/obo-relations/)(URL_TO_INSERT_RECORD https://github.com/albytrav/RadiomicsOntologyIBSI)(URL_TO_INSERT_RECORD https://w3id.org/ro/)BO(URL_TO_INSERT_RECORD http://www.obofoundry.org/)(URL_TO_INSERT_RECORD http://bioportal.bioontology.org/ontologies/3059)T included)| ontology (URL_TO_INSERT_TERM https://fairsharing.org/search?recordType=terminology_artefact)  management environment |
...
| SP(URL_TO_INSERT_RECORD http://bioportal.bioontology.org/ontologies/SP)ARQL(URL_TO_INSERT_RECORD http://www.w3.org/TR/sparql11-overview/) | [https://www.w3.org/TR/sparql11-query/](https://www.w3.org/TR/sparql11-query/) | ontology (URL_TO_INSERT_TERM https://fairsharing.org/search?recordType=terminology_artefact)  query language |
...
<!-- [here](https://github.com(URL_TO_INSERT_RECORD https://github.com/)/FAIRplus/the-fair-cookbook/blob/ontology_robot_recipe/docs/content/recipes/ontology-robot/competency_questions.md).  -->
...
|                                                       | ➕ Identify all data generated from tissues(URL_TO_INSERT_RECORD https://tissues.jensenlab.org/) taken from patients suffering from a specific disease.                                     |
|                                                       | ➕ Identify all data generated from a specific tissues(URL_TO_INSERT_RECORD https://tissues.jensenlab.org/) obtained from mouse model (URL_TO_INSERT_TERM https://fairsharing.org/search?recordType=model_and_format) s that are related to a specific disease.              |
...
|                                                       | ➕ What is the expression of PP(URL_TO_INSERT_RECORD https://bitbucket.org/PlantExpAssay/ontology)ARg / growths factors in lung tissue from IPF patients?                                                 |
|                                                       | ➕ What is the expression of PP(URL_TO_INSERT_RECORD https://bitbucket.org/PlantExpAssay/ontology)ARg / growths factors in primary cells obtained from lung tissue from healthy subjects?                 |
|                                                       | ➕ What is the expression of PP(URL_TO_INSERT_RECORD https://bitbucket.org/PlantExpAssay/ontology)ARg / growths factors in all available tissues(URL_TO_INSERT_RECORD https://tissues.jensenlab.org/) obtained from healthy subjects?                          |
...
|                                                       | ➕ What is the expression of PP(URL_TO_INSERT_RECORD https://bitbucket.org/PlantExpAssay/ontology)ARg in lung tissue upon treatment with a specific compound in patients suffering from a specific disease |
...
| GSE116987March(URL_TO_INSERT_RECORD https://arch.library.northwestern.edu/)er2019 | EX101_1   | HSC CCl4-treated w0 |        |               | Hepatic Stellate Cell |          | NA                            |        | Mus musculus |
...
To build an `application ontology (URL_TO_INSERT_TERM https://fairsharing.org/search?recordType=terminology_artefact) ` that supports communication between different data resources, it is recommended to reuse existing(URL_TO_INSERT_RECORD http://sms.cbi.cnptia.embrapa.br/SMS/index_s.html) terms from existing(URL_TO_INSERT_RECORD http://sms.cbi.cnptia.embrapa.br/SMS/index_s.html) reference ontologies (URL_TO_INSERT_TERM https://fairsharing.org/search?recordType=terminology_artefact)  instead of creating new terms.
...
The following sample script uses the NCBO(URL_TO_INSERT_RECORD http://cbo.biocomplexity.indiana.edu/cbo/)(URL_TO_INSERT_RECORD http://bioportal.bioontology.org/ontologies/3059) Annotator web service to get a list of seed terms - i.e., the URI(URL_TO_INSERT_RECORD https://www.rfc-editor.org/rfc/rfc3986)s of ontology (URL_TO_INSERT_TERM https://fairsharing.org/search?recordType=terminology_artefact)  classes -.
```python
#Python3
...
Module extractions from ontologies (URL_TO_INSERT_TERM https://fairsharing.org/search?recordType=terminology_artefact)  can be run manually and in an ad hoc fashion. We would however recommend collecting all steps together into a script or `Makefile` to avoid missing steps. `RO(URL_TO_INSERT_RECORD https://github.com/oborel/obo-relations/)(URL_TO_INSERT_RECORD https://github.com/albytrav/RadiomicsOntologyIBSI)(URL_TO_INSERT_RECORD https://w3id.org/ro/)BO(URL_TO_INSERT_RECORD http://www.obofoundry.org/)(URL_TO_INSERT_RECORD http://bioportal.bioontology.org/ontologies/3059)T` steps can in theory be chained together into single large commands. Practical experience however teaches that this can have unexpected consequences as well as making debugging difficult in the event of an issue. It is therefore advisable to split extractions and merges out into individual steps with intermediate artefacts which can be deleted at the end of the process chain.
...
`RO(URL_TO_INSERT_RECORD https://github.com/oborel/obo-relations/)(URL_TO_INSERT_RECORD https://github.com/albytrav/RadiomicsOntologyIBSI)(URL_TO_INSERT_RECORD https://w3id.org/ro/)BO(URL_TO_INSERT_RECORD http://www.obofoundry.org/)(URL_TO_INSERT_RECORD http://bioportal.bioontology.org/ontologies/3059)T` supports two types of ontology (URL_TO_INSERT_TERM https://fairsharing.org/search?recordType=terminology_artefact)  module extraction, `Syntactic Locality Module Extractor` (SLME) and `Minimum Informat (URL_TO_INSERT_TERM https://fairsharing.org/search?recordType=model_and_format) ion to Reference an External Ontology (URL_TO_INSERT_TERM https://fairsharing.org/search?recordType=terminology_artefact)  Term` (MIREO(URL_TO_INSERT_RECORD http://browser.planteome.org/amigo/term/EO:0007359)(URL_TO_INSERT_RECORD http://bioportal.bioontology.org/ontologies/EO)T). `SLME` extractions can be further subdivided into TO(URL_TO_INSERT_RECORD http://browser.planteome.org/amigo/term/TO:0000387#display-lineage-tab)P(URL_TO_INSERT_RECORD http://top-thesaurus.org/)(URL_TO_INSERT_RECORD https://cos.io/top) (top module), `BO(URL_TO_INSERT_RECORD http://bioportal.bioontology.org/ontologies/3059)T` (bottom module) and `STAR` (fixpoint-nested module). For full details of what these different options entail, see http://robot.obolibrary.org/extract.html. We recommend the use of BO(URL_TO_INSERT_RECORD http://bioportal.bioontology.org/ontologies/3059)T for comprehensive modules that preserve the links between ontology (URL_TO_INSERT_TERM https://fairsharing.org/search?recordType=terminology_artefact)  classes and the use of `MIREO(URL_TO_INSERT_RECORD http://browser.planteome.org/amigo/term/EO:0007359)(URL_TO_INSERT_RECORD http://bioportal.bioontology.org/ontologies/EO)T` if relationships apart from parent-child ones are less important. 
...
* *method*: `RO(URL_TO_INSERT_RECORD https://github.com/oborel/obo-relations/)(URL_TO_INSERT_RECORD https://github.com/albytrav/RadiomicsOntologyIBSI)(URL_TO_INSERT_RECORD https://w3id.org/ro/)BO(URL_TO_INSERT_RECORD http://www.obofoundry.org/)(URL_TO_INSERT_RECORD http://bioportal.bioontology.org/ontologies/3059)T` uses 4 different algorithms to generate a module.  `TO(URL_TO_INSERT_RECORD http://browser.planteome.org/amigo/term/TO:0000387#display-lineage-tab)P(URL_TO_INSERT_RECORD http://top-thesaurus.org/)(URL_TO_INSERT_RECORD https://cos.io/top)`, `BO(URL_TO_INSERT_RECORD http://bioportal.bioontology.org/ontologies/3059)T`, `STAR` (all from the SLME method), and `MIREO(URL_TO_INSERT_RECORD http://browser.planteome.org/amigo/term/EO:0007359)(URL_TO_INSERT_RECORD http://bioportal.bioontology.org/ontologies/EO)T`. The first two will create a module  below or above the seed classes (the classes of interest in the target ontology (URL_TO_INSERT_TERM https://fairsharing.org/search?recordType=terminology_artefact) ) respectively. The `STAR` method creates a module by pulling all the properties and axioms of the seed classes but nothing else. `MIREO(URL_TO_INSERT_RECORD http://browser.planteome.org/amigo/term/EO:0007359)(URL_TO_INSERT_RECORD http://bioportal.bioontology.org/ontologies/EO)T` uses a different methods and offers some more options, in particular when it comes to how many levels up or down (parent and children) are needed.     
...
* *intermediates*: specific to the `MIREO(URL_TO_INSERT_RECORD http://browser.planteome.org/amigo/term/EO:0007359)(URL_TO_INSERT_RECORD http://bioportal.bioontology.org/ontologies/EO)T` method, it allows to let the algorithm know how much or how little to extract. It has 3 levels (`all`,`minimal`, `none`).
...
* *sources*: optional, a pointer to a file map(URL_TO_INSERT_RECORD https://www.cog-genomics.org/plink2/formats#map)ping .
...
`RO(URL_TO_INSERT_RECORD https://github.com/oborel/obo-relations/)(URL_TO_INSERT_RECORD https://github.com/albytrav/RadiomicsOntologyIBSI)(URL_TO_INSERT_RECORD https://w3id.org/ro/)BO(URL_TO_INSERT_RECORD http://www.obofoundry.org/)(URL_TO_INSERT_RECORD http://bioportal.bioontology.org/ontologies/3059)T` provides a template-driven ontology (URL_TO_INSERT_TERM https://fairsharing.org/search?recordType=terminology_artefact)  term generation system. A `RO(URL_TO_INSERT_RECORD https://github.com/oborel/obo-relations/)(URL_TO_INSERT_RECORD https://github.com/albytrav/RadiomicsOntologyIBSI)(URL_TO_INSERT_RECORD https://w3id.org/ro/)BO(URL_TO_INSERT_RECORD http://www.obofoundry.org/)(URL_TO_INSERT_RECORD http://bioportal.bioontology.org/ontologies/3059)T template` is a `tab-separated values(URL_TO_INSERT_RECORD http://www.iana.org/assignments/media-types/text/tab-separated-values)` (TSV(URL_TO_INSERT_RECORD http://www.iana.org/assignments/media-types/text/tab-separated-values)) or `comma-separated values(URL_TO_INSERT_RECORD https://tools.ietf.org/html/rfc4180)` (CSV(URL_TO_INSERT_RECORD https://tools.ietf.org/html/rfc4180)) file that depicts a set of patterns to build ontology (URL_TO_INSERT_TERM https://fairsharing.org/search?recordType=terminology_artefact)  entities - i.e., classes, properties, and individuals -. These templates can be used for modular ontology (URL_TO_INSERT_TERM https://fairsharing.org/search?recordType=terminology_artefact)  development.
After the _Domain Expert_ and the _Use Case/Scenario Owner_ specify the main entity of the use case and its relationships with remaining ontology (URL_TO_INSERT_TERM https://fairsharing.org/search?recordType=terminology_artefact)  entities, the _Ontology (URL_TO_INSERT_TERM https://fairsharing.org/search?recordType=terminology_artefact)  Developer_ generates the `RO(URL_TO_INSERT_RECORD https://github.com/oborel/obo-relations/)(URL_TO_INSERT_RECORD https://github.com/albytrav/RadiomicsOntologyIBSI)(URL_TO_INSERT_RECORD https://w3id.org/ro/)BO(URL_TO_INSERT_RECORD http://www.obofoundry.org/)(URL_TO_INSERT_RECORD http://bioportal.bioontology.org/ontologies/3059)T` templates depicting the set of patterns aimed to build the _umbrella_ ontology (URL_TO_INSERT_TERM https://fairsharing.org/search?recordType=terminology_artefact) .
...
| -------- | -------- | -------- | -------- |-------- | -------- | -------- |
| ID     | LABEL(URL_TO_INSERT_RECORD https://bel.bio)     | TYPE(URL_TO_INSERT_RECORD http://bioportal.bioontology.org/ontologies/PE)     | EC % | CHARAC(URL_TO_INSERT_RECORD https://ac.tdwg.org/introduction/)TERIS(URL_TO_INSERT_RECORD https://web.archive.org/web/20170707033254/http://www.researcherid.com/resources/html/help_upload.htm)TIC | DOMA(URL_TO_INSERT_RECORD http://www.informatics.jax.org/vocab/gxd/ma_ontology/)(URL_TO_INSERT_RECORD http://omabrowser.org/oma/about/)IN | RANGE |
|ex:cl_2 | Class_2 | class |-|-|-|-|
|ex:cl_3 | Class_3 | class |ex:cl_2|-|-|-|
|ex:op_1	|Prop_1| object property|-|Class_2|Class_3| |
|ex:dp_1	|Prop_2| data property|-|functional|Class_2|xsd:string(URL_TO_INSERT_RECORD https://string-db.org/)|
...
It is therefore also critical to understand the benefits of contributing to existing(URL_TO_INSERT_RECORD http://sms.cbi.cnptia.embrapa.br/SMS/index_s.html) open efforts.    

### What to read next?

* OBO(URL_TO_INSERT_RECORD http://www.obofoundry.org/)(URL_TO_INSERT_RECORD http://bioportal.bioontology.org/ontologies/3059) Foundry(URL_TO_INSERT_RECORD http://www.obofoundry.org/) Semantic Engineering training and the [Robot tutorial](https://oboacademy.github.io/obook/tutorial/robot-tutorial-1/) 
* {ref}`fcb-interop-metadataprofile`  <!-- How to establish a minimal metadata profile? --> <!-- TO(URL_TO_INSERT_RECORD http://browser.planteome.org/amigo/term/TO:0000387#display-lineage-tab)DO add a link to corresponding document -->
* {ref}`fcb-interop-ontorequest` <!-- How to submit/request terms to an ontology (URL_TO_INSERT_TERM https://fairsharing.org/search?recordType=terminology_artefact)  ?--> <!-- TO(URL_TO_INSERT_RECORD http://browser.planteome.org/amigo/term/TO:0000387#display-lineage-tab)DO add a link to corresponding document -->
...
<!-- ```{bibliography} ../../../_bibliography/bibliography-identifier (URL_TO_INSERT_TERM https://fairsharing.org/search?recordType=identifier_schema) -map(URL_TO_INSERT_RECORD https://www.cog-genomics.org/plink2/formats#map)ping.bib
...
- [IPython Notebook(URL_TO_INSERT_RECORD http://bioportal.bioontology.org/ontologies/3059) for the MSIO(URL_TO_INSERT_RECORD https://github.com/MaastrichtU-IDS/semanticscience) Build Process](ontology (URL_TO_INSERT_TERM https://fairsharing.org/search?recordType=terminology_artefact) -robot-recipe/MSIO(URL_TO_INSERT_RECORD https://github.com/MaastrichtU-IDS/semanticscience)-robot-build-process.ipynb)
````
