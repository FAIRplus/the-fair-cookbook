(fcb-selecting-ontologies (URL_TO_INSERT_TERM_8511 https://fairsharing.org/search?recordType=terminology_artefact) )=
...
*   **Inclusion criteria**:
    ...
    * 🔰  Unique URI (URL_TO_INSERT_RECORD_8639 https://fairsharing.org/FAIRsharing.d261e1) , textual definition and IDs for each term
    ...
    * 🔰  Licensing informat (URL_TO_INSERT_TERM_8640 https://fairsharing.org/search?recordType=model_and_format) ion available (_as indicator of freedom to use_)
    * 🔰  Use of a top level ontology (URL_TO_INSERT_TERM_8641 https://fairsharing.org/search?recordType=terminology_artefact)  (_as indicator of a resource built for generic use_)
    * 🔰  Pragmatism (_as indicator of actual, current real life practice)_
    * 🔰  Possibility of collaborating: the resource accepts complaints/remarks that aim to fix or improve the terminology (URL_TO_INSERT_TERM_8642 https://fairsharing.org/search?recordType=terminology_artefact) , while the resource organisation commits to fix or improve the terminology (URL_TO_INSERT_TERM_8643 https://fairsharing.org/search?recordType=terminology_artefact)  in brief delays (one month after receipt?)


### Set of Core Terminologies 

The terminologies (URL_TO_INSERT_TERM_8644 https://fairsharing.org/search?recordType=terminology_artefact)  presented here have been organized by theme and scope. When possible, sections are organized by `granularity levels`, progressing from `macroscopic scale` (organism) to `microscopic scale` (tissue, cells) and `molecular scale` (macromolecules, proteins, small molecules, xenobiotic chemicals).
...
The resources listed here focus on providing structured vocabularies to describe `taxonomic` and `anatomical` informat (URL_TO_INSERT_TERM_8645 https://fairsharing.org/search?recordType=model_and_format) ion. 

|Scope|Name|File location|Top-Level Ontology (URL_TO_INSERT_TERM_8646 https://fairsharing.org/search?recordType=terminology_artefact) |Licence|Issue Tracker URI (URL_TO_INSERT_RECORD_8647 https://fairsharing.org/FAIRsharing.d261e1) |Comment|
|--- |--- |--- |--- |--- |--- |--- |
...
|**Vertebrate Anatomy**|UBERON|http://purl.obolibrary.org/obo/uberon/ext.owl http://purl.obolibrary.org/obo/uberon/ext.obo|BFO| [CC-by 3.0 Unported Licence](https://creativecommons.org/licenses/by/3.0/) |https://github.com (URL_TO_INSERT_RECORD_8648 https://fairsharing.org/FAIRsharing.c55d5e) /obophenotype/uberon/issues|Integrative Resource engineered to go across species|
|**Human Anatomy**| Foundational Model (URL_TO_INSERT_TERM_8649 https://fairsharing.org/search?recordType=model_and_format)  of Anatomy (URL_TO_INSERT_RECORD_8650 https://fairsharing.org/FAIRsharing.x56jsy)  (FMA (URL_TO_INSERT_RECORD_8651 https://fairsharing.org/FAIRsharing.x56jsy)  (URL_TO_INSERT_RECORD_8652 https://fairsharing.org/FAIRsharing.pdwqcr) ) | http://purl.obolibrary.org/obo/fma.owl | | [CC-by 3.0 Unported Licence](https://creativecommons.org/licenses/by/3.0/) |https://sourceforge.net (URL_TO_INSERT_RECORD_8653 https://fairsharing.org/FAIRsharing.b138b5) /p/obo/foundational-model-of-anatomy-fma-requests/| Excellent cross-referencing with Uberon|
...
|**Mouse Anatomy**| Mouse Anatomy (MA (URL_TO_INSERT_RECORD_8654 https://fairsharing.org/FAIRsharing.pdwqcr) )| http://purl.obolibrary.org/obo/ma.owl| |[CC-by 4.0](https://creativecommons.org/licenses/by/4.0/)| https://github.com (URL_TO_INSERT_RECORD_8655 https://fairsharing.org/FAIRsharing.c55d5e) /obophenotype/mouse-anatomy-ontology/issues ||
|**Strain**|Rat Strain Ontology (URL_TO_INSERT_RECORD_8657 https://fairsharing.org/FAIRsharing.vajn3f) |http://purl.obolibrary.org/obo/rs.owl| | [CC-by 4.0](https://creativecommons.org/licenses/by/4.0/) | https://github.com (URL_TO_INSERT_RECORD_8656 https://fairsharing.org/FAIRsharing.c55d5e) /rat-genome-database/RS-Rat-Strain-Ontology/issues ||


In research (URL_TO_INSERT_RECORD_8660 https://fairsharing.org/FAIRsharing.52b22c) , many different model (URL_TO_INSERT_TERM_8658 https://fairsharing.org/search?recordType=model_and_format)  organisms are used (e.g. Dogs, Monkeys...) and specialized resources are available for many model (URL_TO_INSERT_TERM_8659 https://fairsharing.org/search?recordType=model_and_format)  organisms, including C. elegans, Drosophila, Xenopus, Zebrafish, plants and fungi. Use the selection criteria introduced earlier to gauge their value in the data management workflow and their impact on data integration tasks.
...
|Scope|Name|File location|Top-Level Ontology (URL_TO_INSERT_TERM_8661 https://fairsharing.org/search?recordType=terminology_artefact) |Licence|Issue Tracker URI (URL_TO_INSERT_RECORD_8662 https://fairsharing.org/FAIRsharing.d261e1) |
|--- |--- |--- |--- |--- |--- | 
|**Pathology/Disease (generic)**|||||
| |SNOME (URL_TO_INSERT_RECORD_8663 https://fairsharing.org/3502) D-CT| View on [Bioportal](https://bioportal.bioontology.org (URL_TO_INSERT_RECORD_8665 https://fairsharing.org/FAIRsharing.4m97ah) /ontologies/SNOMEDCT?p=summary) | |[SNOME (URL_TO_INSERT_RECORD_8664 https://fairsharing.org/3502) D license](http://www.nlm.nih.gov/databases/umls.html) - part of the UMLS license|| |
| |NCI Thesaurus (URL_TO_INSERT_RECORD_8666 https://fairsharing.org/FAIRsharing.4cvwxa) |http://evs.nci.nih.gov/ftp1/NCI_Thesaurus| | [NCI license](http://evs.nci.nih.gov/ftp1/NCI_Thesaurus/ThesaurusTermsofUse.htm)|| |
| |International Classification of Diseases (ICD-10 (URL_TO_INSERT_RECORD_8667 https://fairsharing.org/FAIRsharing.nj16g) )| View on [WHO site](https://icd.who.int/browse10/2010/en)| | [WHO license](http://www.who.int (URL_TO_INSERT_RECORD_8668 https://fairsharing.org/3498) /about/copyright/en/)|||
...
| | Disease Ontology (URL_TO_INSERT_TERM_8669 https://fairsharing.org/search?recordType=terminology_artefact)  (URL_TO_INSERT_RECORD_8673 https://fairsharing.org/FAIRsharing.8b6wfq)  Identifier (URL_TO_INSERT_TERM_8670 https://fairsharing.org/search?recordType=identifier_schema) s (DOI (URL_TO_INSERT_RECORD_8671 https://fairsharing.org/FAIRsharing.hFLKCn) D (URL_TO_INSERT_RECORD_8674 https://fairsharing.org/FAIRsharing.8b6wfq) ) |http://purl.obolibrary.org/obo/doid.owl|BFO| [CC0 1.0 Universal](https://creativecommons.org/publicdomain/zero/1.0/) |https://github.com (URL_TO_INSERT_RECORD_8672 https://fairsharing.org/FAIRsharing.c55d5e) /DiseaseOntology/HumanDiseaseOntology/issues| | 
| |MO (URL_TO_INSERT_RECORD_8679 https://fairsharing.org/FAIRsharing.qs4x5m) NDO (URL_TO_INSERT_RECORD_8677 https://fairsharing.org/FAIRsharing.b2979t)  Disease Ontology (URL_TO_INSERT_TERM_8675 https://fairsharing.org/search?recordType=terminology_artefact)  (URL_TO_INSERT_RECORD_8678 https://fairsharing.org/FAIRsharing.8b6wfq) <sup>*</sup> |http://purl.obolibrary.org/obo/mondo.owl|BFO| [CC-BY 4.0](https://creativecommons.org/licenses/by/4.0/) |https://github.com (URL_TO_INSERT_RECORD_8676 https://fairsharing.org/FAIRsharing.c55d5e) /monarch-initiative/mondo/issues| 
| |Infectious Disease Ontology (URL_TO_INSERT_TERM_8680 https://fairsharing.org/search?recordType=terminology_artefact)  (URL_TO_INSERT_RECORD_8682 https://fairsharing.org/FAIRsharing.8b6wfq)  (IDO (URL_TO_INSERT_RECORD_8681 https://fairsharing.org/FAIRsharing.aae3v6) ) |https://code.google.com/p/infectious-disease-ontology/source/browse/trunk/src/ontology/ido-core/ido-main.owl|BFO| [CC-by 3.0 Unported Licence](https://creativecommons.org/licenses/by/3.0/) |https://code.google.com/p/infectious-disease-ontology/issues/list| |
|**Phenotype**|||||
| | Human Phenotype (HP (URL_TO_INSERT_RECORD_8685 https://fairsharing.org/FAIRsharing.kbtt7f) ) |http://purl.obolibrary.org/obo/hp.owl|BFO| [HP (URL_TO_INSERT_RECORD_8686 https://fairsharing.org/FAIRsharing.kbtt7f) O (URL_TO_INSERT_RECORD_8683 https://fairsharing.org/FAIRsharing.3ngg40)  Licence](https://hpo.jax.org (URL_TO_INSERT_RECORD_8687 https://fairsharing.org/FAIRsharing.kbtt7f) /app/license) |https://github.com (URL_TO_INSERT_RECORD_8684 https://fairsharing.org/FAIRsharing.c55d5e) /obophenotype/human-phenotype-ontology/issues/|
| |Medical Dictionary for Regulator (URL_TO_INSERT_RECORD_8690 https://fairsharing.org/FAIRsharing.ey49c6) y Activities Terminology (URL_TO_INSERT_TERM_8688 https://fairsharing.org/search?recordType=terminology_artefact)  (URL_TO_INSERT_RECORD_8693 https://fairsharing.org/FAIRsharing.ad3137)  (MedDR (URL_TO_INSERT_RECORD_8692 https://fairsharing.org/FAIRsharing.1sfhp3) A (URL_TO_INSERT_RECORD_8691 https://fairsharing.org/FAIRsharing.23823e)  (URL_TO_INSERT_RECORD_8694 https://fairsharing.org/FAIRsharing.ad3137) )| View on [Bioportal](https://bioportal.bioontology.org (URL_TO_INSERT_RECORD_8689 https://fairsharing.org/FAIRsharing.4m97ah) /ontologies/MEDDRA) || Academic: Free accessible <br/> Commercial contact MSSO|https://mssotools.com/webcr/ login required|
| | Mammalian Phenotype (MP (URL_TO_INSERT_RECORD_8695 https://fairsharing.org/FAIRsharing.kg1x4z) ) | http://purl.obolibrary.org/obo/mp.owl | | [CC-BY 4.0](https://creativecommons.org/licenses/by/4.0/) | https://github.com (URL_TO_INSERT_RECORD_8696 https://fairsharing.org/FAIRsharing.c55d5e) /obophenotype/mammalian-phenotype-ontology/issues | 


> _<sup>*</sup>MO (URL_TO_INSERT_RECORD_8717 https://fairsharing.org/FAIRsharing.qs4x5m) NDO (URL_TO_INSERT_RECORD_8709 https://fairsharing.org/FAIRsharing.b2979t)  was born of an effort to harmonise disease definitions from a number sources, includig [OMIM](https://www.omim.org (URL_TO_INSERT_RECORD_8713 https://fairsharing.org/FAIRsharing.b084yh)  (URL_TO_INSERT_RECORD_8719 https://fairsharing.org/FAIRsharing.9qkaz9) /) (Online Mendelian Inheritance in Man (URL_TO_INSERT_RECORD_8718 https://fairsharing.org/FAIRsharing.9qkaz9) ), [Orphanet](https://www.orpha.net/), EFO (URL_TO_INSERT_RECORD_8714 https://fairsharing.org/FAIRsharing.1gr4tz)  (URL_TO_INSERT_RECORD_8716 https://fairsharing.org/FAIRsharing.ca63ce)  and DOI (URL_TO_INSERT_RECORD_8701 https://fairsharing.org/FAIRsharing.hFLKCn) D (URL_TO_INSERT_RECORD_8711 https://fairsharing.org/FAIRsharing.8b6wfq) , with work in progress to include NCIt (URL_TO_INSERT_RECORD_8703 https://fairsharing.org/FAIRsharing.4cvwxa) . The OWL (URL_TO_INSERT_RECORD_8702 https://fairsharing.org/FAIRsharing.atygwy)  version includes axiomatisation using CL (URL_TO_INSERT_RECORD_8707 https://fairsharing.org/FAIRsharing.j9y503) , Uberon, GO (URL_TO_INSERT_RECORD_8705 https://fairsharing.org/FAIRsharing.6xq0ee) , HP (URL_TO_INSERT_RECORD_8712 https://fairsharing.org/FAIRsharing.kbtt7f) , RO (URL_TO_INSERT_RECORD_8708 https://fairsharing.org/FAIRsharing.9w8ea0)  (URL_TO_INSERT_RECORD_8710 https://fairsharing.org/FAIRsharing.504c6c)  (URL_TO_INSERT_RECORD_8715 https://fairsharing.org/FAIRsharing.cp0ybc)  & NCBITaxon. The ontology (URL_TO_INSERT_TERM_8697 https://fairsharing.org/search?recordType=terminology_artefact)  is under active development by a range of ontology (URL_TO_INSERT_TERM_8698 https://fairsharing.org/search?recordType=terminology_artefact)  and domain experts. If no other limiting requirements dictate the use of an alternative ontology (URL_TO_INSERT_TERM_8699 https://fairsharing.org/search?recordType=terminology_artefact)  (e.g. use of NCIt (URL_TO_INSERT_RECORD_8704 https://fairsharing.org/FAIRsharing.4cvwxa) axon as part of a CDI (URL_TO_INSERT_RECORD_8706 https://fairsharing.org/FAIRsharing.yzagph) SC (URL_TO_INSERT_RECORD_8720 https://fairsharing.org/3525)  (URL_TO_INSERT_RECORD_8721 https://fairsharing.org/3525) -compliant dataset), it is therefore the most recommended open source ontology (URL_TO_INSERT_TERM_8700 https://fairsharing.org/search?recordType=terminology_artefact)  from the above list._
...
There is a wide range of ontologies (URL_TO_INSERT_TERM_8724 https://fairsharing.org/search?recordType=terminology_artefact)  available for specific diseases or disease types. Some examples are given below but this list is by no means exhaustive. Check ontology (URL_TO_INSERT_TERM_8723 https://fairsharing.org/search?recordType=terminology_artefact)  repositories (URL_TO_INSERT_TERM_8722 https://fairsharing.org/search?recordType=repository)  such as [OLS](https://www.ebi.ac.uk/ols/ontologies), [Bioportal](https://bioportal.bioontology.org (URL_TO_INSERT_RECORD_8726 https://fairsharing.org/FAIRsharing.4m97ah) /ontologies) or the [OBO (URL_TO_INSERT_RECORD_8728 https://fairsharing.org/FAIRsharing.847069)  (URL_TO_INSERT_RECORD_8729 https://fairsharing.org/FAIRsharing.cbz72b)  Foundry (URL_TO_INSERT_RECORD_8727 https://fairsharing.org/FAIRsharing.847069) ](http://obofoundry.org/) for up-to-date lists of available ontologies (URL_TO_INSERT_TERM_8725 https://fairsharing.org/search?recordType=terminology_artefact) 

|Scope|Name|File location|Top-Level Ontology (URL_TO_INSERT_TERM_8730 https://fairsharing.org/search?recordType=terminology_artefact) |Licence|Issue Tracker URI (URL_TO_INSERT_RECORD_8731 https://fairsharing.org/FAIRsharing.d261e1) |
|--- |--- |--- |--- |--- |--- |
|**Malaria**|Malaria Ontology (URL_TO_INSERT_TERM_8732 https://fairsharing.org/search?recordType=terminology_artefact)  (IDO (URL_TO_INSERT_RECORD_8735 https://fairsharing.org/FAIRsharing.aae3v6) MA (URL_TO_INSERT_RECORD_8733 https://fairsharing.org/FAIRsharing.pdwqcr)  (URL_TO_INSERT_RECORD_8736 https://fairsharing.org/FAIRsharing.g3j5qj) L (URL_TO_INSERT_RECORD_8734 https://fairsharing.org/FAIRsharing.2q8c28) )||BFO (URL_TO_INSERT_RECORD_8737 https://fairsharing.org/FAIRsharing.ca63ce) | [CC0 1.0 Universal](https://creativecommons.org/publicdomain/zero/1.0/)  ||
|**Alzheimer Disease**| Alzheimer's Disease Ontology (URL_TO_INSERT_TERM_8738 https://fairsharing.org/search?recordType=terminology_artefact)  (URL_TO_INSERT_RECORD_8739 https://fairsharing.org/FAIRsharing.8b6wfq)  (URL_TO_INSERT_RECORD_8740 https://fairsharing.org/FAIRsharing.ckd4rf)  (ADO (URL_TO_INSERT_RECORD_8741 https://fairsharing.org/FAIRsharing.ckd4rf) ) |https://www.scai.fraunhofer.de/content/dam/scai/de/downloads/bioinformatik/ontologies/ADO/ADO.zip|BFO|||
|**Rare disorder**| Orphanet (URL_TO_INSERT_RECORD_8746 https://fairsharing.org/FAIRsharing.6bd5k6)  (URL_TO_INSERT_RECORD_8747 https://fairsharing.org/FAIRsharing.6bd5k6)  Rare Disease Ontology (URL_TO_INSERT_TERM_8742 https://fairsharing.org/search?recordType=terminology_artefact)  (URL_TO_INSERT_RECORD_8745 https://fairsharing.org/FAIRsharing.8b6wfq)  (ORDO (URL_TO_INSERT_RECORD_8744 https://fairsharing.org/FAIRsharing.1566e7)  (URL_TO_INSERT_RECORD_8748 https://fairsharing.org/FAIRsharing.pbbnwa) ) | View on [Bioportal](https://bioportal.bioontology.org (URL_TO_INSERT_RECORD_8743 https://fairsharing.org/FAIRsharing.4m97ah) /ontologies/ORDO)||[CC-BY 4.0](https://creativecommons.org/licenses/by/4.0/)||
...
|Scope|Name|File location|Top-Level Ontology (URL_TO_INSERT_TERM_8749 https://fairsharing.org/search?recordType=terminology_artefact) |Licence|Issue Tracker URI (URL_TO_INSERT_RECORD_8750 https://fairsharing.org/FAIRsharing.d261e1) |
|--- |--- |--- |--- |--- |--- |
|**Cell**| Cell Ontology (URL_TO_INSERT_TERM_8751 https://fairsharing.org/search?recordType=terminology_artefact)  (URL_TO_INSERT_RECORD_8752 https://fairsharing.org/FAIRsharing.j9y503)  (CL (URL_TO_INSERT_RECORD_8753 https://fairsharing.org/FAIRsharing.j9y503) ) |http://purl.obolibrary.org/obo/cl.owl http://purl.obolibrary.org/obo/cl.obo|BFO| [CC-by 4.0](https://creativecommons.org/licenses/by/4.0/)|https://code.google.com/p/cell-ontology/issues/list|
|**Cell Lines**| 
...
| | Cell Line Ontology (URL_TO_INSERT_TERM_8754 https://fairsharing.org/search?recordType=terminology_artefact)  (URL_TO_INSERT_RECORD_8759 https://fairsharing.org/FAIRsharing.4dvtcz)  (CL (URL_TO_INSERT_RECORD_8755 https://fairsharing.org/FAIRsharing.j9y503) O (URL_TO_INSERT_RECORD_8760 https://fairsharing.org/FAIRsharing.4dvtcz) ) |[https://github.com (URL_TO_INSERT_RECORD_8756 https://fairsharing.org/FAIRsharing.c55d5e) /CLO-ontology/CLO/blob/master/src/ontology/clo.owl](https://github.com (URL_TO_INSERT_RECORD_8757 https://fairsharing.org/FAIRsharing.c55d5e) /CLO-ontology/CLO/blob/master/src/ontology/clo.owl)|BFO| [CC-by 3.0 Unported Licence](https://creativecommons.org/licenses/by/3.0/) |https://github.com (URL_TO_INSERT_RECORD_8758 https://fairsharing.org/FAIRsharing.c55d5e) /CLO-ontology/CLO/issues|
|**Cell Molecular Phenotype**|Cell Molecular Phenotype Ontology (URL_TO_INSERT_TERM_8761 https://fairsharing.org/search?recordType=terminology_artefact)  (CMP (URL_TO_INSERT_RECORD_8763 https://fairsharing.org/FAIRsharing.kg1x4z) O (URL_TO_INSERT_RECORD_8762 https://fairsharing.org/FAIRsharing.knp11s)  (URL_TO_INSERT_RECORD_8764 https://fairsharing.org/FAIRsharing.3ngg40)  (URL_TO_INSERT_RECORD_8767 https://fairsharing.org/FAIRsharing.jpxsv1) ) |https://github.com (URL_TO_INSERT_RECORD_8765 https://fairsharing.org/FAIRsharing.c55d5e) /EBISPOT/CMPO/releases/| | | https://github.com (URL_TO_INSERT_RECORD_8766 https://fairsharing.org/FAIRsharing.c55d5e) /EBISPOT/CMPO/issues |
...
This section highlights the major and most widely used OBO (URL_TO_INSERT_RECORD_8769 https://fairsharing.org/FAIRsharing.847069)  (URL_TO_INSERT_RECORD_8770 https://fairsharing.org/FAIRsharing.cbz72b)  Foundry (URL_TO_INSERT_RECORD_8768 https://fairsharing.org/FAIRsharing.847069)  resources for `molecules of biological relevance` as well as `molecular structures`, `biological processes` and `cellular components` 


|Scope|Name|File location|Top-Level Ontology (URL_TO_INSERT_TERM_8771 https://fairsharing.org/search?recordType=terminology_artefact) |Licence|Issue Tracker URI (URL_TO_INSERT_RECORD_8772 https://fairsharing.org/FAIRsharing.d261e1) |
|--- |--- |--- |--- |--- |--- |
|**Chemicals and Small Molecules**| Chemical Entities of Biological Interest (URL_TO_INSERT_RECORD_8773 https://fairsharing.org/FAIRsharing.62qk8w)  (ChEBI)|[ChEBI](https://www.ebi.ac.uk/chebi (URL_TO_INSERT_RECORD_8774 https://fairsharing.org/FAIRsharing.62qk8w) /)| BFO (URL_TO_INSERT_RECORD_8776 https://fairsharing.org/FAIRsharing.ca63ce) |[CC-by 4.0](https://creativecommons.org/licenses/by/4.0/) |https://github.com (URL_TO_INSERT_RECORD_8775 https://fairsharing.org/FAIRsharing.c55d5e) /ebi-chebi/ChEBI/issues|
|**Gene Function, Molecular Component, Biological Process**| Gene Ontology (URL_TO_INSERT_TERM_8777 https://fairsharing.org/search?recordType=terminology_artefact)  (URL_TO_INSERT_RECORD_8778 https://fairsharing.org/FAIRsharing.6xq0ee)  (GO (URL_TO_INSERT_RECORD_8779 https://fairsharing.org/FAIRsharing.6xq0ee) ) |http://purl.obolibrary.org/obo/go.obo http://purl.obolibrary.org/obo/go.owl|BFO| [CC-by 4.0](https://creativecommons.org/licenses/by/4.0/) |http://sourceforge.net (URL_TO_INSERT_RECORD_8780 https://fairsharing.org/FAIRsharing.b138b5) /p/geneontology/ontology-requests/|
|**Protein (URL_TO_INSERT_RECORD_8783 https://fairsharing.org/FAIRsharing.rtndct) /peptide**| Protein (URL_TO_INSERT_RECORD_8784 https://fairsharing.org/FAIRsharing.rtndct)  Ontology (URL_TO_INSERT_TERM_8781 https://fairsharing.org/search?recordType=terminology_artefact)  (URL_TO_INSERT_RECORD_8788 https://fairsharing.org/FAIRsharing.4ndncv)  (PRO (URL_TO_INSERT_RECORD_8782 https://fairsharing.org/FAIRsharing.3e88d6)  (URL_TO_INSERT_RECORD_8785 https://fairsharing.org/FAIRsharing.9w8ea0)  (URL_TO_INSERT_RECORD_8787 https://fairsharing.org/FAIRsharing.504c6c)  (URL_TO_INSERT_RECORD_8789 https://fairsharing.org/FAIRsharing.4ndncv)  (URL_TO_INSERT_RECORD_8791 https://fairsharing.org/FAIRsharing.cp0ybc) ) |https://proconsortium.org (URL_TO_INSERT_RECORD_8790 https://fairsharing.org/FAIRsharing.4ndncv)  |BFO (URL_TO_INSERT_RECORD_8792 https://fairsharing.org/FAIRsharing.ca63ce) | [CC-by 4.0](https://creativecommons.org/licenses/by/4.0/) |https://github.com (URL_TO_INSERT_RECORD_8786 https://fairsharing.org/FAIRsharing.c55d5e) /PROconsortium/PRoteinOntology/issues|


Besides, these open ontologies (URL_TO_INSERT_TERM_8793 https://fairsharing.org/search?recordType=terminology_artefact) , in the context of clinically relevant work where drug formulation require recording and description, the following resources are relevant.

|Scope|Name|File location|Top-Level Ontology (URL_TO_INSERT_TERM_8794 https://fairsharing.org/search?recordType=terminology_artefact) |Licence|Issue Tracker URI (URL_TO_INSERT_RECORD_8795 https://fairsharing.org/FAIRsharing.d261e1) |
|--- |--- |--- |--- |--- |--- |
| **Drug** |
| | National Drug File (URL_TO_INSERT_RECORD_8798 https://fairsharing.org/FAIRsharing.901nkj) | View on [Bioportal](https://bioportal.bioontology.org (URL_TO_INSERT_RECORD_8796 https://fairsharing.org/FAIRsharing.4m97ah) /ontologies/NDFRT (URL_TO_INSERT_RECORD_8799 https://fairsharing.org/FAIRsharing.901nkj) ) ||[NIH (URL_TO_INSERT_RECORD_8797 https://fairsharing.org/FAIRsharing.41718d)  license](https://uts.nlm.nih.gov/license.html)||
| | The Drug Ontology (URL_TO_INSERT_TERM_8800 https://fairsharing.org/search?recordType=terminology_artefact)  (URL_TO_INSERT_RECORD_8801 https://fairsharing.org/FAIRsharing.w5ntfd)  (DR (URL_TO_INSERT_RECORD_8803 https://fairsharing.org/FAIRsharing.1sfhp3) O (URL_TO_INSERT_RECORD_8802 https://fairsharing.org/FAIRsharing.9w8ea0)  (URL_TO_INSERT_RECORD_8804 https://fairsharing.org/FAIRsharing.504c6c)  (URL_TO_INSERT_RECORD_8805 https://fairsharing.org/FAIRsharing.cp0ybc) N) |  http://purl.obolibrary.org/obo/dron.owl | BFO (URL_TO_INSERT_RECORD_8806 https://fairsharing.org/FAIRsharing.ca63ce)  | [CC-by 3.0 Unported Licence](https://creativecommons.org/licenses/by/3.0/) | https://ontology.atlassian.net/browse/DRON |
| | RxNORM (URL_TO_INSERT_RECORD_8808 https://fairsharing.org/FAIRsharing.36pf8q)  (URL_TO_INSERT_RECORD_8810 https://fairsharing.org/FAIRsharing.36pf8q)  |View on [Bioportal](https://bioportal.bioontology.org (URL_TO_INSERT_RECORD_8807 https://fairsharing.org/FAIRsharing.4m97ah) /ontologies/RXNORM) | |[RxNORM (URL_TO_INSERT_RECORD_8809 https://fairsharing.org/FAIRsharing.36pf8q)  (URL_TO_INSERT_RECORD_8811 https://fairsharing.org/FAIRsharing.36pf8q)  license](http://www.nlm.nih.gov/databases/umls.html) - part of the UMLS license||
...
Some of the resources are specialized semantic artefacts developed (URL_TO_INSERT_RECORD_8813 https://fairsharing.org/FAIRsharing.31385c)  to support the standard (URL_TO_INSERT_TERM_8812 https://fairsharing.org/search?fairsharingRegistry=Standard) ized reporting of data modalities.

|Scope|Name|File location|Top-Level Ontology (URL_TO_INSERT_TERM_8814 https://fairsharing.org/search?recordType=terminology_artefact) |Licence|Issue Tracker URI (URL_TO_INSERT_RECORD_8815 https://fairsharing.org/FAIRsharing.d261e1) |
|--- |--- |--- |--- |--- |--- |
|**Radiology**| Radiology Lexicon (URL_TO_INSERT_RECORD_8818 https://fairsharing.org/FAIRsharing.shm2f2)  (RADL (URL_TO_INSERT_RECORD_8817 https://fairsharing.org/FAIRsharing.f1292d) ex) | View on [Bioportal](https://bioportal.bioontology.org (URL_TO_INSERT_RECORD_8816 https://fairsharing.org/FAIRsharing.4m97ah) /ontologies/RADLEX) ||||
|**Medical Imaging**|DICO (URL_TO_INSERT_RECORD_8819 https://fairsharing.org/FAIRsharing.b9znd5)  (URL_TO_INSERT_RECORD_8822 https://fairsharing.org/FAIRsharing.wgfrmg)  (URL_TO_INSERT_RECORD_8823 https://fairsharing.org/FAIRsharing.thskvr) M (URL_TO_INSERT_RECORD_8820 https://fairsharing.org/FAIRsharing.b7z8by) |http://dicom.nema.org/medical/dicom/current/output/chtml/part16/chapter_D.html (URL_TO_INSERT_RECORD_8821 https://fairsharing.org/FAIRsharing.p1ss22) ||||
|**Sample Processing/Reagents/Instruments Assay Definition**| Ontology (URL_TO_INSERT_TERM_8824 https://fairsharing.org/search?recordType=terminology_artefact)  for Biomedical Investigations (URL_TO_INSERT_RECORD_8826 https://fairsharing.org/FAIRsharing.284e1z)  (OBI (URL_TO_INSERT_RECORD_8827 https://fairsharing.org/FAIRsharing.284e1z) ) |http://purl.obolibrary.org/obo/obi.owl|BFO| [CC-by 4.0](https://creativecommons.org/licenses/by/4.0/)|https://github.com (URL_TO_INSERT_RECORD_8825 https://fairsharing.org/FAIRsharing.c55d5e) /obi-ontology/obi/issues|
|**Biological screening assays and their results including high-throughput screening (HTS)**| BioAssay Ontology (URL_TO_INSERT_TERM_8828 https://fairsharing.org/search?recordType=terminology_artefact)  (URL_TO_INSERT_RECORD_8831 https://fairsharing.org/FAIRsharing.mye76w)  (BAO (URL_TO_INSERT_RECORD_8829 https://fairsharing.org/FAIRsharing.k2dq5j)  (URL_TO_INSERT_RECORD_8832 https://fairsharing.org/FAIRsharing.mye76w) ) |http://www.bioassayontology.org (URL_TO_INSERT_RECORD_8830 https://fairsharing.org/FAIRsharing.farr39)  (URL_TO_INSERT_RECORD_8833 https://fairsharing.org/FAIRsharing.mye76w) /bao/bao_complete_bfo_dev.owl|BFO| [CC-by-SA 4.0 International](https://creativecommons.org/licenses/by-sa/4.0/) ||
|**Mass Spectrometry (instrument/acquisition parameter/spectrum related informat (URL_TO_INSERT_TERM_8835 https://fairsharing.org/search?recordType=model_and_format) ion)**| HUPO (URL_TO_INSERT_RECORD_8836 https://fairsharing.org/FAIRsharing.3ngg40)  Proteomics Standard (URL_TO_INSERT_TERM_8834 https://fairsharing.org/search?fairsharingRegistry=Standard) s Initiative (URL_TO_INSERT_RECORD_8837 https://fairsharing.org/3514) -Mass Spectrometry controlled vocabulary (PSI-MS) |https://github.com (URL_TO_INSERT_RECORD_8838 https://fairsharing.org/FAIRsharing.c55d5e) /HUPO-PSI/psi-ms-CV |none specified| [CC-by 4.0](https://creativecommons.org/licenses/by/4.0/)|https://github.com (URL_TO_INSERT_RECORD_8839 https://fairsharing.org/FAIRsharing.c55d5e) /HUPO-PSI/psi-ms-CV/issues |
...
In the field of Biology and Biomedicine, the [OBO (URL_TO_INSERT_RECORD_8885 https://fairsharing.org/FAIRsharing.847069)  (URL_TO_INSERT_RECORD_8889 https://fairsharing.org/FAIRsharing.cbz72b)  Foundry (URL_TO_INSERT_RECORD_8884 https://fairsharing.org/FAIRsharing.847069) ](http://obofoundry.org) coordinates the development of interoperable ontologies (URL_TO_INSERT_TERM_8883 https://fairsharing.org/search?recordType=terminology_artefact) . At the core (URL_TO_INSERT_RECORD_8887 https://fairsharing.org/FAIRsharing.m283c)  (URL_TO_INSERT_RECORD_8888 https://fairsharing.org/FAIRsharing.xMmOCL)  of this interoperation lies the **[Relation Ontology](http://www.obofoundry.org (URL_TO_INSERT_RECORD_8886 https://fairsharing.org/FAIRsharing.847069) /ontology/ro.html)** released under the [CC0 1.0 Universal](https://creativecommons.org/publicdomain/zero/1.0/) license.

| Relation Ontology (URL_TO_INSERT_TERM_8890 https://fairsharing.org/search?recordType=terminology_artefact)                | File  | Variant                                                                        |
|---------------------------------|---|--------------------------------------------------------------------------------|
| Relation Ontology (URL_TO_INSERT_TERM_8891 https://fairsharing.org/search?recordType=terminology_artefact)                | [ro.owl](http://purl.obolibrary.org/obo/ro.owl)  | Canonical edition                                                              |
| Relation Ontology (URL_TO_INSERT_TERM_8893 https://fairsharing.org/search?recordType=terminology_artefact)  in obo format (URL_TO_INSERT_TERM_8892 https://fairsharing.org/search?recordType=model_and_format)  | [ro.obo](http://purl.obolibrary.org/obo/ro.obo)  | Has imports merged in                                                          |
| RO (URL_TO_INSERT_RECORD_8895 https://fairsharing.org/FAIRsharing.9w8ea0)  (URL_TO_INSERT_RECORD_8898 https://fairsharing.org/FAIRsharing.504c6c)  (URL_TO_INSERT_RECORD_8899 https://fairsharing.org/FAIRsharing.cp0ybc)  Core (URL_TO_INSERT_RECORD_8894 https://fairsharing.org/FAIRsharing.xMmOCL)  relations               | [ro/core.owl](http://purl.obolibrary.org/obo/ro/core.owl)  | Minimal subset intended to work with BFO (URL_TO_INSERT_RECORD_8900 https://fairsharing.org/FAIRsharing.ca63ce) -classes [page](https://github.com (URL_TO_INSERT_RECORD_8897 https://fairsharing.org/FAIRsharing.c55d5e) /oborel/obo-relations (URL_TO_INSERT_RECORD_8896 https://fairsharing.org/FAIRsharing.9w8ea0) /wiki/ROCore)                        |
| RO (URL_TO_INSERT_RECORD_8903 https://fairsharing.org/FAIRsharing.9w8ea0)  (URL_TO_INSERT_RECORD_8906 https://fairsharing.org/FAIRsharing.504c6c)  (URL_TO_INSERT_RECORD_8908 https://fairsharing.org/FAIRsharing.cp0ybc)  base ontology (URL_TO_INSERT_TERM_8901 https://fairsharing.org/search?recordType=terminology_artefact)                 | [ro/ro-base.owl](http://purl.obolibrary.org/obo/ro/ro-base.owl)  | Axioms defined within RO (URL_TO_INSERT_RECORD_8904 https://fairsharing.org/FAIRsharing.9w8ea0)  (URL_TO_INSERT_RECORD_8907 https://fairsharing.org/FAIRsharing.504c6c)  (URL_TO_INSERT_RECORD_8909 https://fairsharing.org/FAIRsharing.cp0ybc)  and to be used in imports for other ontologies (URL_TO_INSERT_TERM_8902 https://fairsharing.org/search?recordType=terminology_artefact)  [page](https://github.com (URL_TO_INSERT_RECORD_8905 https://fairsharing.org/FAIRsharing.c55d5e) /INCATools/ontology-development-kit/issues/50) |
...
The following is an example of how a `defined class` may be created in an ontology (URL_TO_INSERT_TERM_8910 https://fairsharing.org/search?recordType=terminology_artefact) . The code snippet shows one such class being expressed to create a type by specifying a number of `axioms`. These use `relations` (aka OWL (URL_TO_INSERT_RECORD_8911 https://fairsharing.org/FAIRsharing.atygwy)  Properties), which may be set to 
...
<!-- 
TO (URL_TO_INSERT_RECORD_8916 https://fairsharing.org/FAIRsharing.w69t6r) DO : fill in the links to what-should-I-read-next recipes -->
...
<!-- {download}`bibliography-identifier (URL_TO_INSERT_TERM_8920 https://fairsharing.org/search?recordType=identifier_schema) -map (URL_TO_INSERT_RECORD_8922 https://fairsharing.org/FAIRsharing.53edcc) ping.bib <./bibref/bibliography-identifier (URL_TO_INSERT_TERM_8921 https://fairsharing.org/search?recordType=identifier_schema) -map (URL_TO_INSERT_RECORD_8923 https://fairsharing.org/FAIRsharing.53edcc) ping.bib>` -->
...
<!-- Smith, B., Ceusters, W., Klagges, B. et al. Relations in biomedical ontologies (URL_TO_INSERT_TERM_8924 https://fairsharing.org/search?recordType=terminology_artefact) . Genome Biol 6, R46 (2005). https://doi.org/10.1186/gb-2005-6-5-r46

Rocca-Serra P, Bratfalean D, Richard F, Marshall C, Romacker M., Auffray C, ., … on the behalf of the eTRIKS (URL_TO_INSERT_RECORD_8929 https://fairsharing.org/3510)  consortium, . (2016, April 25). eTRIKS (URL_TO_INSERT_RECORD_8930 https://fairsharing.org/3510)  Standard (URL_TO_INSERT_TERM_8925 https://fairsharing.org/search?fairsharingRegistry=Standard) s Starter Pack (URL_TO_INSERT_RECORD_8928 https://fairsharing.org/3510)  Release 1.1 April 2016. Zenodo (URL_TO_INSERT_RECORD_8926 https://fairsharing.org/FAIRsharing.wy4egf)  (URL_TO_INSERT_RECORD_8927 https://fairsharing.org/FAIRsharing.wy4egf) . http://doi.org/10.5281/zenodo.50825

Malone J, Stevens R, Jupp S, Hancocks T, Parkinson H, Brooksbank C. Ten Simple Rules for Selecting a Bio-ontology (URL_TO_INSERT_TERM_8931 https://fairsharing.org/search?recordType=terminology_artefact) . PLoS Comput Biol. 2016;12(2):e1004743. Published 2016 Feb 11. http://doi.org/10.1371/journal.pcbi.1004743

Bairoch A. The Cellosaurus (URL_TO_INSERT_RECORD_8932 https://fairsharing.org/FAIRsharing.hkk309)  (URL_TO_INSERT_RECORD_8933 https://fairsharing.org/FAIRsharing.hkk309) , a cell line knowledge resource. J. Biomol. Tech. (2018) 29:25-38. http://doi.org/10.7171/jbt.18-2902-002.

Sansone, S.-A., McQuilton, P., Rocca-Serra, P., Gonzalez-Beltran, A., Izzo, M., Lister, A.L. and Thurston, M. (2019) FAIR (URL_TO_INSERT_RECORD_8939 https://fairsharing.org/FAIRsharing.WWI10U) sharing (URL_TO_INSERT_RECORD_8937 https://fairsharing.org/FAIRsharing.2abjs5)  (URL_TO_INSERT_RECORD_8938 https://fairsharing.org/FAIRsharing.2abjs5)  as a community approach to standard (URL_TO_INSERT_TERM_8934 https://fairsharing.org/search?fairsharingRegistry=Standard) s, repositories (URL_TO_INSERT_TERM_8936 https://fairsharing.org/search?recordType=repository)  and policies (URL_TO_INSERT_TERM_8935 https://fairsharing.org/search?fairsharingRegistry=Policy) . Nature biotechnology, 37, 358: http://doi.org/10.1038/s41587-019-0080-8.

Hripcsak, G., Ryan, P. B., Duke, J. D., Shah, N. H., Park, R. W., Huser, V., Suchard, M. A., Schuemie, M. J., DeFalco, F. J., Perotte, A., Banda, J. M., Reich, C. G., Schilling, L. M., Matheny, M. E., Meeker, D., Pratt, N., & Madigan, D. (2016). Characterizing treatment pathways at scale using the OHD (URL_TO_INSERT_RECORD_8941 https://fairsharing.org/FAIRsharing.bg7bb6) SI network. Proceedings of the National Academy of Sciences of the Unite (URL_TO_INSERT_RECORD_8940 https://fairsharing.org/FAIRsharing.cnwx8c) d States of America, 113(27), 7329-7336. https://doi.org/10.1073/pnas.1510502113

Hripcsak, George et al. “Observational Health Data Sciences and Informat (URL_TO_INSERT_TERM_8942 https://fairsharing.org/search?recordType=model_and_format) ics (OHD (URL_TO_INSERT_RECORD_8945 https://fairsharing.org/FAIRsharing.bg7bb6) SI): Opportunities for Observational Research (URL_TO_INSERT_RECORD_8944 https://fairsharing.org/FAIRsharing.52b22c) ers.” Studies in health technology and informat (URL_TO_INSERT_TERM_8943 https://fairsharing.org/search?recordType=model_and_format) ics vol. 216 (2015): 574-8.
 -->
