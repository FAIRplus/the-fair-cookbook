(fcb-identifier (URL_TO_INSERT_TERM_6749 https://fairsharing.org/search?recordType=identifier_schema) -map (URL_TO_INSERT_RECORD_6750 https://fairsharing.org/FAIRsharing.53edcc) ping)=
...
| :------------- | :------------- | :------------- |
| [Identifier](http://edamontology.org (URL_TO_INSERT_RECORD_6765 https://fairsharing.org/FAIRsharing.a6r7zs) /data_0842) |   |   |
 -->
...
* [bridgedb.org](https://bridgedb.github.io (URL_TO_INSERT_RECORD_6974 https://fairsharing.org/FAIRsharing.5ry74y) /) 
...
* [UniChem](https://www.ebi.ac.uk/unichem/)
    ...
    > For more informat (URL_TO_INSERT_TERM_7009 https://fairsharing.org/search?recordType=model_and_format) ion including the available methods, see the [UniChem REST documentation](https://www.ebi.ac.uk/unichem/info/webservices).
...
<!-- * [Identifier (URL_TO_INSERT_TERM_7019 https://fairsharing.org/search?recordType=identifier_schema) s.org](https://identifiers.org/)

    > [Identifiers.org](https://identifiers.org) is a **Resolution Service** that provides access to alternative mirrors of the same database (URL_TO_INSERT_TERM_7020 https://fairsharing.org/search?fairsharingRegistry=Database)  which are located at different URL (URL_TO_INSERT_RECORD_7023 https://fairsharing.org/FAIRsharing.9d38e2) s on the web. For example, the UniProt database (URL_TO_INSERT_TERM_7021 https://fairsharing.org/search?fairsharingRegistry=Database)  is based as the Swiss Institute of Bioinformat (URL_TO_INSERT_TERM_7022 https://fairsharing.org/search?recordType=model_and_format) ics but is also mirrored on the NCBI in the States.
    > 
    > The following URL (URL_TO_INSERT_RECORD_7026 https://fairsharing.org/FAIRsharing.9d38e2)  https://identifiers.org/uniprot:P38938 resolves to the UniProt page https://www.uniprot.org (URL_TO_INSERT_RECORD_7027 https://fairsharing.org/FAIRsharing.s1ne3g) /uniprot/P38938 by default (meaning that these identifier (URL_TO_INSERT_TERM_7024 https://fairsharing.org/search?recordType=identifier_schema) s are equivalent) but if the SIB service is unavailable will resolve to https://www.ncbi.nlm.nih.gov/protein (URL_TO_INSERT_RECORD_7025 https://fairsharing.org/FAIRsharing.rtndct) /P38938. -->
...
````
<!-- 
    > * [Identifier (URL_TO_INSERT_TERM_7045 https://fairsharing.org/search?recordType=identifier_schema)  Resolution Services](./findability/id-resolution.html) 
-->
