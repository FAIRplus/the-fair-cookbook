...
|[OWLAPI](http://owlcs.github.io/owlapi/)|A Java API and reference implementation for creating, manipulating and serialising OWL Ontologies.|LGPL and Apache||API|
