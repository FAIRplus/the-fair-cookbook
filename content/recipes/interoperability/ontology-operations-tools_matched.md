...
This recipe aims to provide `an overview of tools available` to perform a number of key operations using ontologies and relevant to FAIR (URL_TO_INSERT_RECORD-ABBREV_1763 https://fairsharing.org/FAIRsharing.WWI10U)  processes: from `ontology management` to using `ontology for annotation` or `performing ontology mapping`.
...
|         Topic        |       Curated tools      |   Related tools in Bio.tools (URL_TO_INSERT_RECORD-NAME_1764 https://fairsharing.org/FAIRsharing.63520c)    |
|:--------------------:|:------------------------:|:------------------------------:|
| Ontology annotation  | ZOOMA                    | bioBERT                        |
|                      | NCBI BioPortal (URL_TO_INSERT_RECORD-NAME_1765 https://fairsharing.org/FAIRsharing.4m97ah)  Annotator | PPR-SSM                        |
|                      | BioBert                  | HPO2GO                         |
|                      | Termite                  | Vapur                          |
...
|                      |                          | thbp                           |
| Ontology mapping     | OxO (URL_TO_INSERT_RECORD-ABBREV_1766 https://fairsharing.org/FAIRsharing.0c6fea)                       | meshr                          |
|                      |                          | locdb                          |
| Ontology management  | AberOWL                  | ngly1                          |
|                      | BioPortal (URL_TO_INSERT_RECORD-NAME_1767 https://fairsharing.org/FAIRsharing.4m97ah)                 | Doc2Hpo                        |
|                      | Centree Ontology Manager | PlanGexQ                       |
|                      | OLS (URL_TO_INSERT_RECORD-ABBREV_1768 https://fairsharing.org/FAIRsharing.Mkl9RR)                       | GOcats                         |
|                      | Ontobee (URL_TO_INSERT_RECORD-NAME_1769 https://fairsharing.org/FAIRsharing.q8fx1b)                   | RDFScape                       |
|                      | PoolParty                | OntoBrowser                    |
|                      |                          | QuickGO                        |
|                      |                          | Circular Gene Ontology (URL_TO_INSERT_RECORD-NAME_1770 https://fairsharing.org/FAIRsharing.6xq0ee)  (CirGO) |
...
Ontoloy Annotation is the process of linking free text or data items to 'tokens' (defined terms from a lexicon) which provide semantic value. For example,  "type 2 diabetes" can be annotated with corresponding [term](http://purl.obolibrary.org/obo/MONDO_0005148) in the MONDO (URL_TO_INSERT_RECORD-ABBREV_1771 https://fairsharing.org/FAIRsharing.b2979t)  disease ontology (URL_TO_INSERT_RECORD-NAME_1772 https://fairsharing.org/FAIRsharing.8b6wfq) . 
...
|[NCBI BioPortal Annotator](https://bioportal.bioontology.org/annotatorplus)|Get annotations for biomedical text with classes from the ontologies.|[BioPor (URL_TO_INSERT_RECORD-NAME_1773 https://fairsharing.org/FAIRsharing.4m97ah) tal Terms of Use](https://www.bioontology.org/terms/)|Ontology and terminology,<br>Systems biology,<br>Data identity and mapping|Web application,<br> API|[BioPort (URL_TO_INSERT_RECORD-NAME_1774 https://fairsharing.org/FAIRsharing.4m97ah) al help](https://bioportal.bioontology.org/help?pop=true#Annotator_Tab)|
...
|[QTL TableMiner++(QTM)](https://bio.tools/QTM) | It is a command-line tool to retrieve and semantically annotate results obtained from QTL mapping experiments. It takes full-text articles from the Europe PMC (URL_TO_INSERT_RECORD-ABBREV_1783 https://fairsharing.org/FAIRsharing.wpt5mp)  (URL_TO_INSERT_RECORD-ABBREV_1784 https://fairsharing.org/FAIRsharing.cmw6mm)  repository as input and outputs the extracted QTLs into a relational database (SQLite) and text file (CSV (URL_TO_INSERT_RECORD-ABBREV_1785 https://fairsharing.org/FAIRsharing.1943d4) ).|[Apache-2.0](https://spdx.org/licenses/Apache-2.0)| Ontology and terminology| Command-line tool |
...
|[BioPortal](https://bioportal.bioontology.org/)|A repository of biomedical ontologies.|[BioPor (URL_TO_INSERT_RECORD-NAME_1786 https://fairsharing.org/FAIRsharing.4m97ah) tal Terms of Use](https://www.bioontology.org/terms/)|Ontology and terminology|Web Application, API|
...
|[Ontobee](http://www.ontobee.org/)|A linked data server designed for ontologies. Ontobee (URL_TO_INSERT_RECORD-NAME_1787 https://fairsharing.org/FAIRsharing.q8fx1b)  is aimed to facilitate ontology data sharing, visualization, query, integration, and analysis.|[Apache 2.0](http://www.apache.org/licenses/LICENSE-2.0.html)||Web application|
|[AberOWL](http://www.aber-owl.net/)|A framework for ontology-based access to biological data. It consists of a repository of bio-ontologies, a set of webservices which provide access to OWL (URL_TO_INSERT_RECORD-ABBREV_1788 https://fairsharing.org/FAIRsharing.atygwy) (-EL) reasoning over the ontologies, and several frontends which utilise the ontology repository and reasoning services.|||Web application, API|
...
| Tool| Description  | License | Topics | Type|
|---|--|--|--|--|
|[ngly1](https://bio.tools/ngly1)| A repository for the NGLY1 Deficiency Knowledge Graph, the reasoning context to support hypothesis discovery for NGLY1 Deficiency-CDDG (DOID (URL_TO_INSERT_RECORD-ABBREV_1789 https://fairsharing.org/FAIRsharing.8b6wfq) :0060728) research. The user can navigate the knowledge in the graph in the Neo4j Browser website. | N/A  | Molecular interactions, pathways and networks, Ontology and terminology, Machine learning       | Command-line tool |
| [Doc2Hpo](https://bio.tools/doc2hpo) | Web application for efficient and accurate Human Phenotype Ontology (URL_TO_INSERT_RECORD-NAME_1790 https://fairsharing.org/FAIRsharing.kbtt7f)  (HPO) concept curation. |[Unlicense](https://spdx.org/licenses/Unlicense) | Genotype and phenotype, Ontology and terminology, Natural language processing| Web application |
...
|[GOcats](https://bio.tools/gocats)|Advances in gene ontology (URL_TO_INSERT_RECORD-NAME_1791 https://fairsharing.org/FAIRsharing.6xq0ee)  utilization improve statistical power of annotation enrichment.|N/A| Mapping, Ontology and terminology, Microarray experiment     | Command-line tool                      |
| [RDFScape](https://bio.tools/rdfscape) | This is a project that brings Semantic Web features to the popular Systems Biology software Cytoscape. It allows to query, visualize and reason on ontologies represented in OWL (URL_TO_INSERT_RECORD-ABBREV_1793 https://fairsharing.org/FAIRsharing.atygwy)  or RDF (URL_TO_INSERT_RECORD-ABBREV_1792 https://fairsharing.org/FAIRsharing.p77ph9)  within Cytoscape.  |         | Systems biology, Ontology and terminology, Biology    | Desktop application                    |
| [OntoBrowser](https://bio.tools/ontobrowser)| The tool was developed to manage ontologies (and controlled terminologies e.g. CDISC (URL_TO_INSERT_RECORD-NAME_1796 https://fairsharing.org/3525)  SEND (URL_TO_INSERT_RECORD-ABBREV_1794 https://fairsharing.org/FAIRsharing.7z842d) ). The primary goal of the tool is to provide an online collaborative solution for expert curators to map (URL_TO_INSERT_RECORD-NAME_1795 https://fairsharing.org/FAIRsharing.53edcc)  code list terms (sourced from multiple systems/databases) to preferred ontology terms.|[Apache 2.0](http://www.apache.org/licenses/LICENSE-2.0.html)| Ontology and terminology, Data identity and mapping      | Web API, Web application               |
|[QuickGO](https://bio.tools/quickgo)| A fast browser for Gene Ontology (URL_TO_INSERT_RECORD-NAME_1797 https://fairsharing.org/FAIRsharing.6xq0ee)  terms and annotations.    |         | Ontology and terminology      | Web application                        |
...
|[OWLAPI](http://owlcs.github.io/owlapi/)|A Java API and reference implmentation for creating, manipulating and serialising OWL (URL_TO_INSERT_RECORD-ABBREV_1798 https://fairsharing.org/FAIRsharing.atygwy)  Ontologies.|LGPL and Apache||API|
...
|[VocBench](http://vocbench.uniroma2.it/)|a web-based, multilingual, collaborative development platform for managing OWL (URL_TO_INSERT_RECORD-ABBREV_1801 https://fairsharing.org/FAIRsharing.atygwy)  ontologies, SKOS (URL_TO_INSERT_RECORD-ABBREV_1800 https://fairsharing.org/FAIRsharing.48e326) (/XL) thesauri, Ontolex-lemon lexicons and generic RDF (URL_TO_INSERT_RECORD-ABBREV_1799 https://fairsharing.org/FAIRsharing.p77ph9)  datasets.|[License](https://bitbucket.org/art-uniroma2/vocbench3/src/master/LICENSE)||Desktop application|
