...
|----------------------|--------------------|---------------------------|-------------------------------------------------------|--------------------------------------------|---------------------------|--------------------|---------------|-------------------|-------------------| ------------|--------------------------|---------------------------------|-------------------------|----------------|------------------------|----------|----------------------|---------------------------------------------|
| 1\_Subjects.txt      | SUBJECT\_ID        | Subject number            | https://schema.org/identifier <br/> DM/SV/VS/LB.USUBJID   | https://schema.org <br/> CDISC:SDTMIG      | categorical variable      | integer            |               |                   |                   |             |                          |                                 |                         | Y              |                        | Y        | FORM 1               |                                             |
| 1\_Subjects.txt      | SPECIES            | Species name              | https://schema.org/name    <br/> DM.SPECIES           | https://schema.org <br/> CDISC:SDTMIG      | categorical variable      | string             |               |                   |                   |            |                          |                                 |                         |                |                        |          | FORM 1               |                                             |
| 1\_Subjects.txt      | STRAIN             | Strain                    | https://bioschemas.org/profiles/Taxon/0.6-RELEASE/identifier <br/> DM.STRAIN| https://bioschemas.org/ <br/> CDISC:SDTMIG  | categorical variable | string            |               |                   |                   |            |                          | http://purl.obolibrary.org/obo/NCBITaxon_40674 |          |                |                        |          | FORM 1               |                                             |
| 1\_Subjects.txt      | AGE                | Age at study initiation   | https://bioschemas.org/types/BioSample/0.1-RELEASE-2019_06_19/samplingAge  <br/> DM.AGE | https://bioschemas.org/ <br/> CDISC:SDTMIG  | continuous variable | integer |             |                   |                   |             |                          |                                 |                         |                |                        | Y        | FORM 1               |                                             |
| 1\_Subjects.txt      | AGE\_UNIT          | Age unit                  | http://purl.obolibrary.org/obo/UO_0000003 <br/> DM.AGEU | http://purl.obolibrary.org/obo/uo <br/> CDISC:SDTMIG  | categorial variable | string |             |                   |                   |             |                          |                                 |                         |                |                        | Y        | FORM 1               |                                             |
| 1\_Subjects.txt      | SEX                | Sex                       | https://schema.org/gender  <br/> DM.SEX               | https://schema.org  <br/> CDISC:SDTMIG     | categorical variable      | enum               |               |                   |                   |             | M;F                      | M=male;F=female                 |                         |                |                        |          | FORM 1               |                                             |
| 1\_Subjects.txt      | SOMEDATE           | Date of acquiring subject | https://schema.org/dateCreated <br/> SV.SVSTDTC        | https://schema.org  <br/> CDISC:SDTMIG      | ordinal variable          | date               |               |                   |                   | YYYY-MM-DD |                          |                                 |                         |                |                        |          | FORM 1               |                                             |
| 1\_Subjects.txt      | HEMOGLOBIN         | Hematology: Hemoglobin    | http://www.ebi.ac.uk/efo/EFO_0004509 <br/> LB.LBORRES  | http://www.ebi.ac.uk/efo <br/> CDISC:SDTMIG | continuous variable       | float              | 2,1           | 15.0              | 4.0               |             |                          |                                 |                         |                |                        |          | FORM 1               | Field size denotes "places, decimal places" |
| 1\_Subjects.txt      | HEMOGLOBIN\_UNIT   | Hemoglobin unit           | http://purl.obolibrary.org/obo/UO_0000003 <br/> LB.LBORRESU | http://www.ebi.ac.uk/efo <br/> CDISC:SDTMIG | continuous variable       | float              | 2,1           | 15.0              | 4.0               |             |                          |                                 |                         |                |                        |          | FORM 1               | Field size denotes "places, decimal places" |
| 1\_Subjects.txt      | HEIGHT             | Body size                 | https://schema.org/height <br/> VS.VSORRES               | https://schema.org  <br/> CDISC:SDTMIG      | continuous variable       | float              |               | 2,5               | 0,5               |             |                          |                                 |                         |                |                        |          |                      |                                             |
| 1\_Subjects.txt      | HEIGHT\_UNIT       | Body size unit            | http://purl.obolibrary.org/obo/UO_0000003 <br/> VS.VSORRESU  | https://schema.org  <br/> CDISC:SDTMIG      | continuous variable       | float              |               | 2,5               | 0,5               |             |                          |                                 |                         |                |                        |          |                      |                                             |
| 1\_Subjects.txt      | WEIGHT             | Body weight               | https://schema.org/weight <br/> VS.VSORRES             | https://schema.org  <br/> CDISC:SDTMIG      | continuous variable       | float              |               | 300               | 25                |             |                          |                                 |                         |                |                        |          |                      |                                             |
| 1\_Subjects.txt      | WEIGHT\_UNIT       | Body weight unit          | http://purl.obolibrary.org/obo/UO_0000003 <br/> VS.VSORRESU  | https://schema.org  <br/> CDISC:SDTMIG      | continuous variable       | float              |               | 300               | 25                |             |                          |                                 |                         |                |                        |          |                      |                                             |
| 1\_Subjects.txt      | BMI                | Body mass index           | http://www.ebi.ac.uk/efo/EFO_0004340 <br/> VS.VSORRES    | http://www.ebi.ac.uk/efo <br/> CDISC:SDTMIG | continuous variable       | float              |               | 100               | 10                |             |                          |                                 | WEIGHT/(HEIGHT\*HEIGHT) |                |                        |          |                      |                                             |
| 1\_Subjects.txt      | LAB                | Laboratory                | https://schema.org/identifier <br/>  LB.LBNAM              | https://schema.org  <br/> CDISC:SDTMIG      | categorical variable      | integer            |               |                   |                   |             | 1;2;3                    | 1=LabA;2=UniversityB;3=CompanyC |                         |                |                        |          | FORM 1               |                                             |
| 2\_Samples.txt       | SAMPLE\_ID         | Sample ID                 | https://schema.org/identifier <br/>                     | https://schema.org  <br/> CDISC:SDTMIG      | categorical variable      | string             |               |                   |                   |             |                          |                                 |                         | Y              |                        | Y        | FORM 2               |                                             |
| 2\_Samples.txt       | SAMPLE\_SITE       | Sample collection site    | https://bioschemas.org/types/BioSample/0.1-RELEASE-2019_06_19 <br/> /locationcreated | https://bioschemas.org/ <br/> CDISC:SDTMIG  | categorical variable | string |        |                   |                   |             |                          |                                 |                         |                |                        | Y        | FORM 2               |                                             |
| 2\_Samples.txt       | ANALYTE\_TYPE      | Type of analysis          | http://edamontology.org/operation_2945  <br/>              | http://edamontology.org <br/> CDISC:SDTMIG  | categorical variable      | string             |               |                   |                   |             |                          | http://edamontology.org/operation_2945 |                  |                |                        | Y        | FORM 2               |                                             |
| 2\_Samples.txt       | GENOTYPING\_CENTER | GENOTYPING\_CENTER        | https://schema.org/identifier <br/> LB.LBNAM               | https://schema.org  <br/> CDISC:SDTMIG      | categorical variable      | string             |               |                   |                   |             |                          |                                 |                         |                |                        |          | FORM 2               |                                             |
| 2\_Samples.txt       | SEQUENCING\_CENTER | SEQUENCING\_CENTER        | https://schema.org/identifier <br/> LB.LBNAM               | https://schema.org  <br/> CDISC:SDTMIG      | categorical variable      | string             |               |                   |                   |             |                          |                                 |                         |                |                        |          | FORM 2               |                                             |
| 3\_SampleMapping.txt | SUBJECT\_ID        | Subject number            | https://schema.org/identifier <br/>                        | https://schema.org  <br/> CDISC:SDTMIG      | ordinal variable          | integer            |               |                   |                   |            |                          |                                 |                         |                | SAMPLE\_ID             | Y        | FORM 3               |                                             |
| 3\_SampleMapping.txt | SAMPLE\_ID         | Sample ID                 | https://schema.org/identifier <br/>                        | https://schema.org  <br/> CDISC:SDTMIG      | categorical variable      | string             |               |                   |                   |             |                          |                                 |                         |                | SUBJECT\_ID            | Y        | FORM 3               |                                             |                                          |

*Here, we present two complementary options for expressing variable types. Semantic types such as schema.org or ontology terms enhance the findability of the data in repositories. Anchoring the variables in a domain-relevant data standard such as CDISC (as shown here) or the OMOP CDM helps improve interoperability with other datasets in that domain. It should be noted that CDISC-compliant datasets group variables slightly differently to the format suggested here. Records are grouped by `Domain` such as vital signs (VS) and demographics (DM). Records represent one single measurement, so rather than capturing both height and weight in one record, like in the data dictionary here, these would be separate records in the VS domain, with test name (VSTESTCD) height or weight, respectively. For further information on the CDISC model, please visit (https://www.cdisc.org/).   
___
