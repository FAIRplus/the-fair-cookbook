...
| :------------- | :------------- | :------------- |
| semantic markup<!-- TO(URL_TO_INSERT_RECORD http://browser.planteome.org/amigo/term/TO:0000387#display-lineage-tab)DO add a link to corresponding document -->|text<!-- TO(URL_TO_INSERT_RECORD http://browser.planteome.org/amigo/term/TO:0000387#display-lineage-tab)DO add a link to corresponding document -->  | URI(URL_TO_INSERT_RECORD https://www.rfc-editor.org/rfc/rfc3986)<!-- TO(URL_TO_INSERT_RECORD http://browser.planteome.org/amigo/term/TO:0000387#display-lineage-tab)DO add a link to corresponding document -->|
| constraint validation<!-- TO(URL_TO_INSERT_RECORD http://browser.planteome.org/amigo/term/TO:0000387#display-lineage-tab)DO add a link to corresponding document -->  | text<!-- TO(URL_TO_INSERT_RECORD http://browser.planteome.org/amigo/term/TO:0000387#display-lineage-tab)DO add a link to corresponding document -->  | DOI(URL_TO_INSERT_RECORD https://www.doi.org)<!-- TO(URL_TO_INSERT_RECORD http://browser.planteome.org/amigo/term/TO:0000387#display-lineage-tab)DO add a link to corresponding document -->  |
||file||
...
| [SP(URL_TO_INSERT_RECORD http://bioportal.bioontology.org/ontologies/SP)ARQL(URL_TO_INSERT_RECORD http://www.w3.org/TR/sparql11-overview/) 1.1](https://www.w3.org/TR/sparql11-query/)|[schema.org(URL_TO_INSERT_RECORD http://schema.org/)](https://fairsharing.org(URL_TO_INSERT_RECORD https://fairsharing.org/)(URL_TO_INSERT_RECORD https://fairsharing.org)(URL_TO_INSERT_RECORD https://fairsharing.org/)/FAIRsharing.hzdzq8)||
| [Shape Expression Syntax (SHEX)](https://shex.io/shex-semantics/)|[EDAM](https://fairsharing.org(URL_TO_INSERT_RECORD https://fairsharing.org/)(URL_TO_INSERT_RECORD https://fairsharing.org)(URL_TO_INSERT_RECORD https://fairsharing.org/)/FAIRsharing.a6r7zs)||
| |[OBO(URL_TO_INSERT_RECORD http://www.obofoundry.org/)(URL_TO_INSERT_RECORD http://bioportal.bioontology.org/ontologies/3059) foundry(URL_TO_INSERT_RECORD http://www.obofoundry.org/)](https://fairsharing.org(URL_TO_INSERT_RECORD https://fairsharing.org/)(URL_TO_INSERT_RECORD https://fairsharing.org)(URL_TO_INSERT_RECORD https://fairsharing.org/)/biodbcore-001083/)||
| |[Wikidata(URL_TO_INSERT_RECORD http://wikidata.org/)(URL_TO_INSERT_RECORD http://wikidata.org/)](https://fairsharing.org(URL_TO_INSERT_RECORD https://fairsharing.org/)(URL_TO_INSERT_RECORD https://fairsharing.org)(URL_TO_INSERT_RECORD https://fairsharing.org/)/FAIRsharing.PB6595)||

## Tools
| Tool Name| capability|
|:--|:--|
| [Semantic Annotation for Linked Arvado Data (SALAD)](https://www.commonwl.org(URL_TO_INSERT_RECORD http://www.commonwl.org)/draft-3/SchemaSalad.html)  | conversion from  YAML to RDF(URL_TO_INSERT_RECORD http://www.w3.org/TR/2014/REC-rdf11-concepts-20140225/) |
|[WESO(URL_TO_INSERT_RECORD http://www.sequenceontology.org/) shExVisualize](http://rdfshape.weso.es/shExVisualize) | Shape expression syntax visualization |
| [Virtuoso](https://virtuoso.openlinksw.com/) | RDF(URL_TO_INSERT_RECORD http://www.w3.org/TR/2014/REC-rdf11-concepts-20140225/) triple store |
...
Several distinct to the following resources map(URL_TO_INSERT_RECORD https://www.cog-genomics.org/plink2/formats#map)pings have been made by the developers :
    
- [OBO(URL_TO_INSERT_RECORD http://www.obofoundry.org/)(URL_TO_INSERT_RECORD http://bioportal.bioontology.org/ontologies/3059) Foundry(URL_TO_INSERT_RECORD http://www.obofoundry.org/)](https://obofoundry.org)
- [Wikidata(URL_TO_INSERT_RECORD http://wikidata.org/)(URL_TO_INSERT_RECORD http://wikidata.org/)](https://wikidata.org(URL_TO_INSERT_RECORD http://wikidata.org/))
- [schema.org(URL_TO_INSERT_RECORD http://schema.org/)](https://schema.org(URL_TO_INSERT_RECORD http://schema.org/))
...
However, for the final implementation, only the OBO(URL_TO_INSERT_RECORD http://www.obofoundry.org/)(URL_TO_INSERT_RECORD http://bioportal.bioontology.org/ontologies/3059) related map(URL_TO_INSERT_RECORD https://www.cog-genomics.org/plink2/formats#map)pings have been used as show in the following figure.
...
`source`: https://github.com(URL_TO_INSERT_RECORD https://github.com/)/arvados/bh20-seq-resource/blob/master/example/maximum_metadata_example.yaml
...
While defining a SALA(URL_TO_INSERT_RECORD https://www.ala.org.au/)D(URL_TO_INSERT_RECORD http://darwin.biochem.okstate.edu/lad/ilat/) schema using YAML allows to list key entities and their attributes, it does not allow to check constraints. This has to be done on the RDF(URL_TO_INSERT_RECORD http://www.w3.org/TR/2014/REC-rdf11-concepts-20140225/) which needs to be checks for compliancee against a set of constraints which can be expressed using ShEx. Working with a ShEx expert ([Dr Jose Emilio Labra Gayo - (Oviedo Uni)](http://di002.edv.uniovi.es/~labra/), the following [Shape Expression syntax](https://shex.io/shex-semantics/) profile was developed(URL_TO_INSERT_RECORD https://www.cog-genomics.org/plink2/formats#ped) and used to validate the RDF(URL_TO_INSERT_RECORD http://www.w3.org/TR/2014/REC-rdf11-concepts-20140225/) before persistence to the SP(URL_TO_INSERT_RECORD http://bioportal.bioontology.org/ontologies/SP)ARQL(URL_TO_INSERT_RECORD http://www.w3.org/TR/sparql11-overview/) endpoint.
...
---
width: 1200px
name: WESO(URL_TO_INSERT_RECORD http://www.sequenceontology.org/) SHape Expression Viewer
alt: WESO(URL_TO_INSERT_RECORD http://www.sequenceontology.org/) SHape Expression Viewer
---
WESO(URL_TO_INSERT_RECORD http://www.sequenceontology.org/) SHape Expression Viewer
```
````
...
Limiting search(URL_TO_INSERT_RECORD https://arch.library.northwestern.edu/) to metadata add http://covid-19.genenetwork.org/graph/metadata.ttl in the top input box. Now you can find a predicate for submitter that looks like http://biohackathon.org/bh20-seq-schema#MainSchema/submitter.
