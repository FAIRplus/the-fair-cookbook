...
Some ontologies, often large projects organized by consortia, have a detailed formal request process, maybe even with a dedicated ticketing and tracking system. A big number of ontologies rely on [GitHub](https://github.com) as a publicly accessible ticketing system for reporting issues on the ontology and also for requesting new terms. They might provide explicit guidelines on how to create an issue for a new term request, or they rely on GitHub (URL_TO_INSERT_RECORD-NAME_1740 https://fairsharing.org/FAIRsharing.c55d5e)  issues without guidelines. And there are also ontologies relying on email for requesting new terms. These different request processes can be summarized as follows:
* Formal request process
* Request via GitHub (URL_TO_INSERT_RECORD-NAME_1741 https://fairsharing.org/FAIRsharing.c55d5e)  with explicit guidelines
* Request via GitHub (URL_TO_INSERT_RECORD-NAME_1742 https://fairsharing.org/FAIRsharing.c55d5e)  without guidelines
* Request via email

In most ontologies, everybody can request new terms. However, in some ontologies only members have access to the request process. In case of a request process organized via GitHub (URL_TO_INSERT_RECORD-NAME_1743 https://fairsharing.org/FAIRsharing.c55d5e) , a free [GitHub account](https://github.com/join) is required.


## Ingredients
* List of new terms
* Target ontology
    * E.g. SNOMED CT, MedDRA (URL_TO_INSERT_RECORD-ABBREV_1751 https://fairsharing.org/FAIRsharing.ad3137) , OBI (URL_TO_INSERT_RECORD-ABBREV_1748 https://fairsharing.org/FAIRsharing.284e1z) , EFO (URL_TO_INSERT_RECORD-ABBREV_1747 https://fairsharing.org/FAIRsharing.1gr4tz) , BAO (URL_TO_INSERT_RECORD-ABBREV_1750 https://fairsharing.org/FAIRsharing.mye76w) , CL (URL_TO_INSERT_RECORD-ABBREV_1749 https://fairsharing.org/FAIRsharing.j9y503) , RxNorm (URL_TO_INSERT_RECORD-NAME_1752 https://fairsharing.org/FAIRsharing.36pf8q) , BTO (URL_TO_INSERT_RECORD-ABBREV_1746 https://fairsharing.org/FAIRsharing.1414v8)  - BRENDA (URL_TO_INSERT_RECORD-ABBREV_1744 https://fairsharing.org/FAIRsharing.etp533) , DCAT (URL_TO_INSERT_RECORD-ABBREV_1745 https://fairsharing.org/FAIRsharing.h4j3qm)  2
...
| :------------- | :------------- |
| [OWL](https://fairsharing.org/FAIRsharing.atygwy)  | [OBI](https://fairsharing.org/FAIRsharing.284e1z), [Cell Ontology (URL_TO_INSERT_RECORD-NAME_1753 https://fairsharing.org/FAIRsharing.j9y503) ](https://fairsharing.org/FAIRsharing.j9y503)|
| [OBO](https://fairsharing.org/FAIRsharing.aa0eat)  | [Cell Ontology (URL_TO_INSERT_RECORD-NAME_1754 https://fairsharing.org/FAIRsharing.j9y503) ](https://fairsharing.org/FAIRsharing.j9y503)  |
...
**Step 2**
Identify request process of the public ontology (i.e. formal request process, GitHub (URL_TO_INSERT_RECORD-NAME_1755 https://fairsharing.org/FAIRsharing.c55d5e)  request with guidelines, GitHub (URL_TO_INSERT_RECORD-NAME_1756 https://fairsharing.org/FAIRsharing.c55d5e)  request without guidelines, email request).
...
**Information about requesting changes or additions:** 
OBI (URL_TO_INSERT_RECORD-ABBREV_1757 https://fairsharing.org/FAIRsharing.284e1z)  provides a [GitHub repository](https://github.com/obi-ontology/obi) and a mailing list. New-term requests are handled as GitHub (URL_TO_INSERT_RECORD-NAME_1758 https://fairsharing.org/FAIRsharing.c55d5e)  issues. There is an explicit [guideline document](http://obi-ontology.org/page/OBI_term_guidelines) on how to request new terms.
...
* example of usage
* term editor: your name, and that of any collaborators, as it should appear in OBI (URL_TO_INSERT_RECORD-ABBREV_1759 https://fairsharing.org/FAIRsharing.284e1z) 
...
**Information about requesting changes or additions**:
The Cell Ontology (URL_TO_INSERT_RECORD-NAME_1760 https://fairsharing.org/FAIRsharing.j9y503)  provides a [GitHub repository](https://github.com/obophenotype/cell-ontology), a contact email, and a mail list. New-term requests (NTR) are formulated as issues on the GitHub (URL_TO_INSERT_RECORD-NAME_1761 https://fairsharing.org/FAIRsharing.c55d5e)  repository. 
...
**Information about requesting changes or additions**:
Information about requesting terms can be found in the [FAQ section](https://www.nlm.nih.gov/research/umls/faq_main.html) of the Unified Medical Language System (UMLS) where RxNorm (URL_TO_INSERT_RECORD-NAME_1762 https://fairsharing.org/FAIRsharing.36pf8q)  is part of.  
