...
but also manage expectations (and costs) when devising a FAIR(URL_TO_INSERT_RECORD https://www.go-fair.org/fair-principles/)ification program for specific domains and digital objects
...
Large amounts of literature exist detailing the key ideas for handling data. A resource such as the *DAMA(URL_TO_INSERT_RECORD http://www.informatics.jax.org/vocab/gxd/ma_ontology/) book(URL_TO_INSERT_RECORD http://bioportal.bioontology.org/ontologies/3059)* covers in 
great depths the fundamental operations and challenges associated with data management activities {footcite}`DAMA(URL_TO_INSERT_RECORD http://www.informatics.jax.org/vocab/gxd/ma_ontology/)-DMB(URL_TO_INSERT_RECORD http://www.Metabase.net)O(URL_TO_INSERT_RECORD http://bioportal.bioontology.org/ontologies/3059)OK(URL_TO_INSERT_RECORD http://bioportal.bioontology.org/ontologies/3059)`.

More recently, The FAIR(URL_TO_INSERT_RECORD https://www.go-fair.org/fair-principles/) principles(URL_TO_INSERT_RECORD https://www.go-fair.org/fair-principles/) articulated key requirements and properties data should have {footcite}`pmid26978244`.
...
Each recipe in the FAIR(URL_TO_INSERT_RECORD https://www.go-fair.org/fair-principles/)plus Cookbook(URL_TO_INSERT_RECORD http://bioportal.bioontology.org/ontologies/3059) now incorporates one or more FAIR(URL_TO_INSERT_RECORD https://www.go-fair.org/fair-principles/)plus DSM indicators.
...
---
width: 450px
name: FAIR(URL_TO_INSERT_RECORD https://www.go-fair.org/fair-principles/) DSM indicators in the FAIR(URL_TO_INSERT_RECORD https://www.go-fair.org/fair-principles/) Cookbook(URL_TO_INSERT_RECORD http://bioportal.bioontology.org/ontologies/3059) Recipe card
alt:  FAIR(URL_TO_INSERT_RECORD https://www.go-fair.org/fair-principles/) DSM indicators in the FAIR(URL_TO_INSERT_RECORD https://www.go-fair.org/fair-principles/) Cookbook(URL_TO_INSERT_RECORD http://bioportal.bioontology.org/ontologies/3059) Recipe card
---
 FAIR(URL_TO_INSERT_RECORD https://www.go-fair.org/fair-principles/) DSM indicators in the FAIR(URL_TO_INSERT_RECORD https://www.go-fair.org/fair-principles/) Cookbook(URL_TO_INSERT_RECORD http://bioportal.bioontology.org/ontologies/3059) Recipe card
```
````
...
FAIR(URL_TO_INSERT_RECORD https://www.go-fair.org/fair-principles/)plus DSM developed(URL_TO_INSERT_RECORD https://www.cog-genomics.org/plink2/formats#ped) a dedicated manual assessment template.

### Training the assessor

As with any tool, fam(URL_TO_INSERT_RECORD https://www.cog-genomics.org/plink2/formats#fam)iliarization and training are necessary to ensure that the personnel carrying out the evaluations 
...
---
width: 800px
name: FAIR(URL_TO_INSERT_RECORD https://www.go-fair.org/fair-principles/) DSM indicators before and after intervention-Content
alt:   FAIR(URL_TO_INSERT_RECORD https://www.go-fair.org/fair-principles/) DSM indicators before and after intervention-Content
---
FAIR(URL_TO_INSERT_RECORD https://www.go-fair.org/fair-principles/) DSM indicators before and after intervention-Content
```
````
...
---
width: 800px
name: FAIR(URL_TO_INSERT_RECORD https://www.go-fair.org/fair-principles/) DSM indicators before and after intervention-Access
alt:  FAIR(URL_TO_INSERT_RECORD https://www.go-fair.org/fair-principles/) DSM indicators before and after intervention-Access
---
FAIR(URL_TO_INSERT_RECORD https://www.go-fair.org/fair-principles/) DSM indicators before and after intervention-Access
```
````
...
Moving through maturity levels with ISA by running the following notebook(URL_TO_INSERT_RECORD http://bioportal.bioontology.org/ontologies/3059)s in the indicated order:

- [improving dataset maturity: the MIAPP(URL_TO_INSERT_RECORD https://bitbucket.org/PlantExpAssay/ontology)E(URL_TO_INSERT_RECORD http://miappe.org)(URL_TO_INSERT_RECORD http://bioportal.bioontology.org/ontologies/PE) use case](https://w3id.org(URL_TO_INSERT_RECORD https://w3id.org/)/faircookbook/FCB062) 
- [create-a-simple-isa-descriptor](https://w3id.org(URL_TO_INSERT_RECORD https://w3id.org/)/faircookbook/FCB063)
- [isa-api-programmatic-rebuild-of-BII-S-3](https://w3id.org(URL_TO_INSERT_RECORD https://w3id.org/)/faircookbook/FCB064)
- [isa-json-conversion-to-rdf-linked-data](https://w3id.org(URL_TO_INSERT_RECORD https://w3id.org/)/faircookbook/FCB064)
- [isa-as-ro](https://w3id.org(URL_TO_INSERT_RECORD https://w3id.org/)/faircookbook/FCB066)
