...
Like a software license, a data license governs what someone else can do with data that you create or own and that you make accessible to others through, for example, a data repository (URL_TO_INSERT_TERM_10564 https://fairsharing.org/search?recordType=repository) .
...
Creative Commons or CC provides a number of licenses that can be used with a wide variety of creations that might otherwise fall under copyright restrictions, including music, art, book (URL_TO_INSERT_RECORD_10565 https://fairsharing.org/FAIRsharing.cbz72b) s and photographs.
...
In many instances, data repositories (URL_TO_INSERT_TERM_10566 https://fairsharing.org/search?recordType=repository)  maintained by universities recommend CC0 as the default option, such as the [4TU.Centre for Research (URL_TO_INSERT_RECORD_10567 https://fairsharing.org/FAIRsharing.52b22c)  Data](https://data.4tu.nl/info/fileadmin/user_upload/Documenten/Data_collection_policy_2020.pdf).

(rr-licensing-data-odc)=
## Open Data Commons

Open Data Commons provides three licenses that can be applied specifically to data.
The [webpages](https://opendatacommons.org/licenses/index.html) {footcite}`odk2020odc` of each of these licenses include human-readable summaries, with the ramifications of the legalese explained in a concise format (URL_TO_INSERT_TERM_10568 https://fairsharing.org/search?recordType=model_and_format) .
...
Any use or distribution of your database (URL_TO_INSERT_TERM_10569 https://fairsharing.org/search?fairsharingRegistry=Database)  must also include informat (URL_TO_INSERT_TERM_10570 https://fairsharing.org/search?recordType=model_and_format) ion on the license used with the original.

(rr-licensing-data-odc-odbl)=
### The Open Database License or ODbL

The ODbL adds two more restrictions to the ODC (URL_TO_INSERT_RECORD_10571 https://fairsharing.org/FAIRsharing.3nx7t)  (URL_TO_INSERT_RECORD_10572 https://fairsharing.org/3547) -BY license.
The first is that any public uses of your data must be shared with the same license, similar to the CC **SA** permission mark.
The second is that if any version of your data is redistributed in a 'closed' format (URL_TO_INSERT_TERM_10573 https://fairsharing.org/search?recordType=model_and_format)  (for example, with Technological Protection Measures), it is mandatory for this redistribution to also be available in a version that is free of such closure measures.
...
The ODC (URL_TO_INSERT_RECORD_10575 https://fairsharing.org/FAIRsharing.3nx7t)  (URL_TO_INSERT_RECORD_10576 https://fairsharing.org/3547)  licenses were made specifically to be applied to data, and typically cover only database (URL_TO_INSERT_TERM_10574 https://fairsharing.org/search?fairsharingRegistry=Database)  rights.
...
Another difference is the availability of a standard (URL_TO_INSERT_TERM_10577 https://fairsharing.org/search?fairsharingRegistry=Standard) ised Community Norms document with the PDDL.
...
It is also possible to choose other data licenses that may have been developed (URL_TO_INSERT_RECORD_10578 https://fairsharing.org/FAIRsharing.31385c)  with a specific use case or community in mind or that are not in widespread global use.
These include licenses that were developed (URL_TO_INSERT_RECORD_10579 https://fairsharing.org/FAIRsharing.31385c)  by national governments, such as the [Norwegian License for Open Government Data](https://data.norge.no/nlod/en/) {footcite}`nlod2020governmentdata`.
...
Another example is the [Open Government Licence](http://www.nationalarchives.gov.uk/doc/open-government-licence/version/3/) or OGL, which was developed (URL_TO_INSERT_RECORD_10581 https://fairsharing.org/FAIRsharing.31385c)  by The National Arch (URL_TO_INSERT_RECORD_10580 https://fairsharing.org/FAIRsharing.52b22c) ives, UK.

The [Data Curation Center (DC (URL_TO_INSERT_RECORD_10583 https://fairsharing.org/FAIRsharing.3nx7t)  (URL_TO_INSERT_RECORD_10585 https://fairsharing.org/3547) C) guide](https://www.dcc.ac.uk/guidance/how-guides/license-research-data) {footcite}`ball2011license` on how to license research (URL_TO_INSERT_RECORD_10584 https://fairsharing.org/FAIRsharing.52b22c)  data expatiates on the licenses discussed in this chapter, and gives more informat (URL_TO_INSERT_TERM_10582 https://fairsharing.org/search?recordType=model_and_format) ion about [Prepared Licenses](https://www.dcc.ac.uk/guidance/how-guides/license-research-data#x1-6000), [Bespoke Licenses](https://www.dcc.ac.uk/guidance/how-guides/license-research-data#x1-7000), [Multiple Licensing](https://www.dcc.ac.uk/guidance/how-guides/license-research-data#x1-13000) and [Mechanisms for Licensing Data](https://www.dcc.ac.uk/guidance/how-guides/license-research-data#x1-14000).
