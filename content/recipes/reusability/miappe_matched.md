...
In terms of FAIR (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.WWI10U) ification goals, this means obtaining stable, resolvable  identifier (URL_TO_INSERT_TERM https://fairsharing.org/search?recordType=identifier_schema) s for the datasets and meeting
...
|--- |--- |--- |
|[FAST (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.p5df9c) Q](https://fairsharing.org (URL_TO_INSERT_RECORD http://127.0.0.1:8080/3518)  (URL_TO_INSERT_RECORD http://127.0.0.1:8080/3536)  (URL_TO_INSERT_RECORD http://127.0.0.1:8080/3538) /FAIRsharing.r2ts5t)|||
|[FAST (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.p5df9c) A (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.rz4vfg) ](https://fairsharing.org (URL_TO_INSERT_RECORD http://127.0.0.1:8080/3518)  (URL_TO_INSERT_RECORD http://127.0.0.1:8080/3536)  (URL_TO_INSERT_RECORD http://127.0.0.1:8080/3538) /FAIRsharing.rz4vfg)|||
|[MIAPP (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.tghhc4) E (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.b403jy)  (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.nd9ce9) ](https://fairsharing.org (URL_TO_INSERT_RECORD http://127.0.0.1:8080/3518)  (URL_TO_INSERT_RECORD http://127.0.0.1:8080/3536)  (URL_TO_INSERT_RECORD http://127.0.0.1:8080/3538) /FAIRsharing.nd9ce9)|||
|[Variant File Format (URL_TO_INSERT_TERM https://fairsharing.org/search?recordType=model_and_format)  (.vcf)](https://fairsharing.org (URL_TO_INSERT_RECORD http://127.0.0.1:8080/3518)  (URL_TO_INSERT_RECORD http://127.0.0.1:8080/3536)  (URL_TO_INSERT_RECORD http://127.0.0.1:8080/3538) /FAIRsharing.cfzz0h)|||
|[BioSample (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.qr6pqk) s - Plant MIAPP (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.tghhc4) E (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.b403jy)  (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.nd9ce9)  checklist](https://www.ebi.ac.uk/biosamples (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.ewjdq6) /schemas/certification/plant-miappe.json)|||
...
|Tool Name|
|--- |
|[BioSample (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.qr6pqk) s](https://www.ebi.ac.uk/biosamples (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.ewjdq6) /)|
|[European Nucleotide Arch (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.52b22c) ive (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.dj8nt8) , ENA (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.dj8nt8) ](https://www.ebi.ac.uk/ena (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.dj8nt8) /browser/home)|
|[European Variation Arch (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.52b22c) ive (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.6824pv) ,EVA (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.6824pv) ](https://www.ebi.ac.uk/eva (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.6824pv) /)|
...
|[VCF (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.cfzz0h)  Validator](https://github.com (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.c55d5e) /EBIvariation/vcf-validator/wiki/User's-Guide)|
|[Curl](https://curl.se/)|

## Step-by-Step Process


<!-- ### Step 1: Take DNA sample and register sample material at BioSample (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.qr6pqk) s -->
...
_the [MIAPPE](https://github.com (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.c55d5e) /MIAPPE/MIAPPE/tree/master/MIAPPE_Checklist-Data-Model-v1.1) specifications,
...
This is done in general through JSO (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.6bc7h9) N (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.5bbab9)  API ([Python](https://github.com (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.c55d5e) /PBR/elixir-fondue-datathon/tree/master/test_data_set/BioSamples/scripts/python) 
and [Shell](https://github.com (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.c55d5e) /PBR/elixir-fondue-datathon/tree/master/test_data_set/BioSamples/scripts/shell) commands are also available).
Refer to the official [documentation](https://www.ebi.ac.uk/biosamples (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.ewjdq6) /docs/references/api/submit (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.NYAjYd) #_submit_a_sample) for 
...
<!-- ### Step 2: Sequence DNA sample and submit reads to ENA (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.dj8nt8)  -->
...
<!-- ### Step 6: Analyse sequencing results and submit VCF (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.cfzz0h)  file to EVA (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.6824pv)  -->
...
**##fileDate(Date)**: creation date of the VCF (URL_TO_INSERT_RECORD http://127.0.0.1:8080/FAIRsharing.cfzz0h)  in the basic form without separator: YYYYMMDD 
