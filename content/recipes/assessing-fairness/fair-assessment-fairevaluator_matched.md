...
- Perform an automatic assessment of a dataset against the FAIR(URL_TO_INSERT_RECORD https://www.go-fair.org/fair-principles/) principles(URL_TO_INSERT_RECORD https://www.go-fair.org/fair-principles/) {footcite}`pmid26978244` expressed as nanopublications using the [FAIREvaluator](https://w3id.org(URL_TO_INSERT_RECORD https://w3id.org/)/AmIFAIR) {footcite}`pmid31541130`.
- Obtain human and machine-readable reports highlighting strengths and weaknesses with respect to FAIR(URL_TO_INSERT_RECORD https://www.go-fair.org/fair-principles/).

## Step by Step Process

### Loading FAIREvaluator web application 
     
Navigate the FAIR(URL_TO_INSERT_RECORD https://www.go-fair.org/fair-principles/)Evaluator tool, which can be accessed via the following 2 addresses:

- [https://w3id.org(URL_TO_INSERT_RECORD https://w3id.org/)/AmIFAIR](https://w3id.org(URL_TO_INSERT_RECORD https://w3id.org/)/AmIFAIR)
...
---
width: 800px
name: the FAIR(URL_TO_INSERT_RECORD https://www.go-fair.org/fair-principles/)Evaluator Home page
alt: the FAIR(URL_TO_INSERT_RECORD https://www.go-fair.org/fair-principles/)Evaluator Home page
---
the [FAIREvaluator](https://w3id.org(URL_TO_INSERT_RECORD https://w3id.org/)/AmIFAIR) Home page
```
````
...
---
width: 800px
name: Running the FAIR(URL_TO_INSERT_RECORD https://www.go-fair.org/fair-principles/)Evaluator - part 1 - setting the input
alt: Running the FAIR(URL_TO_INSERT_RECORD https://www.go-fair.org/fair-principles/)Evaluator - part 1 - setting the input
---
Running the FAIR(URL_TO_INSERT_RECORD https://www.go-fair.org/fair-principles/)Evaluator - part 1: setting the input
```
````
...
---
width: 800px
name: Running the FAIR(URL_TO_INSERT_RECORD https://www.go-fair.org/fair-principles/)Evaluator - part 2 - execution
alt: Running the FAIR(URL_TO_INSERT_RECORD https://www.go-fair.org/fair-principles/)Evaluator - part 2 - execution
---
Running the FAIR(URL_TO_INSERT_RECORD https://www.go-fair.org/fair-principles/)Evaluator - part 2: execution
```
````
...
Following execution of the FAIR(URL_TO_INSERT_RECORD https://www.go-fair.org/fair-principles/)Evaluator, a detail report is generated.
...
---
width: 800px
name: FAIR(URL_TO_INSERT_RECORD https://www.go-fair.org/fair-principles/)Evaluator report - overall report
alt: FAIR(URL_TO_INSERT_RECORD https://www.go-fair.org/fair-principles/)Evaluator report - overall report
---
FAIR(URL_TO_INSERT_RECORD https://www.go-fair.org/fair-principles/)Evaluator report - overall report
```
````
...
Using software tools to assess FAIR(URL_TO_INSERT_RECORD https://www.go-fair.org/fair-principles/) maturity constitutes an essential activity to ensure processes and capabilities actually deliver and claims can be checked.
Furthermore, only automation is able to cope with the scale and volumes of assets to evaluate.
The software-based evaluations are repeatable, reproducible and free of bias (other than those that may be related to definitions of the FAIR(URL_TO_INSERT_RECORD https://www.go-fair.org/fair-principles/) indicators themselves).
These are also more demanding in terms of technical implementation and knowledge.
Services such as the FAIR(URL_TO_INSERT_RECORD https://www.go-fair.org/fair-principles/)evaluator are essential to gauge improvements of data management services and for helping developers build FAIR(URL_TO_INSERT_RECORD https://www.go-fair.org/fair-principles/) services and data.
...
<!-- Wilkinson, M.D., Dumontier, M., Sansone, S. et al. Evaluating FAIR(URL_TO_INSERT_RECORD https://www.go-fair.org/fair-principles/) maturity through a scalable, automated, community-governed framework. Sci Data 6, 174 (2019). [doi:10.1038/s41597-019-0184-5](https://doi.org/10.1038/s41597-019-0184-5)

Clarke et al. FAIR(URL_TO_INSERT_RECORD https://www.go-fair.org/fair-principles/)shake: Toolkit to Evaluate the FAIR(URL_TO_INSERT_RECORD https://www.go-fair.org/fair-principles/)ness of Research(URL_TO_INSERT_RECORD https://arch.library.northwestern.edu/) Digital Resources, Cell Systems (2019),[doi:10.1016/j.cels.2019.09.011](https://doi.org/10.1016/j.cels.2019.09.011)
 -->
