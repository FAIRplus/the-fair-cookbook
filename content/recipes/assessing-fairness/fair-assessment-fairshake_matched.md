...
<!-- ![Anatomy of a FAIR (URL_TO_INSERT_RECORD_1844 https://fairsharing.org/FAIRsharing.WWI10U)  Insignia](./images/insignia-anatomy) -->
...
1. Use FAIR (URL_TO_INSERT_RECORD_1894 https://fairsharing.org/FAIRsharing.WWI10U) shake to facilitate FAIR (URL_TO_INSERT_RECORD_1895 https://fairsharing.org/FAIRsharing.WWI10U)  Rubric discovery and development
...
After logging in:
<!-- ![FAIR (URL_TO_INSERT_RECORD_1907 https://fairsharing.org/FAIRsharing.WWI10U) shake login page](./images/ss8.png) -->
...
<!-- ![FAIR (URL_TO_INSERT_RECORD_1914 https://fairsharing.org/FAIRsharing.WWI10U) shake performing a search (URL_TO_INSERT_RECORD_1915 https://fairsharing.org/FAIRsharing.52b22c) ](./images/ss9.png) -->
...
<!-- ![FAIR (URL_TO_INSERT_RECORD_1927 https://fairsharing.org/FAIRsharing.WWI10U) shake Chrome Extension install](./images/ss10.png) -->
````{dropdown}
:open:
...
<!-- ![Screenshot showing the FAIR (URL_TO_INSERT_RECORD_1932 https://fairsharing.org/FAIRsharing.WWI10U) shake chrome extension assessment summary](./images/ss6.png) -->
...
She points her mouse over some of the red squares revealing informat (URL_TO_INSERT_TERM_1936 https://fairsharing.org/search?recordType=model_and_format) ion she doesn't quite understand.

<!-- ![Screenshot showing the FAIR (URL_TO_INSERT_RECORD_1937 https://fairsharing.org/FAIRsharing.WWI10U) shake chrome extension assessment summary tooltip](./images/ss7.png) -->
````{dropdown}
:open:
...
<!-- ![FAIR (URL_TO_INSERT_RECORD_1960 https://fairsharing.org/FAIRsharing.WWI10U)  metric (URL_TO_INSERT_TERM_1959 https://fairsharing.org/search?recordType=metric) s Rubric on FAIR (URL_TO_INSERT_RECORD_1961 https://fairsharing.org/FAIRsharing.WWI10U) shake](./images/ss1.png)] -->
````{dropdown}
:open:
...
<!-- ![View on FAIR (URL_TO_INSERT_RECORD_1973 https://fairsharing.org/FAIRsharing.WWI10U) shake with extension](./images/ss11.png) -->
````{dropdown}
:open:
...
<!-- ![View on FAIR (URL_TO_INSERT_RECORD_1979 https://fairsharing.org/FAIRsharing.WWI10U) shake link location](./images/ss12.png) -->
````{dropdown}
:open:
...
<!-- ![Preparing an assessment on FAIR (URL_TO_INSERT_RECORD_1984 https://fairsharing.org/FAIRsharing.WWI10U) shake](./images/ss13.png) -->
````{dropdown}
:open:
...
<!-- ![Selecting the FAIR (URL_TO_INSERT_RECORD_1990 https://fairsharing.org/FAIRsharing.WWI10U) metric (URL_TO_INSERT_TERM_1989 https://fairsharing.org/search?recordType=metric) s rubric](./images/ss14.png) -->
````{dropdown}
:open:
...
<!-- ![Selecting the FAIR (URL_TO_INSERT_RECORD_2004 https://fairsharing.org/FAIRsharing.WWI10U) metric (URL_TO_INSERT_TERM_2002 https://fairsharing.org/search?recordType=metric) s project (URL_TO_INSERT_TERM_2003 https://fairsharing.org/search?recordType=project) ](./images/ss15.png) -->
````{dropdown}
:open:
...
It's also important to note that project (URL_TO_INSERT_TERM_2014 https://fairsharing.org/search?recordType=project)  here can be left blank if our assessment isn't for any project (URL_TO_INSERT_TERM_2015 https://fairsharing.org/search?recordType=project) .

<!-- ![Preparing the FAIR (URL_TO_INSERT_RECORD_2016 https://fairsharing.org/FAIRsharing.WWI10U) shake Assessment](./images/ss16.png) -->
````{dropdown}
:open:
...
<!-- ![Performing a Manual Assessment with FAIR (URL_TO_INSERT_RECORD_2020 https://fairsharing.org/FAIRsharing.WWI10U) shake](./images/ss17.png) -->
````{dropdown}
:open:
...
<!-- ![Global unique identifier (URL_TO_INSERT_TERM_2030 https://fairsharing.org/search?recordType=identifier_schema)  metric (URL_TO_INSERT_TERM_2029 https://fairsharing.org/search?recordType=metric)  on FAIR (URL_TO_INSERT_RECORD_2031 https://fairsharing.org/FAIRsharing.WWI10U) shake](./images/ss18.png) -->
````{dropdown}
:open:
...
[Clicking 'View assessments'](https://fairshake.cloud/metric/104/assessments/) she can even see what other digital objects in the database (URL_TO_INSERT_TERM_2041 https://fairsharing.org/search?fairsharingRegistry=Database)  got as an answer during an assessment through a tabular view.

<!-- ![Assessments for Global unique identifier (URL_TO_INSERT_TERM_2042 https://fairsharing.org/search?recordType=identifier_schema) ](./images/ss19.png) -->
````{dropdown}
:open:
...
<!-- ![Identifying identifier (URL_TO_INSERT_TERM_2051 https://fairsharing.org/search?recordType=identifier_schema) s](./images/ss20.png) -->
````{dropdown}
:open:
...
<!-- ![FAIR (URL_TO_INSERT_RECORD_2074 https://fairsharing.org/FAIRsharing.WWI10U) sharing (URL_TO_INSERT_RECORD_2072 https://fairsharing.org/FAIRsharing.2abjs5)  (URL_TO_INSERT_RECORD_2073 https://fairsharing.org/FAIRsharing.2abjs5)  identifier (URL_TO_INSERT_TERM_2071 https://fairsharing.org/search?recordType=identifier_schema) s](./images/ss21.png) -->
...
<!-- ![Assessment shown on FAIR (URL_TO_INSERT_RECORD_2152 https://fairsharing.org/FAIRsharing.WWI10U) shake](./images/ss27.png) -->
...
<!-- ![Reviewing FAIR (URL_TO_INSERT_RECORD_2251 https://fairsharing.org/FAIRsharing.WWI10U)  assessment breakdown on FAIR (URL_TO_INSERT_RECORD_2252 https://fairsharing.org/FAIRsharing.WWI10U) shake](./images/ss5.png) -->
<!-- <div><img src="https://github.com (URL_TO_INSERT_RECORD_2253 https://fairsharing.org/FAIRsharing.c55d5e) /nih-cfde/the-fair-cookbook/blob/dev/content/recipes/04/images/ss5.png?raw=true" width="1000px" style="padding:1px;border:thin solid black;"/></div> -->
...
increasing the FAIR (URL_TO_INSERT_RECORD_2283 https://fairsharing.org/FAIRsharing.WWI10U) ness of the standard (URL_TO_INSERT_TERM_2281 https://fairsharing.org/search?fairsharingRegistry=Standard)  itself and anything using that standard (URL_TO_INSERT_TERM_2282 https://fairsharing.org/search?fairsharingRegistry=Standard) .
...
<!-- ### <a name="fair-repo"></a><a name="fair-repo-report"></a><a name="fair-repo-assessments"></a>FAIR (URL_TO_INSERT_RECORD_2287 https://fairsharing.org/FAIRsharing.WWI10U)  Repo -->
