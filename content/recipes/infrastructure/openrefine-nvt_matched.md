...
The processed information results in an RDF (URL_TO_INSERT_RECORD-ABBREV_1144 https://fairsharing.org/FAIRsharing.p77ph9) /Linked Data graph, that can be seen as a specific implementation
...
* **Map (URL_TO_INSERT_RECORD-NAME_1145 https://fairsharing.org/FAIRsharing.53edcc)  the structure of the data to an ontology**.
...
Except for simple cases, such mappings go beyond simple names to URI (URL_TO_INSERT_RECORD-ABBREV_1146 https://fairsharing.org/FAIRsharing.d261e1)  relations and generally include **small graph patterns**.
...
We mentioned that we assume here that source data is represented as one or more CSV (URL_TO_INSERT_RECORD-ABBREV_1147 https://fairsharing.org/FAIRsharing.1943d4)  files.
...
in complex data structures such as XML (URL_TO_INSERT_RECORD-ABBREV_1149 https://fairsharing.org/FAIRsharing.b5cc91) , JSON (URL_TO_INSERT_RECORD-ABBREV_1148 https://fairsharing.org/FAIRsharing.5bbab9)  etc.
...
There are publicly available reconciliation services, but it is also possible to implement *ad-hoc* services (e.g.: on top of an MDM (URL_TO_INSERT_RECORD-ABBREV_1150 https://fairsharing.org/FAIRsharing.wnk2eq)  system).
...
One of the best developed systems supporting reconciliation APIs is Wikidata (URL_TO_INSERT_RECORD-NAME_1151 https://fairsharing.org/FAIRsharing.6s749p)  (https://wikidata.reconci.link).
By specifying the URI (URL_TO_INSERT_RECORD-ABBREV_1152 https://fairsharing.org/FAIRsharing.d261e1) : [https://wikidata.reconci.link/en/api](https://wikidata.reconci.link/en/api) as a reconciliation
service, OpenRefine will help users to normalise entity references to Wikidata (URL_TO_INSERT_RECORD-NAME_1153 https://fairsharing.org/FAIRsharing.6s749p)  URIs.
...
alt: Wikidata (URL_TO_INSERT_RECORD-NAME_1154 https://fairsharing.org/FAIRsharing.6s749p)  Reconcile for OpenRefine
---
Wikidata (URL_TO_INSERT_RECORD-NAME_1155 https://fairsharing.org/FAIRsharing.6s749p)  Reconcile for OpenRefine
```
````
...
OpenRefine can also be used for internal data (e.g.: MDM (URL_TO_INSERT_RECORD-ABBREV_1156 https://fairsharing.org/FAIRsharing.wnk2eq)  systems), by providing “internal” reconciliation services.
...
(the system at the basis of Wikidata (URL_TO_INSERT_RECORD-NAME_1157 https://fairsharing.org/FAIRsharing.6s749p) ). 

We could implement a local “empty” version of Wikidata (URL_TO_INSERT_RECORD-NAME_1158 https://fairsharing.org/FAIRsharing.6s749p) , and populate it with internal data (represented using the Wikidata (URL_TO_INSERT_RECORD-NAME_1159 https://fairsharing.org/FAIRsharing.6s749p)  format).
...
This extension graphical user interface (GUI) for exporting data of Google Refine projects in RDF (URL_TO_INSERT_RECORD-ABBREV_1160 https://fairsharing.org/FAIRsharing.p77ph9)  format. 
...
Finally, it is possible to implement reconciliation APIs on top of proprietary systems (e.g.: MDM (URL_TO_INSERT_RECORD-ABBREV_1161 https://fairsharing.org/FAIRsharing.wnk2eq) ):
...
<table>
  ...
  <tr>
   <td>http://www.wikidata.org (URL_TO_INSERT_RECORD-HOMEPAGE_1162 https://fairsharing.org/FAIRsharing.6s749p) /entity/Q937
   </td>
   <td>http://www.wikidata.org (URL_TO_INSERT_RECORD-HOMEPAGE_1163 https://fairsharing.org/FAIRsharing.6s749p) /entity/Q88665
   </td>
  </tr>
</table>
...
Note that first we could map (URL_TO_INSERT_RECORD-NAME_1164 https://fairsharing.org/FAIRsharing.53edcc) :


<table>
  <tr>
   <td>Person => <a href="http://www.wikidata.org (URL_TO_INSERT_RECORD-HOMEPAGE_1165 https://fairsharing.org/FAIRsharing.6s749p) /entity/Q5">http://www.wikidata.org (URL_TO_INSERT_RECORD-HOMEPAGE_1166 https://fairsharing.org/FAIRsharing.6s749p) /entity/Q5</a> (Human, the type of the entity in the column)
   </td>
   <td>Father =>
<p>
<a href="http://www.wikidata.org (URL_TO_INSERT_RECORD-HOMEPAGE_1167 https://fairsharing.org/FAIRsharing.6s749p) /entity/Q5">http://www.wikidata.org (URL_TO_INSERT_RECORD-HOMEPAGE_1168 https://fairsharing.org/FAIRsharing.6s749p) /entity/Q5</a> (Human, the type of the entity in the column)
<p>
=> <a href="http://www.wikidata.org (URL_TO_INSERT_RECORD-HOMEPAGE_1169 https://fairsharing.org/FAIRsharing.6s749p) /entity/P22">http://www.wikidata.org (URL_TO_INSERT_RECORD-HOMEPAGE_1170 https://fairsharing.org/FAIRsharing.6s749p) /entity/P22</a> (father, the relation to the other entity)
   </td>
  </tr>
  <tr>
   <td>http://www.wikidata.org (URL_TO_INSERT_RECORD-HOMEPAGE_1171 https://fairsharing.org/FAIRsharing.6s749p) /entity/Q937
   </td>
   <td>http://www.wikidata.org (URL_TO_INSERT_RECORD-HOMEPAGE_1172 https://fairsharing.org/FAIRsharing.6s749p) /entity/Q88665
   </td>
  </tr>
</table>
...
The RDF (URL_TO_INSERT_RECORD-ABBREV_1173 https://fairsharing.org/FAIRsharing.p77ph9)  plugin in OpenRefine allows to map (URL_TO_INSERT_RECORD-NAME_1174 https://fairsharing.org/FAIRsharing.53edcc)  a table in OpenRefine to a graph pattern where the content of other columns can be added.
...
---
width: 800px
name: RDF (URL_TO_INSERT_RECORD-ABBREV_1175 https://fairsharing.org/FAIRsharing.p77ph9)  schema alignment in OpenRefine
alt: RDF (URL_TO_INSERT_RECORD-ABBREV_1176 https://fairsharing.org/FAIRsharing.p77ph9)  schema alignment in OpenRefine
---
RDF (URL_TO_INSERT_RECORD-ABBREV_1177 https://fairsharing.org/FAIRsharing.p77ph9)  schema alignment in OpenRefine
```
````



The system assists the users in defining how the table should look like in RDF (URL_TO_INSERT_RECORD-ABBREV_1178 https://fairsharing.org/FAIRsharing.p77ph9) , fundamentally providing a template editor.
...
designed to map (URL_TO_INSERT_RECORD-NAME_1180 https://fairsharing.org/FAIRsharing.53edcc)  data to RDF (URL_TO_INSERT_RECORD-ABBREV_1179 https://fairsharing.org/FAIRsharing.p77ph9) . 
It covers different input formats (e.g.: JSON (URL_TO_INSERT_RECORD-ABBREV_1181 https://fairsharing.org/FAIRsharing.5bbab9)  and hierarchical content).
In terms of functionality, it is different from OpenRefine in some fundamental ways:


* **Use of ontologies**. When mapping a dataset to RDF (URL_TO_INSERT_RECORD-ABBREV_1182 https://fairsharing.org/FAIRsharing.p77ph9) , one can create the required classes and properties URIs “while doing the mapping”.
Karma requires the full ontology to map (URL_TO_INSERT_RECORD-NAME_1183 https://fairsharing.org/FAIRsharing.53edcc)  to to be present a-priori.
...
---
width: 800px
name: RDF (URL_TO_INSERT_RECORD-ABBREV_1184 https://fairsharing.org/FAIRsharing.p77ph9)  schema alignment in Karma
alt: RDF (URL_TO_INSERT_RECORD-ABBREV_1185 https://fairsharing.org/FAIRsharing.p77ph9)  schema alignment in Karma
---
RDF (URL_TO_INSERT_RECORD-ABBREV_1186 https://fairsharing.org/FAIRsharing.p77ph9)  schema alignment in Karma
```
````
...
It is however possible to map (URL_TO_INSERT_RECORD-NAME_1187 https://fairsharing.org/FAIRsharing.53edcc)  data to a graph without performing any reconciliation step (in general the resulting graph will not be fully FAIR (URL_TO_INSERT_RECORD-ABBREV_1188 https://fairsharing.org/FAIRsharing.WWI10U) ).
...
This content provides a basic overview of reconciliation tools for dealing with relative lightweight processes to convert tabular data to an RDF (URL_TO_INSERT_RECORD-ABBREV_1189 https://fairsharing.org/FAIRsharing.p77ph9)  Linked Data graph.
It complements content related to ETL to RDF (URL_TO_INSERT_RECORD-ABBREV_1190 https://fairsharing.org/FAIRsharing.p77ph9) .
