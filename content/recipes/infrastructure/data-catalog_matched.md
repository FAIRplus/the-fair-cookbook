...
1. DATS (URL_TO_INSERT_RECORD-ABBREV_959 https://fairsharing.org/FAIRsharing.e20vsd) :
...
2. DCAT (URL_TO_INSERT_RECORD-ABBREV_960 https://fairsharing.org/FAIRsharing.h4j3qm) :
In the world of semantic web technologies, The W3C DCAT specifications<!-- TODO add a link to corresponding document -->
(v1 and the newly released version 2) provide a vocabulary to express **data catalogue metadata** in **RDF (URL_TO_INSERT_RECORD-ABBREV_961 https://fairsharing.org/FAIRsharing.p77ph9) **.
3. Schema.org (URL_TO_INSERT_RECORD-NAME_962 https://fairsharing.org/FAIRsharing.hzdzq8) :
...
A number data Indexes/Data Catalogue are populated by harvest Dataset metadata from primary Data Repositories or harvesting JSON (URL_TO_INSERT_RECORD-ABBREV_963 https://fairsharing.org/FAIRsharing.5bbab9) -LD (URL_TO_INSERT_RECORD-ABBREV_964 https://fairsharing.org/FAIRsharing.8f9bbb)  files served by these same pages for rapid, shallow indexing. The former method is often richer but requires more 
...
For the readership interested in finding out about additional capabilities needed to enhance other aspects of FAIR (URL_TO_INSERT_RECORD-ABBREV_965 https://fairsharing.org/FAIRsharing.WWI10U)  such
