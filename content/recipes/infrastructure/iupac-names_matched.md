...
The latter is done by the offical InChI (URL_TO_INSERT_RECORD-ABBREV_994 https://fairsharing.org/FAIRsharing.ddk9t9)  library {footcite}`Goodman2021InChI`.
...
After that, we use the manager API to parse the IUPAC name and generate an InChI (URL_TO_INSERT_RECORD-ABBREV_995 https://fairsharing.org/FAIRsharing.ddk9t9)  and InChIKey:
