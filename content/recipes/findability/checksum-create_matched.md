...
to confirm that the actual content, i.e. the bits that make up the informat (URL_TO_INSERT_TERM_1494 https://fairsharing.org/search?recordType=model_and_format) ion, arrived correctly in the target system.
  ...
  - Start up a console. Type 
    ...
    and hit return.
      - You should see as output: 
        ```text
        md5sum (GNU core (URL_TO_INSERT_RECORD_1495 https://fairsharing.org/FAIRsharing.m283c)  (URL_TO_INSERT_RECORD_1496 https://fairsharing.org/FAIRsharing.xMmOCL) utils) 8.30
...
- The tool above could be used to calculate checksums in parallel if typical scheduling systems and multiple worker nodes are available sharing the same file system (equivalently, this would be possible in a cloud arch (URL_TO_INSERT_RECORD_1501 https://fairsharing.org/FAIRsharing.52b22c) itecture).
...
- Wikiped (URL_TO_INSERT_RECORD_1502 https://fairsharing.org/FAIRsharing.31385c) ia article on checksums: <https://en.wikipedia.org/wiki/Checksum>
- Wikiped (URL_TO_INSERT_RECORD_1503 https://fairsharing.org/FAIRsharing.31385c) ia article on the algorithm `md5`: <https://en.wikipedia.org/wiki/MD5>
- Wikiped (URL_TO_INSERT_RECORD_1504 https://fairsharing.org/FAIRsharing.31385c) ia article on the tool `md5sum`: <https://en.wikipedia.org/wiki/Md5sum>
