...
> To markup a webpage representing a data record with `Bioschemas (URL_TO_INSERT_RECORD-NAME_515 https://fairsharing.org/3517) ` compliant markup.
...
We will outline the steps for embedding machine processable mark up within a web page in your site. As a specific example, we will use the Wikidata (URL_TO_INSERT_RECORD-NAME_516 https://fairsharing.org/FAIRsharing.6s749p)  page for [BRCA1](https://www.wikidata.org/wiki/Q227339).
...
2. Open the [Bioschemas Generator](https://www.macs.hw.ac.uk/SWeL/BioschemasGenerator/)
   ...
   1.  Select the type of data page that you are marking up, i.e. the primary subject of the page. In the example we will use `Gene`. Here are the Bioschemas (URL_TO_INSERT_RECORD-NAME_517 https://fairsharing.org/3517)  [profiles](https://bioschemas.org/profiles/) that you can choose from<sup>[1](#draft-profiles)</sup>. 
        ...
        - `Protein (URL_TO_INSERT_RECORD-ABBREV_518 https://fairsharing.org/FAIRsharing.rtndct) ` for a page about a protein

        - `BioSample (URL_TO_INSERT_RECORD-ABBREV_519 https://fairsharing.org/FAIRsharing.qr6pqk) ` for a page about a biological sample
        
        - `Taxon` for a page about a taxon
      
   2. Enter the URL (URL_TO_INSERT_RECORD-ABBREV_521 https://fairsharing.org/FAIRsharing.9d38e2)  of the page in URL (URL_TO_INSERT_RECORD-ABBREV_522 https://fairsharing.org/FAIRsharing.9d38e2)  box, e.g. `https://www.wikidata.org (URL_TO_INSERT_RECORD-HOMEPAGE_520 https://fairsharing.org/FAIRsharing.6s749p) /wiki/Q227339`. Note that this URL (URL_TO_INSERT_RECORD-ABBREV_523 https://fairsharing.org/FAIRsharing.9d38e2)  will be used as the identifier for the resource being described in the markup.
   ...
   3. Click on the `Show Form` button
    ...
    ---
    name: bioschemas (URL_TO_INSERT_RECORD-NAME_524 https://fairsharing.org/3517) -generator-start-screen-2
    alt: Bioschemas (URL_TO_INSERT_RECORD-NAME_525 https://fairsharing.org/3517)  Generator start screen.
    
    ---
    Bioschemas (URL_TO_INSERT_RECORD-NAME_526 https://fairsharing.org/3517)  Generator start screen.
    ```
    ````
...
3. Complete the profile form with the data relevant for your page. Once completed, click on the `Generate Markup`  button
   ...
   - The form defaults to the data type with the first alphabetical character, e.g. for `identifier` this defaults to `PropertyValue` but `Text` or `URL (URL_TO_INSERT_RECORD-ABBREV_527 https://fairsharing.org/FAIRsharing.9d38e2)  ` will be more appropriate in most cases
   - The right side of the screen gives examples for properties, where these have been provided by the Bioschemas (URL_TO_INSERT_RECORD-NAME_528 https://fairsharing.org/3517)  profile authors. Click on the `Show` button to see the example for a specific property. Click on `Minimum`, `Recommended`, or `Optional` to expand/contract the section and see the properties contained at that marginality level
    ...
    ---
    height: 550px
    name: Bioschemas (URL_TO_INSERT_RECORD-NAME_529 https://fairsharing.org/3517)  Generator Gene profile form
    alt: Bioschemas (URL_TO_INSERT_RECORD-NAME_530 https://fairsharing.org/3517)  Generator Gene profile form
    ---
    Bioschemas (URL_TO_INSERT_RECORD-NAME_531 https://fairsharing.org/3517)  Generator Gene profile form.
    ```
    ````
    
4. You should now see the generated markup in `JSON (URL_TO_INSERT_RECORD-ABBREV_533 https://fairsharing.org/FAIRsharing.5bbab9) -LD (URL_TO_INSERT_RECORD-ABBREV_536 https://fairsharing.org/FAIRsharing.8f9bbb) ` format. You can click on the `Microdata` and `RDFa (URL_TO_INSERT_RECORD-ABBREV_535 https://fairsharing.org/663) ` tabs to see the same content rendered in the different formats. However, we recommend the use of `JSON (URL_TO_INSERT_RECORD-ABBREV_534 https://fairsharing.org/FAIRsharing.5bbab9) -LD (URL_TO_INSERT_RECORD-ABBREV_537 https://fairsharing.org/FAIRsharing.8f9bbb) `. For our Wikidata (URL_TO_INSERT_RECORD-NAME_532 https://fairsharing.org/FAIRsharing.6s749p)  example, we get the following markup

    ```html
    <script type="application/ld+json" >
    {
      "@context": "https://schema.org (URL_TO_INSERT_RECORD-HOMEPAGE_538 https://fairsharing.org/FAIRsharing.hzdzq8) ",
      "@id": "https://www.wikidata.org (URL_TO_INSERT_RECORD-HOMEPAGE_539 https://fairsharing.org/FAIRsharing.6s749p) /wiki/Q227339",
      "@type": "Gene",
      "alternateName": [
        ...
        "BRCC1",
        "BROVCA1",
        "IRIS (URL_TO_INSERT_RECORD-ABBREV_540 https://fairsharing.org/FAIRsharing.e20b79) ",
        "PNCA4",
        "PPP1R53",
        "PSCP",
        "RNF53",
