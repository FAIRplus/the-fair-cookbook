...
> To embed `Schema.org (URL_TO_INSERT_RECORD https://fairsharing.org/FAIRsharing.hzdzq8)  (URL_TO_INSERT_RECORD https://fairsharing.org/FAIRsharing.hzdzq8) ` markup in a web page representing a dataset.
...
width: 500px
name: 
alt: The process of annotating a dataset webpage with bioschema markup for Search (URL_TO_INSERT_RECORD https://fairsharing.org/FAIRsharing.52b22c)  Engine discovery
---
The process of annotating a dataset webpage with bioschema markup for Search (URL_TO_INSERT_RECORD https://fairsharing.org/FAIRsharing.52b22c)  Engine discovery.
```
````
...
and the [Bioschemas (URL_TO_INSERT_RECORD https://fairsharing.org/3517)  (URL_TO_INSERT_RECORD https://fairsharing.org/3517)  Dataset Profile (URL_TO_INSERT_RECORD https://fairsharing.org/FAIRsharing.20sbr9) ](https://bioschemas.org (URL_TO_INSERT_RECORD https://fairsharing.org/3517) /profiles/Dataset (URL_TO_INSERT_RECORD https://fairsharing.org/FAIRsharing.20sbr9) ). The resulting webpage will be indexable by the major search (URL_TO_INSERT_RECORD https://fairsharing.org/FAIRsharing.52b22c)  engines and should eventually appear in [Google's Dataset Search (URL_TO_INSERT_RECORD https://fairsharing.org/FAIRsharing.52b22c)  Tool](https://datasetsearch.research.google.com/).

We will use [UniProtKB](https://www.uniprot.org (URL_TO_INSERT_RECORD https://fairsharing.org/FAIRsharing.s1ne3g) /uniprot/) as an example for this recipe.

1. Identify the page in your site about a specific dataset, e.g. https://www.uniprot.org (URL_TO_INSERT_RECORD https://fairsharing.org/FAIRsharing.s1ne3g) /uniprot/
...
2. Open the  [Bioschemas (URL_TO_INSERT_RECORD https://fairsharing.org/3517)  (URL_TO_INSERT_RECORD https://fairsharing.org/3517)  Generator](https://www.macs.hw.ac.uk/SWeL/BioschemasGenerator/)
   ...
   1.  Select `Dataset` from the Bioschemas (URL_TO_INSERT_RECORD https://fairsharing.org/3517)  (URL_TO_INSERT_RECORD https://fairsharing.org/3517)  Profile dropdown

   2.  Enter the URL (URL_TO_INSERT_RECORD https://fairsharing.org/FAIRsharing.9d38e2)  of the page in URL (URL_TO_INSERT_RECORD https://fairsharing.org/FAIRsharing.9d38e2)  box, e.g. `https://www.uniprot.org (URL_TO_INSERT_RECORD https://fairsharing.org/FAIRsharing.s1ne3g) /uniprot/`
   ...
   ---
   name: bioschemas (URL_TO_INSERT_RECORD https://fairsharing.org/3517) -generator-start-screen-3
...
3. Complete the profile form with the data relevant for your page. Once completed, click on the `Generate Markup`  button
   ...
   ````{dropdown} 
   :open:
   ```{figure} Bioschemas (URL_TO_INSERT_RECORD https://fairsharing.org/3517)  (URL_TO_INSERT_RECORD https://fairsharing.org/3517) GeneratorDatasetForm.png
   ---
   height: 550px
   name: Bioschemas (URL_TO_INSERT_RECORD https://fairsharing.org/3517)  (URL_TO_INSERT_RECORD https://fairsharing.org/3517)  Generator Dataset profile form
   alt: Bioschemas (URL_TO_INSERT_RECORD https://fairsharing.org/3517)  (URL_TO_INSERT_RECORD https://fairsharing.org/3517)  Generator Dataset profile form
   ---
   Bioschemas (URL_TO_INSERT_RECORD https://fairsharing.org/3517)  (URL_TO_INSERT_RECORD https://fairsharing.org/3517)  Generator Dataset profile form.
   ``` 
   ````
   
4. You will now see the generated markup in `JSO (URL_TO_INSERT_RECORD https://fairsharing.org/FAIRsharing.6bc7h9) N (URL_TO_INSERT_RECORD https://fairsharing.org/FAIRsharing.5bbab9) -LD (URL_TO_INSERT_RECORD https://fairsharing.org/FAIRsharing.8f9bbb) ` format (URL_TO_INSERT_TERM https://fairsharing.org/search?recordType=model_and_format) . You can click on the `Microdata` and `RDF (URL_TO_INSERT_RECORD https://fairsharing.org/FAIRsharing.p77ph9) a (URL_TO_INSERT_RECORD https://fairsharing.org/663) ` tabs to see the same content rendered in the different format (URL_TO_INSERT_TERM https://fairsharing.org/search?recordType=model_and_format) s. However, we recommend the use of `JSO (URL_TO_INSERT_RECORD https://fairsharing.org/FAIRsharing.6bc7h9) N (URL_TO_INSERT_RECORD https://fairsharing.org/FAIRsharing.5bbab9) -LD (URL_TO_INSERT_RECORD https://fairsharing.org/FAIRsharing.8f9bbb) `. For our UniProtKB (URL_TO_INSERT_RECORD https://fairsharing.org/FAIRsharing.s1ne3g)  example, we get the following markup
   
   ```
   <script type="application/ld+json" >
   {
     "@context": "https://schema.org (URL_TO_INSERT_RECORD https://fairsharing.org/FAIRsharing.hzdzq8) ",
     "@id": "https://www.uniprot.org (URL_TO_INSERT_RECORD https://fairsharing.org/FAIRsharing.s1ne3g) /uniprot/",
     "@type": "Dataset",
     "citation": [
       {
     ...
     "description": "The UniProt Knowledgebas (URL_TO_INSERT_RECORD https://fairsharing.org/FAIRsharing.b94a20) e (URL_TO_INSERT_TERM https://fairsharing.org/search?recordType=knowledgebase)  (URL_TO_INSERT_RECORD https://fairsharing.org/FAIRsharing.s1ne3g)  (UniProtKB (URL_TO_INSERT_RECORD https://fairsharing.org/FAIRsharing.s1ne3g) ) is the central hub for the collection (URL_TO_INSERT_TERM https://fairsharing.org/search?recordType=collection)  of functional informat (URL_TO_INSERT_TERM https://fairsharing.org/search?recordType=model_and_format) ion on proteins, with accurate, consistent and rich annotation. In addition to capturing the core (URL_TO_INSERT_RECORD https://fairsharing.org/FAIRsharing.m283c)  (URL_TO_INSERT_RECORD https://fairsharing.org/FAIRsharing.xMmOCL)  data mandatory for each UniProtKB (URL_TO_INSERT_RECORD https://fairsharing.org/FAIRsharing.s1ne3g)  entry (mainly, the amino acid sequence, protein name or description, taxonomic data and citation informat (URL_TO_INSERT_TERM https://fairsharing.org/search?recordType=model_and_format) ion), as much annotation informat (URL_TO_INSERT_TERM https://fairsharing.org/search?recordType=model_and_format) ion as possible is added.",
     "distribution": {
       "@id": "https://www.uniprot.org (URL_TO_INSERT_RECORD https://fairsharing.org/FAIRsharing.s1ne3g) /downloads#uniprotkblink",
       "@type": "DataDownload"
     },
     "identifier (URL_TO_INSERT_TERM https://fairsharing.org/search?recordType=identifier_schema) ": [
       "https://www.uniprot.org (URL_TO_INSERT_RECORD https://fairsharing.org/FAIRsharing.s1ne3g) /uniprot/"
     ],
     ...
     "keywords": [
       ...
       "Protein (URL_TO_INSERT_RECORD https://fairsharing.org/FAIRsharing.rtndct)  annotation"
     ],
     "license": "https://creativecommons.org/licenses/by/4.0/",
     "name": "UniProtKB (URL_TO_INSERT_RECORD https://fairsharing.org/FAIRsharing.s1ne3g) ",
     "url": "https://www.uniprot.org (URL_TO_INSERT_RECORD https://fairsharing.org/FAIRsharing.s1ne3g) /uniprot/"
   }
   </script >
   ```
...
8. If you have multiple datasets released through your site, then you should make a template for your datasets. In your template you should replace the values in your markup that will change from dataset to dataset with variables. Your web page templating system will replace the variables with values from your database (URL_TO_INSERT_TERM https://fairsharing.org/search?fairsharingRegistry=Database) . For example, the follow snippet uses variables of the form `%%%PAGEURL (URL_TO_INSERT_RECORD https://fairsharing.org/FAIRsharing.9d38e2) %%%`
   ...
   ```
      <script type="application/ld+json">
      {
        ...
        "citation": [
          {
            "@id": "%%%DOI (URL_TO_INSERT_RECORD https://fairsharing.org/FAIRsharing.hFLKCn) %%%",
            "@type": "CreativeWork"
          }
        ],
        "creator": [
