(fcb-find-identifier (URL_TO_INSERT_TERM_2348 https://fairsharing.org/search?recordType=identifier_schema) s)=
...
| :------------- | :------------- | :------------- |
| [Identifier](http://edamontology.org (URL_TO_INSERT_RECORD_2361 https://fairsharing.org/FAIRsharing.a6r7zs) /data_0842) |   |   |
 -->
...
| HTTP<!-- TO (URL_TO_INSERT_RECORD_2366 https://fairsharing.org/FAIRsharing.w69t6r) DO add a link to corresponding document --> |  |  |
| RDF (URL_TO_INSERT_RECORD_2367 https://fairsharing.org/FAIRsharing.p77ph9) <!-- TO (URL_TO_INSERT_RECORD_2368 https://fairsharing.org/FAIRsharing.w69t6r) DO add a link to corresponding document --> |  |  |
...
In other words, in order to create globally unique identifier (URL_TO_INSERT_TERM_2388 https://fairsharing.org/search?recordType=identifier_schema) s `for the web`, it is necessary to understand what Uniform Resource Locator (URL_TO_INSERT_RECORD_2389 https://fairsharing.org/FAIRsharing.9d38e2) s<!-- TO (URL_TO_INSERT_RECORD_2391 https://fairsharing.org/FAIRsharing.w69t6r) DO add a link to corresponding document --> (a.k.a `URL (URL_TO_INSERT_RECORD_2390 https://fairsharing.org/FAIRsharing.9d38e2) `) are and how to construct them for use with the Hypertext Transfer Protocol<!-- TO (URL_TO_INSERT_RECORD_2392 https://fairsharing.org/FAIRsharing.w69t6r) DO add a link to corresponding document -->.
...
When a user retrieves a PURL (URL_TO_INSERT_RECORD_2431 https://fairsharing.org/FAIRsharing.3e603c)  (URL_TO_INSERT_RECORD_2432 https://fairsharing.org/FAIRsharing.9d38e2) , they will be **`redirected`** to the current location of the resource.
...
* [w3id (URL_TO_INSERT_RECORD_2500 https://fairsharing.org/FAIRsharing.S6BoUk) s](https://w3id.org (URL_TO_INSERT_RECORD_2501 https://fairsharing.org/FAIRsharing.S6BoUk) /)
    ...
    > Permanent Identifier (URL_TO_INSERT_TERM_2502 https://fairsharing.org/search?recordType=identifier_schema) s for the Web. Secure, permanent URL (URL_TO_INSERT_RECORD_2503 https://fairsharing.org/FAIRsharing.9d38e2) s for your Web application that will stand the test of time.
...
### What to read next?
<!-- > * [Why resolvable identifier (URL_TO_INSERT_TERM_2566 https://fairsharing.org/search?recordType=identifier_schema) s matter?](https://www.TODO.org/findability/why-identifiers.html) -->
