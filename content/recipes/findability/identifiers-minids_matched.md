...
<!-- <div><img src="https://github.com (URL_TO_INSERT_RECORD https://fairsharing.org/FAIRsharing.c55d5e) /nih-cfde/the-fair-cookbook/blob/master/content/recipes/08/2/images/minid-mermaid.png?raw=true" alt="drawing" style="border:1px solid black;" width="650"  align="top" /></div>
 -->
...
| :------------- | :------------- | :------------- |
| [service invokation](http://edamontology.org (URL_TO_INSERT_RECORD https://fairsharing.org/FAIRsharing.a6r7zs) /operation_3763)  | [file](http://purl.obolibrary.org/obo/STATO_0000002)  | [guid](http://edamontology.org (URL_TO_INSERT_RECORD https://fairsharing.org/FAIRsharing.a6r7zs) /data_0976)  |
...
[minid github (URL_TO_INSERT_RECORD https://fairsharing.org/FAIRsharing.c55d5e)  repository (URL_TO_INSERT_TERM https://fairsharing.org/search?recordType=repository) ](https://github.com (URL_TO_INSERT_RECORD https://fairsharing.org/FAIRsharing.c55d5e) /fair-research/minid)
...
<!-- <div>
  <img src="https://github.com (URL_TO_INSERT_RECORD https://fairsharing.org/FAIRsharing.c55d5e) /nih-cfde/the-fair-cookbook/blob/dev/content/recipes/08/2/images/globus/globus-account-create.png?raw=true" alt="drawing" style="border:1px solid black;" width="650"  align="top" />
</div> 
 -->
  <!-- ![](/images/B5UbkpF.png) -->
...
<!-- <div>
  <img src="https://github.com (URL_TO_INSERT_RECORD https://fairsharing.org/FAIRsharing.c55d5e) /nih-cfde/the-fair-cookbook/blob/dev/content/recipes/08/2/images/globus/globus-account-login.png?raw=true" alt="drawing" style="border:1px solid black;" width="750"  align="top" />
</div>  -->
...
<!-- <div>
<img src="https://github.com (URL_TO_INSERT_RECORD https://fairsharing.org/FAIRsharing.c55d5e) /nih-cfde/the-fair-cookbook/blob/dev/content/recipes/08/2/images/globus/globus-account-allow.png?raw=true" width="900px" style="padding:1px;border:thin solid black;"/>
</div> -->
...
<!-- <div>
<img src="https://github.com (URL_TO_INSERT_RECORD https://fairsharing.org/FAIRsharing.c55d5e) /nih-cfde/the-fair-cookbook/blob/dev/content/recipes/08/2/images/globus/globus-account-login-success.png?raw=true" width="900px" style="padding:1px;border:thin solid black;"/>
</div>
 -->
...
The CL (URL_TO_INSERT_RECORD https://fairsharing.org/FAIRsharing.j9y503) I supports the following simple operations (Note: the `--test` flag creates names in a test namespace that is removed periodically; remove that flag to create production minids.):
...
Minids can only be assigned to a single file. In order to assign a minid to a collection (URL_TO_INSERT_TERM https://fairsharing.org/search?recordType=collection)  of files, we recommend using a `BDBag <https://github.com (URL_TO_INSERT_RECORD https://fairsharing.org/FAIRsharing.c55d5e) /ini-bdds/bdbag>`_ or the minid file manifest format (URL_TO_INSERT_TERM https://fairsharing.org/search?recordType=model_and_format) .

The minid file manifest format (URL_TO_INSERT_TERM https://fairsharing.org/search?recordType=model_and_format)  is a JSO (URL_TO_INSERT_RECORD https://fairsharing.org/FAIRsharing.6bc7h9) N (URL_TO_INSERT_RECORD https://fairsharing.org/FAIRsharing.5bbab9) -based format (URL_TO_INSERT_TERM https://fairsharing.org/search?recordType=model_and_format)  that enumerates a list of files as JSO (URL_TO_INSERT_RECORD https://fairsharing.org/FAIRsharing.6bc7h9) N (URL_TO_INSERT_RECORD https://fairsharing.org/FAIRsharing.5bbab9)  objects that have the following attributes:
...
* url: the URL (URL_TO_INSERT_RECORD https://fairsharing.org/FAIRsharing.9d38e2)  to the file.
...
<!-- 1. Madduri R, Chard K, D’Arcy M, Jung SC, Rodriguez A, Sulakhe D, et al. (2019) Reproducible big data science: A case study in continuous FAIR (URL_TO_INSERT_RECORD https://fairsharing.org/FAIRsharing.WWI10U) ness. PLoS ONE (URL_TO_INSERT_RECORD https://fairsharing.org/FAIRsharing.USxx0K)  14(4): e0213013. https://doi.org/10.1371/journal.pone.0213013
