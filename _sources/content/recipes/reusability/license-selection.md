# Selection a Licensing Model and Determinizing conditions of Use and Condition of Access:
...
:align: right
```
[The three recipes about licensing are original content from The Turing Way](https://the-turing-way.netlify.app/welcome) and are included in the FAIRCookbook for convenience. Please cite keeping this in mind.
...
The Alan Turing Institute Book of Data Science has covered that ground very well already so we are pointing the readership towards that effort:
