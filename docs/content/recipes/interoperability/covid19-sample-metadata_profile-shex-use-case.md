# RDF Metadata Profile Validation validate with Shex: the Covid-19 sample metadata use case 
...
The original work on the metadata profile was carried out by the following people:
...
<!-- ![](https://i.imgur.com/lwV1cPd.png) -->

<!-- ![](https://i.imgur.com/1ahQLjy.png) -->

<div><img src="https://i.imgur.com/1ahQLjy.png" width="300" border="1"/></div>

## Semantic anchoring of metadata element:

Several mapping have been made by the developers: OBO, Wikidata, Schema.org
<!-- ![](https://i.imgur.com/Ro92a7D.png) -->

<div><img src="https://i.imgur.com/Ro92a7D.png" width="650" border="1"/></div>
For the rest of the development, the OBO based mapping were retained.

<!-- ![](https://i.imgur.com/Lc7FcPs.png) -->
<div><img src="https://i.imgur.com/Ro92a7D.png" width="650" border="1"/></div>

## 1. YAML based definition of an metadata acquisition form:

The annotation requirement has been defined with a YAML document:

https://github.com/arvados/bh20-seq-resource/blob/master/bh20sequploader/bh20seq-schema.yml

a partial view of the metadata yaml form:
...
## 2. with exemplar instance data here:
...
Working with a rdf validation expert (Dr Jose Emilio Labra Gayo - (Oviedo Uni) the following Shape Expression was developed and used to validate the RDF before persistence to the SPARQL endpoint:
...
I'll reach out to the group (Dani, Thomas and the rest of the group) and work at created a recipe on that if everyone is OK with this
